...
description: "Give a Team leader ReasoningTools to optimize delegation across a web-search agent and a finance agent."
---
This is a multi-agent team reasoning example with reasoning tools.

<Tip>
Adding `ReasoningTools` to the team leader lets it invoke deeper reasoning while coordinating the member agents.
</Tip>
