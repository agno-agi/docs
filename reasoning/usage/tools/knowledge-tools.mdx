---
title: Agent with Knowledge Tools
description: "Give an agent KnowledgeTools backed by a LanceDB hybrid-search knowledge base to think, search, and analyze before answering."
---
