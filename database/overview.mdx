...
- [User Memories](/memory/overview)
- [Knowledge](/knowledge/concepts/content-db)
...
Agents backed by a database persist their [sessions](/sessions/overview) to it. You can then load this persisted history into the context to maintain continuity across sessions.
...
<Note>
  Learn more about [Teams](/teams/overview) and
  [Workflows](/workflows/overview), Agno abstractions to build
  multi-agent systems.
</Note>
...
<Note>
[In-Memory](/database/providers/in-memory/overview) databases are also supported. This is not recommended for production, but perfect for demos and testing.
</Note>

You can see a detailed list of [examples](/database/providers) for all supported databases.
