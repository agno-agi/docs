...
description: "Due diligence agent that crawls company websites and produces investment-grade analysis reports using ScrapeGraph."
---

A startup intelligence agent that performs comprehensive due diligence on companies by crawling their websites, analyzing public information, and producing investment-grade reports using ScrapeGraph.

## What It Does

- Crawls company websites comprehensively
- Extracts team, product, and pricing information
- Searches for funding news and press coverage
- Analyzes business model and market positioning
- Identifies risks and competitive advantages
...
```bash
python cookbook/01_showcase/01_agents/startup_analyst/examples/01_analyze_startup.py
```
...
```bash
python cookbook/01_showcase/01_agents/startup_analyst/examples/02_competitive_intel.py
```
...
```bash
python cookbook/01_showcase/01_agents/startup_analyst/examples/03_quick_scan.py
```
