...
description: "Emotion-aware translation with localized voice generation using Cartesia TTS."
---

An emotion-aware translation agent that translates text, analyzes emotional tone, selects an appropriate voice, and generates localized audio output using Cartesia TTS.

## What It Does

- Translates text to target language
- Analyzes emotional tone of content
- Selects voice matching emotion and language
- Creates localized voice clone
- Generates audio output with Cartesia TTS
...
```bash
python cookbook/01_showcase/01_agents/translation_agent/examples/01_basic_translation.py
```
...
```bash
python cookbook/01_showcase/01_agents/translation_agent/examples/02_emotional_content.py
```
...
```bash
python cookbook/01_showcase/01_agents/translation_agent/examples/03_batch_translate.py
```
...
| Parameter | Purpose |
|-----------|---------|
| `model` | GPT for translation and emotion analysis |
