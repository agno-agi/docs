---
title: "Discord Bot"
description: "Create a Discord bot powered by agents for community support, moderation, or custom commands."
---

Agno makes it easy to deploy your agents on Discord with just 2 extra lines of code.

This example creates a simple agent for answering questions in your Discord server:
...
<Note>
Unlike Slack and WhatsApp bots, Discord bots don't require webhooks or ngrok. They connect directly to Discord's Gateway API. You can deploy them on any service that supports continuous Python runtime (Railway, Render, AWS EC2, etc.). See [deployment tutorials](/templates/overview) for production setup.
</Note>

## Developer Resources

- [Discord Integration](/integrations/discord/overview)
- [Deployment Templates](/templates/overview)
