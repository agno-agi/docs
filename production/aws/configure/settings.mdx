...
<CardGroup cols={3}>
  ...
  <Card title="Database" icon="database" href="/production/aws/configure/database">
    RDS configuration
  </Card>
  <Card title="EFS Storage" icon="hard-drive" href="/production/aws/configure/efs">
    Persistent storage for Pal
  </Card>
</CardGroup>

<Note>
See [Environment Variables Reference](/production/aws/more/env-vars) for a complete list of app configuration options.
</Note>
