...
<AccordionGroup>
  ...
  <Accordion title="ECS task fails to start">
    Check that the EFS security group allows inbound NFS (port 2049) from your app security group. View the security group rules:
...
- [Monitoring](/production/aws/operate/monitoring) - CloudWatch logs
