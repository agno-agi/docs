...
<CardGroup cols={2}>
  ...
  <Card title="Python Packages" icon="box" href="/production/aws/configure/packages">
    Add custom dependencies
  </Card>
</CardGroup>

<Note>
See [Code Quality](/production/aws/more/code-quality) for formatting and validation scripts.
</Note>
