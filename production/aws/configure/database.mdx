...
description: "Configure RDS PostgreSQL and run migrations"
keywords: ["database", "RDS", "PostgreSQL", "pgvector", "migrations", "Alembic", "SQL"]
---
...
- [Database Tables Reference](/production/aws/reference/database-tables) - SQLAlchemy models
