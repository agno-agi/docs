...
<Warning>
[HTTPS](/production/aws/go-live/https) is required to connect to os.agno.com. You'll set this up after deployment.
</Warning>
...
<CardGroup cols={3}>
  <Card title="Configure Settings" icon="gear" href="/production/aws/configure/settings">
    Region, subnets, and ECR
  </Card>
  <Card title="Set Up Secrets" icon="key" href="/production/aws/configure/secrets">
    API keys and credentials
  </Card>
  <Card title="Verify Deployment" icon="check" href="/production/aws/go-live/verify">
