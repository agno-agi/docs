...
| Task | Guide |
|------|-------|
| Add persistent storage | [Configure EFS](/production/aws/configure/efs) |
| Set up automated deployments | [CI/CD](/production/aws/operate/ci-cd) |
| Monitor logs and metrics | [Monitoring](/production/aws/operate/monitoring) |
| Update your deployment | [Push Updates](/production/aws/operate/updates) |
