...
| Symptom | Next Step |
|---------|-----------|
| Health returns error | Check [CloudWatch logs](/production/aws/operate/monitoring) |
| No logs appearing | Check ECS task started in AWS Console |
| Task keeps restarting | See [Troubleshooting](/production/aws/operate/troubleshooting) |
