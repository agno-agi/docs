...
<Note>
For manual builds, see [Production Deployment](/production/aws/deploy/updates#create-an-ecr-repository). ECR tokens expire after 12 hours.
</Note>
...
<img src="/images/github-oidc-provider-assign-role.png" alt="Assign role to OIDC provider" />

2. Select **Create a new role**

<img src="/images/github-oidc-provider-create-new-role.png" alt="Create new IAM role" />

3. Confirm **Web identity** is selected as trusted entity, Identity provider shows GitHub, and Audience is `sts.amazonaws.com`

<img src="/images/github-oidc-provider-trusted-entity.png" alt="Configure trusted entity" />
...
- [Production Deployment](/production/aws/deploy/updates) - Manual deployment steps
- [Monitoring](/production/aws/manage/monitoring) - Watch your deployments
