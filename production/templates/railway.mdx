...
Find your URL in the dashboard (e.g., `my-agentos.up.railway.app`)
...
Open `https://your-domain.up.railway.app/docs` and try these prompts:

<Tip>
**Pal:** "Save a note: we decided to use Railway for deployment"

**Knowledge Agent:** "What is Agno and how does it work?"

**MCP Agent:** "What tools do you have access to?"
</Tip>
