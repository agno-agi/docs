...
<CardGroup cols={2}>
  <Card title="Filesystem" icon="folder" href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/00_filesystem.py">
    Explore a codebase or docs folder
  </Card>
  <Card title="Database" icon="database" href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/04_database_read_write.py">
    Read/write with separate engines
  </Card>
  <Card title="Multi-provider" icon="layer-group" href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/08_multi_provider.py">
    Three sources, no collisions
  </Card>
  <Card title="Gmail" icon="envelope" href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/18_gmail.py">
    Search, read, draft, send
  </Card>
  <Card title="Calendar" icon="calendar" href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/19_calendar.py">
    Events and availability
  </Card>
  <Card title="Wiki (git)" icon="code-branch" href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/15_wiki_git.py">
