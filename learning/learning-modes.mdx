...
Extraction happens automatically in the background and does not depend on an agent tool call. Stores such as Learned Knowledge and Decision Log can still expose tools when `enable_agent_tools=True`.
