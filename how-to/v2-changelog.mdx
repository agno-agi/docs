...
- `CustomEvent` is now supported and you can inherit from it to create your own custom events that can be yielded from your own tools. See the [documentation](/examples/concepts/agent/events/custom_events) for more details.
