...
For more examples and advanced patterns, see [here](/examples/basics/workflows/basic-workflows). Each file demonstrates a specific pattern with detailed comments and real-world use cases.
