...
For basic filtering with dictionary format, see [Search & Retrieval](/concepts/knowledge/search-retrieval).
...
For detailed examples, API-specific patterns, and troubleshooting, see the [API Filtering Guide](/agent-os/filter-knowledge).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
    href="/agent-os/filter-knowledge"
  >
  ...
  <Card
    ...
    href="/concepts/knowledge/search-retrieval"
  >
  ...
  <Card
    ...
    icon="book-open"
    href="/concepts/knowledge/knowledge-bases" 
  >
  ...
  <Card
    ...
    icon="gauge"
    href="/concepts/knowledge/performance-tips"
  >
