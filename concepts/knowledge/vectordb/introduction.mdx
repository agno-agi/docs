...
<CardGroup cols={2}>
  ...
  <Card title="High Performance" icon="zap" href="/concepts/knowledge/vectordb/qdrant">
...
<CardGroup cols={2}>
  ...
  <Card title="Embeddings" icon="vector-square" href="/concepts/knowledge/embedder/introduction">
