...
<Steps>
  ...
  <Step title="Set up your API key">
    ...
    ```
    <Note>This tutorial uses OpenAI, but Agno supports [many other models](/concepts/models/introduction).</Note>
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Content Types" icon="file-text" href="/concepts/knowledge/content_types">
    Learn about different ways to add content: files, URLs, databases, and more.
  </Card>
  <Card title="Chunking Strategies" icon="scissors" href="/concepts/knowledge/chunking/introduction">
    Optimize how your content is broken down for better search results.
  </Card>
  <Card title="Vector Databases" icon="database" href="/concepts/knowledge/vectordb/introduction">
    Choose the right storage solution for your needs and scale.
  </Card>
  <Card title="Search Types" icon="magnifying-glass" href="/concepts/knowledge/search">
