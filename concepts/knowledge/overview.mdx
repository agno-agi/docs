...
<CardGroup cols={3}>
  ...
  <Card title="Knowledge with Agents" icon="robot" href="/concepts/knowledge/agent">
    Learn how to use knowledge with agents.
  </Card>
  <Card title="Knowledge with Teams" icon="users" href="/concepts/knowledge/team">
    Learn how to use knowledge with teams.
  </Card>
  <Card title="Further Knowledge Concepts" icon="book-open" href="/concepts/knowledge/terminology">
    Learn how to use knowledge with teams.
  </Card>
</CardGroup>
