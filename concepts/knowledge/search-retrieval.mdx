...
For advanced filtering with complex logical conditions (OR, NOT, comparisons), see [Advanced Filtering](/concepts/knowledge/filters/advanced-filtering).
...
<CardGroup cols={3}>
  <Card
    ...
    icon="filter"
    href="/concepts/knowledge/filters/advanced-filtering"
  >
  ...
  <Card
    ...
    icon="database"
    href="/concepts/knowledge/content-db"
  >
  ...
  <Card
    ...
    href="/concepts/knowledge/hybrid-search"
  >
