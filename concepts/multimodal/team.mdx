...
- View [Image Team Examples](/examples/concepts/teams/multimodal/image_to_text)
- View [Audio Team Examples](/examples/concepts/teams/multimodal/audio_to_text)
- View [Video Team Examples](/examples/concepts/teams/multimodal/video_caption_generation)