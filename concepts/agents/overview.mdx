...
<CardGroup cols={3}>
  ...
  >
    Learn how to build your agents.
  </Card>
  <Card
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="images"
    iconType="duotone"
    href="/concepts/agents/multimodal"
  >
    Learn about multimodal agents and inputs.
  </Card>
  <Card
    title="Pre & Post Hooks"
    icon="link"
    iconType="duotone"
    href="/concepts/agents/hooks"
  >
    Learn about pre and post-execution hooks.
  </Card>
  <Card
    title="Guardrails"
    icon="shield-check"
    iconType="duotone"
    href="/concepts/agents/guardrails"
  >
    Learn about implementing safety guardrails.
  </Card>
</CardGroup>
