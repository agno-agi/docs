...
description: Learn how to manage Agent sessions.
---
...
- **`store_tool_messages`** - Controls storage of tool messages and their results  
...
- **Message pairs are removed together**: To maintain valid message sequences, when tool messages are removed from storage, the corresponding assistant messages that containes tool calls for that tool message are also removed. 
