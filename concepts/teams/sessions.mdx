...
description: Learn about Team sessions.
---
...
<Steps>
  <Step title="Customize session summaries example">
    ```python customize_session_summary.py
    from agno.team import Team
...
<Steps>
  <Step title="Session history search example">
...
As your sessions grow, storing every piece of data can bloat your database. Agno provides three flags to optimize storage while maintaining full functionality during execution:

- **`store_media`** - Controls storage of images, videos, audio, and files
- **`store_tool_results`** - Controls storage of tool calls and their results  
