...
description: Teams can run in different execution modes.
---
...
<Note>
`respond_directly` is not compatible with `delegate_task_to_all_members` or with delegating to multiple members.
</Note>
