...
- **How do I give the team context?** -> See the [context engineering](/concepts/context/team) documentation.
- **How do I add knowledge?** -> See the [knowledge](/concepts/knowledge/team) documentation.
