...
3. The model processes the input and decides whether to delegate to team members, call other tools, or respond directly.
...
You can enable streaming of intermediate steps by setting `stream_events=True`.
