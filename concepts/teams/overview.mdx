...
The team leader delegates tasks to members depending on the role of the members and the nature of the tasks.  See the [Execution Modes](/concepts/teams/execution-modes) guide for more details.
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="link"
    iconType="duotone"
    href="/concepts/teams/pre-hooks-and-post-hooks"
  >
  ...
  <Card
    ...
    icon="shield-check"
    iconType="duotone"
    href="/concepts/teams/guardrails"
  >
