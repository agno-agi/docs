...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="/concepts/workflows/workflow-patterns/parallel-workflow"
  >
  ...
  <Card
    ...
    icon="code-branch"
    href="/concepts/workflows/workflow-patterns/conditional-workflow"
  >
  ...
  <Card
    ...
    icon="rotate"
    href="/concepts/workflows/workflow-patterns/iterative-workflow"
  >
  ...
  <Card
    ...
    icon="sitemap"
    href="/concepts/workflows/workflow-patterns/branching-workflow"
  >
  ...
  <Card
    title="Grouped Steps"
    icon="layer-group"
    href="/concepts/workflows/workflow-patterns/grouped-steps-workflow"
  >
...
<CardGroup cols={3}>
  <Card
    ...
    icon="function"
    href="/concepts/workflows/workflow-patterns/custom-function-step-workflow"
  >
  ...
  <Card
    ...
    icon="puzzle-piece"
    href="/concepts/workflows/workflow-patterns/advanced-workflow-patterns"
  >
