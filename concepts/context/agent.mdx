...
If you are using a [Toolkit](/concepts/tools/toolkits/overview) on your agent, you can add tool instructions to the system message using the `instructions` parameter:
...
If you have database storage enabled on your agent, session history is automatically stored (see [sessions](/concepts/sessions/overview)).
