...
| `add_session_summary_to_context` | `bool`      | `False` | If True, add the session summary to the context. See [sessions](/concepts/sessions/overview) for more information.                                                           |
| `add_memories_to_context`        | `bool`      | `False` | If True, add the user memories to the context. See [memory](/concepts/memory/overview) for more information.                                                                 |
| `add_dependencies_to_context`    | `bool`      | `False` | If True, add the dependencies to the context. See [dependencies](/concepts/dependencies/overview) for more information.                                                      |
| `add_session_state_to_context`   | `bool`      | `False` | If True, add the session state to the context. See [state](/concepts/state/overview) for more information.                                                                   |
| `add_knowledge_to_context`       | `bool`      | `False` | If True, add retrieved knowledge to the context, to enable RAG. See [knowledge](/concepts/knowledge/overview) for more information.                                          |
...
If you are using a [Toolkit](/concepts/tools/toolkits/overview) on your team, you can add tool instructions to the system message using the `instructions` parameter:
...
See [dependencies](/concepts/dependencies/overview) for how to do dependency injection for your user message.
...
If you have database storage enabled on your team, session history is automatically stored (see [sessions](/concepts/sessions/overview)).
...
See more details on [sessions](/concepts/chat_history/overview).
