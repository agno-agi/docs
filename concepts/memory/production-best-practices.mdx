...
<CardGroup cols={2}>
  <Card title="Advanced Memory" icon="sliders" href="/concepts/memory/advanced">
    Explore advanced memory features and customization options
  </Card>
  <Card title="Memory Tools" icon="wrench" href="/concepts/tools/reasoning_tools/memory-tools">
    Full API reference for Memory Tools
  </Card>
