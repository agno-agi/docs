...
<Tip>
**Memory ≠ Session History:** Memory stores learned user facts ("Sarah prefers email"), [session history](/concepts/chat_history/overview) stores conversation messages for continuity ("what did we just discuss?").
</Tip>
...
Memories are stored in the database you connect to your agent. Agno supports all major database systems: Postgres, SQLite, MongoDB, and more. Check the [Storage documentation](/concepts/storage/overview) for the full list of supported databases and setup instructions.
