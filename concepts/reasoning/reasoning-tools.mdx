...
description: Reasoning tools help models think in structured steps, like using scratchpads or planning formats, which significantly enhances their reasoning capabilities.
...
The first version of the Reasoning Tools, previously known as Thinking tools, was published by Anthropic in [this blog post](https://www.anthropic.com/engineering/claude-think-tool).
...
- View [Teams with Reasoning Tools Examples](/examples/concepts/reasoning/tools/reasoning-finance-team)
