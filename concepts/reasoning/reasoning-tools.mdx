...
You can use multiple reasoning toolkits together for powerful multi-domain reasoning:
...
agent = Agent(
    ...
    tools=[
        ...
        KnowledgeTools(knowledge=my_knowledge, add_instructions=True),
        MemoryTools(db=my_db, add_instructions=True),
    ],
