...
You can learn more about them in the [Guardrails](/concepts/guardrails/overview) section.

## Developer Resources

- View [Agent Examples](/examples/concepts/agent/hooks)
- View [Team Examples](/examples/concepts/teams/hooks)
