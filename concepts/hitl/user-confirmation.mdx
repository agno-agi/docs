...
<CardGroup cols={2}>
  <Card
    ...
    icon="circle-check"
    href="/examples/concepts/agent/human_in_the_loop/confirmation_required"
  >
    View complete examples of user confirmation patterns
  </Card>
  <Card
    title="HITL Overview"
    icon="book"
...
- View [Examples](/examples/concepts/agent/human_in_the_loop/confirmation_required)
