...
<CardGroup cols={2}>
  <Card title="Dependencies Overview" icon="book" href="/concepts/dependencies/overview">
    Learn the fundamentals of dependency injection
  </Card>
  <Card title="Reference Dependencies" icon="link" href="/examples/concepts/teams/dependencies/reference-dependencies">
    Reference dependencies in instructions
  </Card>
  <Card title="Access Dependencies in Tool" icon="wrench" href="/examples/concepts/teams/dependencies/access-dependencies-in-tool">
