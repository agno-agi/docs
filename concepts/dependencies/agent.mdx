...
<CardGroup cols={2}>
  ...
  icon="book"
  href="/concepts/dependencies/overview">
    Learn about dependencies in Agno
  </Card>
  <Card title="Add Dependencies on Run"
  icon="play"
  href="/examples/concepts/agent/dependencies/add-dependencies-run">
    Pass dependencies to agent.run()
  </Card>
  <Card title="Add Dependencies to Context"
  icon="inbox"
  href="/examples/concepts/agent/dependencies/add-dependencies-to-context">
    Auto-inject dependencies into messages
  </Card>
  <Card title="Access in Tools"
  icon="wrench"
  href="/examples/concepts/agent/dependencies/access-dependencies-in-tool">
