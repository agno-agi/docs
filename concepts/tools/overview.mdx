...
# Importing our DuckDuckGoTools Toolkit, containing multiple web search tools
...
In this example, the `DuckDuckGoTools` toolkit is added to the agent. This ToolKit comes pre-configured with the `duckduckgo_search` function.
