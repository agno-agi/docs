...
description: Enable agents and teams to generate files in multiple formats including JSON, CSV, PDF, and TXT
keywords: [file generation, PDF, CSV, JSON, TXT, tools, toolkit]
mode: wide
---
...
<Tip>
FileGenerationTools supports generating the following file types: 
- TXT
- JSON
- CSV
- PDF
