...
Agents backed by a database persist their [sessions](/concepts/sessions/overview) to it. You can then load this persisted history into the context to maintain continuity across sessions.
