...
In addition this DB is used to store [knowledge](/concepts/knowledge/content-db), [evals](/concepts/evals/overview) and [culture](/concepts/culture/overview).
<Note>
...
<Note>
We also support using an [In-Memory](/concepts/storage/in_memory) database. This is not recommended for production, but perfect for demos and testing.
</Note>
