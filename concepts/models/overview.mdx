...
<CardGroup cols={2}>
  <Card title="Supported Model Providers" icon="layers" href="/concepts/models/model-index">
    See the full list of supported model providers.
  </Card>
  <Card title="Model-as-string" icon="code" href="/concepts/models/model-as-string">
    Use the convenient provider:model_id string format to specify models without importing model classes.
  </Card>
  <Card title="Compatibility" icon="compare" href="/concepts/models/compatibility">
    See what features are supported by each model provider.
  </Card>
  <Card title="Cache Response" icon="database" href="/concepts/models/cache-response">
