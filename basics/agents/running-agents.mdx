...
description: "Execute agents with Agent.run() and process their output."
---
...
<Tip>
Run the agent asynchronously using `Agent.arun()`. See this [example](/basics/agents/running-agents).
</Tip>
...
<Tip>
See [Input & Output](/basics/input-output/overview) for structured input and output.
</Tip>
...
- `metrics`: The metrics of the run. See [Metrics](/basics/sessions/metrics/overview).
...
<Tip>
For asynchronous streaming, see this [example](/basics/agents/running-agents).
</Tip>
...
See [Agent Sessions](/basics/sessions/overview) for more details.
...
See [Multimodal Agents](/features/multimodal/overview) for more details.
...
See [Input & Output](/basics/input-output/overview) for more details.
...
See [Human-in-the-Loop](/execution-control/hitl/overview) for more details.

## Cancelling a Run

Cancel a run with `Agent.cancel_run()`.

See [Cancelling a Run](/execution-control/run-cancellation/overview) for more details.
