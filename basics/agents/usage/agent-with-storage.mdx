...
description: "Persist conversation history across runs with database storage."
mode: wide
---
...
- **`add_history_to_context=True`:** Adds previous messages to the context sent to the model
- **`num_history_runs=5`:** Number of previous runs to include in context
