...
description: "Give your agent persistent memory of user preferences."
mode: wide
---

Memory lets your agent remember facts about users across conversations. Different from storage (which persists conversation history), memory stores user-level information like preferences and context.
