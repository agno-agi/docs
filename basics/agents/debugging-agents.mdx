...
Agno has an exceptional **debug mode**, to take your development experience to the next level.

With debug mode, you can better understand all intermediate steps taking place during your agent runs.

Specifically, debug mode will help you:
...
3. Inspect tool calls, errors, and their results. This can help you identify issues with your tools and improve their reliability.
