...
- See the [Guardrails](/concepts/guardrails/overview) documentation for more details.
...
You can see complete examples of pre-hooks in the [Examples](/examples/basics/agent/hooks) section.
...
You can see complete examples of post-hooks in the [Examples](/examples/basics/agent/hooks) section.
...
- View [Agent Examples](/examples/basics/agent/hooks)
- View [Team Examples](/examples/basics/teams/hooks)
