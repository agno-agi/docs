...
description: Learn how to load skills into your agents using LocalSkills and the Skills orchestrator.
---

Skills are loaded using the `Skills` class with one or more `SkillLoader` implementations. Currently, `LocalSkills` is available for loading skills from the filesystem.
