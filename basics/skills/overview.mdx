...
Skills are packages of domain expertise that extend your agent's capabilities. Based on [Anthropic's Agent Skills](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview) concept, they provide a structured way to give agents specialized knowledge and capabilities.
...
Instead of cramming everything into the system prompt, skills let you organize domain knowledge into focused packages. The agent loads only what it needs, when it needs it.
...
<CardGroup cols={2}>
  <Card title="Creating Skills" icon="hammer" href="/basics/skills/creating-skills">
    Learn how to create your own skills with instructions, scripts, and references
  </Card>
  <Card title="Loading Skills" icon="download" href="/basics/skills/loading-skills">
