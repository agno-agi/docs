...
When a thread grows beyond a few turns, pass a condensed summary instead of the entire transcript. Agno can generate and maintain those summaries for you—just enable `enable_session_summaries` on the Agent/Team.
