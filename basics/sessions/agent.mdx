...
See more examples in [Disable Storing History Messages](/examples/basics/agent/session/disable-storing-history-messages) and [Disable Storing Tool Messages](/examples/basics/agent/session/disable_storing_tool_messages).
