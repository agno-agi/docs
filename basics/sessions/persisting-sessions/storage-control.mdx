...
<CardGroup cols={2}>
  <Card
    ...
    href="/basics/sessions/persisting-sessions/usage/disable-history-storage"
  >
  ...
  <Card
    ...
    icon="wrench"
    href="/basics/sessions/persisting-sessions/usage/disable-tool-storage"
  >
    Agent example for tool message storage control
  </Card>
  <Card
    title="Disable Storing Media"
    icon="image"
    href="/basics/sessions/persisting-sessions/usage/disable-media-storage"
  >
    Agent example for media storage control
  </Card>
</CardGroup>
