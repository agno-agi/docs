...
See [examples](/examples/basics/workflows/06_workflows_advanced_basics/access_session_state_in_custom_python_function_step) for more details.
...
See example of [Session State in Condition Evaluator Function](/examples/basics/workflows/06_workflows_advanced_basics/access_session_state_in_condition_evaluator_function)
and [Session State in Router Selector Function](/examples/basics/workflows/06_workflows_advanced_basics/access_session_state_in_router_selector_function) for more details.
...
<CardGroup cols={3}>
  <Card
    ...
    icon="user"
    href="https://github.com/agno-agi/agno/tree/main/cookbook/workflows/_06_advanced_basics/_04_shared_session_state/shared_session_state_with_agent.py"
  >
  ...
  <Card
    title="Team Examples"
    icon="users"
    href="https://github.com/agno-agi/agno/tree/main/cookbook/workflows/_06_advanced_basics/_04_shared_session_state/shared_session_state_with_team.py"
  >
