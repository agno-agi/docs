...
See [examples](/basics/workflows/usage/access-session-state-in-custom-python-function-step) for more details.
...
See example of [Session State in Condition Evaluator Function](/basics/workflows/usage/access-session-state-in-condition-evaluator-function)
and [Session State in Router Selector Function](/basics/workflows/usage/access-session-state-in-router-selector-function) for more details.
