...
See [examples](/examples/basics/workflows/workflows-advanced-concepts/access-session-state-in-custom-python-function-step) for more details.
...
See example of [Session State in Condition Evaluator Function](/examples/basics/workflows/workflows-advanced-concepts/access-session-state-in-condition-evaluator-function)
and [Session State in Router Selector Function](/examples/basics/workflows/workflows-advanced-concepts/access-session-state-in-router-selector-function) for more details.
