...
If you are using a [Toolkit](/basics/tools/toolkits/overview) on your team, you can add tool instructions to the system message using the `instructions` parameter:
...
See the [full example](/examples/basics/teams/context_management/filter_tool_calls_from_history) for a complete demonstration.
