...
knowledge.insert(path=Path("data/csv"))

# Query the agent
agent.print_response("What is the csv file about", markdown=True)
```
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U pandas sqlalchemy psycopg pgvector agno
    ```
  </Step>
