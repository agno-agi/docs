...
For more information about the different readers and their capabilities checkout the [Readers](/basics/knowledge/readers/overview) page.
...
<CardGroup cols={3}>
  ...
  <Card title="Readers" icon="book-open" href="/basics/knowledge/readers/overview">
