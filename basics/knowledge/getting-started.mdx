...
<CardGroup cols={3}>
<<<<<<< HEAD:basics/knowledge/getting-started.mdx
  <Card title="Content Types" icon="file-lines" href="/basics/knowledge/content_types">
=======
  <Card title="Content Types" icon="file-lines" href="/concepts/knowledge/content-types">
>>>>>>> 287f4476 ([Update / Cleanup] Context Engineering > Knowledge):concepts/knowledge/getting-started.mdx
  ...
  <Card title="Search Types" icon="magnifying-glass" href="/basics/knowledge/search-retrieval">
