...
In this example, the `AgentAsJudgeEval` will run the Agent with the input, then use an evaluator model to score the Agent's response according to the custom criteria provided.
