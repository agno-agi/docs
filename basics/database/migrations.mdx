...
<Tabs>
  <Tab title="Database Connection Errors">
    Verify your database connection string and ensure the database is running and accessible.
  </Tab>
  <Tab title="Migration Errors">
    If you are facing migration errors, please check the error message and troubleshoot accordingly.
  </Tab>
</Tabs>
