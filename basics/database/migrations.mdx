...
If you are using the [AgentOS](/agent-os/introduction), you can run the migrations using the migration endpoints. You can read more about it in the [AgentOS database migrations page](/agent-os/database-migrations).
