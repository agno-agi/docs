...
- [Workflow with Input Schema Validation](/examples/basics/workflows/workflows-advanced-concepts/workflow-with-input-schema)
...
- [Structured IO at each Step Level](/examples/basics/workflows/workflows-advanced-concepts/structured-io-at-each-step-level)
...
- [Image/Video Selection Sequence](/examples/basics/workflows/workflows-conditional-branching/selector-for-image-video-generation-pipelines)