...
<CardGroup cols={3}>
  <Card title="Development & Testing" icon="laptop-code" href="/basics/vectordb/lancedb">
    **LanceDB** - Fast, local, no setup required
  </Card>
  <Card title="Production at Scale" icon="server" href="/basics/vectordb/pgvector">
    **PgVector** - Reliable, scalable, full SQL support
  </Card>
  <Card title="Managed Service" icon="cloud" href="/basics/vectordb/pinecone">
    **Pinecone** - Fully managed, no operations overhead
  </Card>
  <Card title="High Performance" icon="gauge" href="/basics/vectordb/qdrant">
...
<CardGroup cols={3}>
  ...
  <Card title="Search & Retrieval" icon="magnifying-glass" href="/basics/knowledge/search-retrieval">
