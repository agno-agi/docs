...
- [Sequence of Functions and Agents](/examples/basics/workflows/basic-workflows/sequence-of-functions-and-agents) - Complete workflow with functions and agents
...
Take a look at the schemas for [`StepInput`](/reference/workflows/step-input) and [`StepOutput`](/reference/workflows/step-output).
