...
For a detailed example see [Class-based Executor](/examples/basics/workflows/basic-workflows/class-based-executor).
...
- [Step with a Custom Function](/examples/basics/workflows/basic-workflows/step-with-function)
- [Step with a Custom Function with Streaming on AgentOS](/examples/basics/workflows/basic-workflows/step-with-function-streaming-agentos)
- [Parallel and custom function step streaming on AgentOS](/examples/basics/workflows/workflows-parallel-execution/parallel-and-custom-function-step-streaming-agentos)