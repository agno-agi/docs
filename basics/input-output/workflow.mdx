...
description: Learn how to use structured input and output with Workflows for type-safe, production-ready systems.
keywords: [workflow input, workflow output, structured input, pydantic, type safety, validation, workflow schema]
---
...
- [Pydantic Model as Input](/examples/basics/teams/input-output/pydantic-model-as-input)
- [Workflow with Input Schema Validation](/examples/basics/workflows/06_workflows_advanced_concepts/workflow_with_input_schema)
...
- [Structured IO at each Step Level](/examples/basics/workflows/06_workflows_advanced_concepts/structured_io_at_each_step_level)
...
- View [Workflow Reference](/reference/workflows/workflow)
- View [Cookbook Examples](https://github.com/agno-agi/agno/tree/main/cookbook/workflows)