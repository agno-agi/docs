...
- [Pydantic Model as Input](/basics/input-output/workflow/usage/pydantic-input)
- [Workflow with Input Schema Validation](/basics/input-output/workflow/usage/input-schema-validation)
...
- [Structured IO at each Step Level](/basics/input-output/workflow/usage/structured-output)
...
- [Media Input Usage Example](/basics/input-output/workflow/usage/media-input)
- [Image/Video Selection Sequence (GitHub)](https://github.com/agno-agi/agno/blob/main/cookbook/workflows/_05_workflows_conditional_branching/sync/selector_for_image_video_generation_pipelines.py)

## Usage Examples

Explore comprehensive examples for different input and output patterns:
...
<CardGroup cols={2}>
  <Card
    ...
    icon="play"
    iconType="duotone"
    href="/basics/input-output/workflow/usage/basic-workflow"
  >
    Simple workflow with string input
  </Card>
  
  <Card
    title="Pydantic Model Input"
    icon="shield-check"
    iconType="duotone"
    href="/basics/input-output/workflow/usage/pydantic-input"
  >
    Type-safe, validated input with Pydantic models
  </Card>
  ...
  <Card
    ...
    icon="check-double"
    iconType="duotone"
    href="/basics/input-output/workflow/usage/input-schema-validation"
  >
    Enforce input validation with schemas
  </Card>
  ...
  <Card
    ...
    icon="diagram-cells"
    iconType="duotone"
    href="/basics/input-output/workflow/usage/structured-output"
  >
    Type-safe output with Pydantic models at each step
  </Card>
  ...
  <Card
    ...
    icon="image"
    iconType="duotone"
    href="/basics/input-output/workflow/usage/media-input"
  >
  ...
  <Card
    ...
    icon="database"
    iconType="duotone"
    href="/basics/input-output/workflow/usage/session-state"
  >
