...
- [Pydantic Model as Input](/basics/input-output/team/usage/pydantic-model-as-input)
- [Workflow with Input Schema Validation](/basics/workflows/usage/workflow-with-input-schema)
...
- [Structured IO at each Step Level](/basics/workflows/usage/structured-io-at-each-step-level)
...
- [Image/Video Selection Sequence](/basics/workflows/usage/selector-for-image-video-generation-pipelines)