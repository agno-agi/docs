...
- [Pydantic Model as Input](/examples/basics/teams/input_output/pydantic_model_as_input)
- [Workflow with Input Schema Validation](/examples/basics/workflows/06_workflows_advanced_basics/workflow_with_input_schema)
...
- [Structured IO at each Step Level](/examples/basics/workflows/06_workflows_advanced_basics/structured_io_at_each_step_level)
...
- [Image/Video Selection Sequence](/examples/basics/workflows/05_workflows_conditional_branching/selector_for_image_video_generation_pipelines)
