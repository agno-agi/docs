---
title: Workflow with Session State
---

This example demonstrates how to maintain shared state across workflow runs using session state.
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    ```bash
    touch shared_session_state_with_agent.py
    ```
  </Step>
  ...
  <Step title="Find All Cookbooks">
    ...
    <Link href="https://github.com/agno-agi/agno/tree/main/cookbook/workflows/_06_advanced_concepts/_04_shared_session_state" target="_blank">
