...
description: Troubleshoot and inspect team behavior with debug mode and interactive CLI.
keywords: [teams, debugging teams]
---

Agno comes with a debug mode that helps you understand the flow of execution and the intermediate steps. For example:
...
Agno also comes with a pre-built interactive CLI that runs your Team as a command-line application. Use this to test multi-turn conversations with your team.
