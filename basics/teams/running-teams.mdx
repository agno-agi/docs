...
7. **Response is processed** and parsed into an [`output_schema`](/basics/input-output/team/overview#structured-output) if provided.
...
For more information see the [Team Sessions](/basics/sessions/team) documentation.
