...
- **How do I add history to my team?** -> See the [chat history](/basics/chat-history/team) documentation.
- **How do I manage sessions?** -> See the [team sessions](/basics/sessions/team) documentation.
