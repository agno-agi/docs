...
<Note>
If you are migrating from Agno v1.x.x, the `mode` parameter has been deprecated. See the [Migration Guide](/other/v2-migration#teams) for details on migrating your teams.
</Note>
