...
<CardGroup cols={3}>
  <Card title="Basic Coordination" icon="link" href="/basics/teams/usage/basic-team">
    Basic team coordination pattern
  </Card>
  <Card title="Member Responds Directly" icon="link" href="/basics/teams/usage/respond-directly">
    Router pattern with direct response
  </Card>
  <Card title="Delegate to All Members" icon="link" href="/basics/teams/delegation">
...
- [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/04_teams/basic_flows/README.md)
