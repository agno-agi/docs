...
<Info>
  For detailed AgentOS tracing configuration including multi-database setups, see [Tracing in AgentOS](/agent-os/tracing/tracing).
</Info>
...
## Developer Reconstruct
- See [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/integrations/observability/trace_to_database.py) for full example code.