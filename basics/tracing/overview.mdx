...
In the systems you build with Agno, agents will make autonomous decisions, interact with external tools, and coordinate with each other in ways that aren't immediately visible from logs alone. To stay on top of how your systems are working, you will want a good observability approach.

**Agno Tracing** is our recommended way to introduce observability for your Agno agents and teams. It automatically captures all relevant execution details, helping you understand what your agents are doing, simplifying debugging and helping you optimize your system.
