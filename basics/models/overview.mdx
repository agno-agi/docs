...
<CardGroup cols={2}>
  <Card title="Supported Model Providers" icon="layer-group" href="/concepts/models/model-index">
    See the full list of supported model providers.
  </Card>
  <Card title="Model-as-string" icon="code" href="/basics/models/mo del-as-string">
