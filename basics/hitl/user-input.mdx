...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="list-check"
    href="/examples/basics/agent/hitl/user-input-required-all-fields"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/examples/basics/agent/hitl/user-input-required-async"
  >
  ...
  <Card
    ...
    icon="water"
    href="/examples/basics/agent/hitl/user-input-required-stream-async"
  >
