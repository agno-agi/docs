...
If you need to continue a run from a different context (like a different process or after storing the state), you can use the `run_id` approach:

```python
run_response = agent.run("Perform sensitive operation")

if run_response.is_paused:
    # Mark tools as confirmed
    for tool in run_response.tools_requiring_confirmation:
        tool.confirmed = True
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="bolt"
    href="/examples/basics/agent/hitl/confirmation-required-async"
  >
  ...
  <Card
    title="Mixed Tools"
    icon="layer-group"
    href="/examples/basics/agent/hitl/confirmation-required-mixed-tools"
  >
  ...
  <Card
    ...
    icon="list"
    href="/examples/basics/agent/hitl/confirmation-required-multiple-tools"
  >
  ...
  <Card
    ...
    icon="water"
    href="/examples/basics/agent/hitl/confirmation-required-stream-async"
  >
  ...
  <Card
    ...
    icon="toolbox"
    href="/examples/basics/agent/hitl/confirmation-required-toolkit"
  >
  ...
  <Card
    ...
    href="/examples/basics/agent/hitl/confirmation-required-with-history"
  >
  ...
  <Card
    title="With Run ID"
    icon="id-badge"
    href="/examples/basics/agent/hitl/confirmation-required-with-run-id"
  >
