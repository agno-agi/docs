...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="bolt"
    href="/examples/basics/agent/hitl/external-tool-execution-async"
  >
  ...
  <Card
    ...
    icon="water"
    href="/examples/basics/agent/hitl/external-tool-execution-stream-async"
  >
  ...
  <Card
    ...
    icon="toolbox"
    href="/examples/basics/agent/hitl/external-tool-execution-toolkit"
  >
