...
Guardrails are implemented as [pre-hooks](/concepts/hooks/overview), which execute before your Agent processes input. This allows them to validate, filter, or transform the input before it reaches the LLM.
...
You can see complete examples using the Agno Guardrails in the [examples](/examples/basics/agent/guardrails) section.
...
<CardGroup cols={2}>
  <Card
    title="Agent Guardrails Examples"
    icon="shield"
    href="/examples/concepts/agent/guardrails/pii_detection"
  >
    Protect agents with PII detection, prompt injection defense, and content moderation
  </Card>
  <Card
    title="Team Guardrails Examples"
    icon="shield-halved"
    href="/examples/concepts/teams/guardrails/pii_detection"
  >
    Apply guardrails to team workflows for comprehensive protection
  </Card>
  <Card
    title="PII Detection"
    icon="user-shield"
    href="/concepts/guardrails/included/pii"
  >
  ...
  <Card
    ...
    icon="bug-slash"
    href="/concepts/guardrails/included/prompt-injection"
  >
...
- View [Agent Examples](/examples/basics/agent/guardrails)
- View [Team Examples](/examples/basics/teams/guardrails)
