...
<Note>
For all forms of session history, you need to have a database assigned to the team. See [Storage](/basics/storage/overview) for more details.
</Note>
...
See the full example in the [Add history to the team context](/basics/chat-history/team/usage/respond-directly-with-history) documentation.
...
See the full example in the [Team History for Members](/basics/chat-history/team/usage/team-history) documentation.
...
```
See the full example in the [Share Member Interactions](/basics/chat-history/team/usage/share-member-interactions) documentation.
