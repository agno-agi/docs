...
<Note>
**Database Requirement**: All history features require a database configured on the team. See [Storage](/basics/storage/overview) for setup.
</Note>
...
See the [Direct Response with Team History](/examples/basics/teams/basic/respond-directly-with-history) example for a complete implementation.
...
See the [Team History for Members](/examples/basics/teams/basic/team-history) example for a complete implementation.
...
See the [Share Member Interactions](/examples/basics/teams/basic/share-member-interactions) example for a complete implementation.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="reply"
    iconType="duotone"
    href="/examples/basics/teams/basic/respond-directly-with-history"
  >
  ...
  <Card
    ...
    icon="share-nodes"
    iconType="duotone"
    href="/examples/basics/teams/basic/team-history"
  >
  ...
  <Card
    ...
    icon="user-check"
    iconType="duotone"
    href="/examples/basics/teams/basic/history-of-members"
  >
  ...
  <Card
    ...
    icon="comments"
    iconType="duotone"
    href="/examples/basics/teams/basic/share-member-interactions"
  >
