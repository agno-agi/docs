...
Refer to [StepInput](/reference/workflows/step-input) reference for more details.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="rotate"
    iconType="duotone"
    href="/examples/basics/workflows/workflows-advanced-concepts/workflow-history/single-step-continuous-execution-workflow"
  >
  ...
  <Card
    ...
    icon="list-check"
    iconType="duotone"
    href="/examples/basics/workflows/workflows-advanced-concepts/workflow-history/workflow-with-history-enabled-for-steps"
  >
    Add workflow history to all steps in the workflow.
  </Card>
  <Card
    ...
    icon="toggle-on"
    iconType="duotone"
    href="/examples/basics/workflows/workflows-advanced-concepts/workflow-history/enable-history-for-step"
  >
  ...
  <Card
    ...
    icon="code"
    iconType="duotone"
    href="/examples/basics/workflows/workflows-advanced-concepts/workflow-history/get-history-in-function"
  >
