...
<Note>
**Database Requirement**: All history features require a database configured on the agent. See [Storage](/basics/storage/overview) for setup.
</Note>
...
See the [Persistent Session with History](/examples/basics/agent/session/persistent-session-history) example for a complete implementation.
...
See the [Chat History Management](/examples/basics/agent/session/chat-history) example for a complete implementation.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="message"
    iconType="duotone"
    href="/examples/basics/agent/session/chat-history"
  >
  ...
  <Card
    ...
    icon="database"
    iconType="duotone"
    href="/examples/basics/agent/session/persistent-session-history"
  >
