...
description: "Control which details MemoryManager captures with memory_capture_instructions."
---

Pass `memory_capture_instructions` to control what a `MemoryManager` captures. The first manager below only records academic interests. The second uses the default instructions for comparison.
