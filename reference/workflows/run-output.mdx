...
description: "Attributes of WorkflowRunOutput, the events streamed during a workflow run, and workflow metrics."
---
...
| `step_executor_runs` | `Optional[List[Union[RunOutput, TeamRunOutput, WorkflowRunOutput]]]` | `None` | Store agent/team/nested workflow responses separately with parent_run_id references |
