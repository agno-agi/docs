...
| `sessions` | Agent, team, and workflow session data |
| `metrics` | Performance and usage metrics |
| `evals` | Evaluation results |
| `knowledge` | Knowledge base entries |
| `culture` | Cultural knowledge entries |
| `approvals` | Human-in-the-loop approval records |

## See Also

- [Database Migrations Guide](/other/database-migrations)
- [Migration Scripts](https://github.com/agno-agi/agno/tree/v2.7.4/libs/agno/agno/db/migrations)
