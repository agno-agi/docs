...
| `images` | `List[ImageArtifact]` | `None` | List of images from member runs |
| `videos` | `List[VideoArtifact]` | `None` | List of videos from member runs |
| `audio` | `List[AudioArtifact]` | `None` | List of audio snippets from member runs |
| `response_audio` | `AudioResponse` | `None` | The model's raw response in audio |
