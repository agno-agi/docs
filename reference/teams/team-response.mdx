...
description: "Attributes of TeamRunOutput and the events streamed during a team run."
---
...
| `title` | `str` | `""` | Title of the task |
| `status` | `str` | `""` | New status: pending, in_progress, completed, failed, or blocked |
