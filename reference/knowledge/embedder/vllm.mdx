...
## Developer Resources
- [Local mode cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/07_knowledge/09_archive/embedders/vllm_embedder_local.py)
- [Remote mode cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/07_knowledge/09_archive/embedders/vllm_embedder_remote.py)
