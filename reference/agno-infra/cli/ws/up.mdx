---
title: ag infra up
description: "Options for ag infra up: create resources for the active AgentOS codebase, filtered by env, infra, group, name, or type."
---
...
<ResponseField name="force" type="bool">
  Force create resources where applicable. `--force` `-f`
</ResponseField>
