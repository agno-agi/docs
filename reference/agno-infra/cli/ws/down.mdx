---
title: ag infra down
description: "Options for ag infra down: delete resources for the active AgentOS codebase, filtered by env, infra, group, name, or type."
---

Delete resources for active AgentOS codebase
