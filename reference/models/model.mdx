...
| `cache_ttl`          | `Optional[int]`                    | `None`                         | Time-to-live for cached responses in seconds. If None, cache never expires                                      |
| `cache_dir`          | `Optional[str]`                    | `None`                         | Directory path for storing cached responses. If None, uses default cache location                               |
