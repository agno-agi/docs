...
title: Claude
sidebarTitle: Claude
description: "Configure the Claude model class, Agno's wrapper for Anthropic's Messages API."
---
...
| `api_key`                      | `Optional[str]`             | `None`                         | The API key for authenticating with Anthropic (defaults to ANTHROPIC_API_KEY env var) |
