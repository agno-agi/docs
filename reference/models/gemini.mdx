...
title: Gemini
sidebarTitle: Gemini
description: "Parameter reference for the Gemini model class, covering Google AI Studio and Vertex AI configuration."
---
...
| `model_type`                    | `ModelType`                   | `ModelType.MODEL`              | Functional role of this model (e.g. `MODEL`, `OUTPUT_MODEL`, `PARSER_MODEL`). Set by the agent during initialization |
