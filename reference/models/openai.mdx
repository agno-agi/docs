...
title: OpenAI
sidebarTitle: OpenAI
description: "Configure OpenAIChat, Agno's model class for OpenAI's Chat Completions API."
---
...
| `reasoning_effort`           | `Optional[ReasoningEffort]`    | `None`                 | Model-dependent reasoning effort. Named values are `none`, `minimal`, `low`, `medium`, `high`, `xhigh`, and `max`; any other string is passed through, and model support varies. See [Create chat completion](https://developers.openai.com/api/reference/resources/chat/subresources/completions/methods/create). |
