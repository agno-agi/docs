...
<ResponseField name="user_message" type="Union[str, Message]" optional>
  An optional message added to the conversation as a `user` message before the retry.
</ResponseField>

<ResponseField name="agent_message" type="Union[str, Message]" optional>
  An optional message added to the conversation as an `assistant` message before the retry.
</ResponseField>
