...
| --------- | ---- | ------- | ----------- |
| `embedder` | `Embedder` | `OpenAIEmbedder` | The embedder to use for generating embeddings. Supports any Agno embedder (e.g., `AzureOpenAIEmbedder`, `CohereEmbedder`, `GeminiEmbedder`). |
