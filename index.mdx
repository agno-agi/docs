    ...
    <section className="mt-20 flex flex-col items-center gap-6 text-center">
      ...
      <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        >
          ...
          <h3 className="text-base font-semibold text-start text-zinc-900 dark:text-zinc-100">Production Patterns</h3>
          <p className="text-xs leading-relaxed text-start text-zinc-500 dark:text-zinc-400">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-5 sm:px-8 lg:grid-cols-5 lg:px-10">
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="/first-agent" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Quickstart</a></li>
            <li><a href="/get-help" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Getting Help</a></li>
          </ul>
        </div>
