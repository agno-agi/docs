...
description: Build, run, and manage multi-agent systems. Create agents, teams, and workflows with memory, knowledge, and 100+ tool integrations.
mode: custom
---
    ...
    <section className="mt-20 flex flex-col items-center gap-6 text-center">
      ...
      <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        >
          ...
          <p className="text-xs leading-relaxed text-start text-zinc-500 dark:text-zinc-400">
            Turn your Agents into a production system.
          </p>
        </a>
        ...
        >
          ...
          <h3 className="text-base font-semibold text-start text-zinc-900 dark:text-zinc-100">Tutorials</h3>
          <p className="text-xs leading-relaxed text-start text-zinc-500 dark:text-zinc-400">
            Step-by-step guides for production patterns.
          </p>
        </a>
      </div>
    </section>
    ...
    <section className="mt-20 pb-12">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-5 sm:px-8 lg:grid-cols-5 lg:px-10">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="/tutorials" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Tutorials</a></li>
            <li><a href="/cookbook" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Cookbook</a></li>
            <li><a href="/reference" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">SDK API</a></li>
            <li><a href="/reference-api" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">AgentOS API</a></li>
          </ul>
        </div>
