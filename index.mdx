...
export const CodeTabs = ({ tabs, defaultTab }) => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div style={{ position: 'relative', borderRadius: '16px', border: '1px solid #27272a', background: '#09090b', padding: '20px', overflow: 'auto' }}>
        <pre style={{ margin: 0, padding: 0, overflow: 'auto', fontSize: '13px', lineHeight: '1.8', fontFamily: '"JetBrains Mono", "Fira Code", Monaco, Consolas, monospace' }}>
          <code style={{ color: '#e5e7eb', whiteSpace: 'pre' }}>
            {currentTab?.language && (
              <span style={{ display: 'block', fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.15em', color: '#ff4017', marginBottom: '16px', fontWeight: 600 }}>
                {currentTab.language}
              </span>
            )}
            {currentTab?.code}
    ...
    },
    {
        ...
        code: (
          <>
            ...
            <span style={{ color: colors.variable }}>team</span>.<span style={{ color: colors.function }}>print_response</span>(<span style={{ color: colors.string }}>"Research AI trends and summarize the top articles"</span>)
          </>
        ),
    },
    {
        ...
        code: (
          <>
            ...
            {'\n'}
            <span style={{ color: colors.variable }}>workflow</span> <span style={{ color: colors.operator }}>=</span> <span style={{ color: colors.function }}>Workflow</span>({'\n'}
            {'    '}<span style={{ color: colors.property }}>name</span><span style={{ color: colors.operator }}>=</span><span style={{ color: colors.string }}>"Content Workflow"</span>,{'\n'}
            {'    '}<span style={{ color: colors.property }}>description</span><span style={{ color: colors.operator }}>=</span><span style={{ color: colors.string }}>"A workflow for creating content"</span>,{'\n'}
            {'    '}<span style={{ color: colors.property }}>steps</span><span style={{ color: colors.operator }}>=</span>[<span style={{ color: colors.variable }}>researcher</span>, <span style={{ color: colors.variable }}>writer</span>],{'\n'}
            ){'\n'}
            {'\n'}
            <span style={{ color: colors.variable }}>workflow</span>.<span style={{ color: colors.function }}>print_response</span>(<span style={{ color: colors.string }}>"Create a blog post about AI agents"</span>, <span style={{ color: colors.property }}>stream</span><span style={{ color: colors.operator }}>=</span><span style={{ color: colors.keyword }}>True</span>)
          </>
        ),
    },
    {
