...
description: Build workflows that reference previous runs across multiple executions using workflow history.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="terminal"
    iconType="duotone"
    href="/history/workflow/multi-purpose-cli"
  >
  ...
  <Card
    ...
    icon="route"
    iconType="duotone"
    href="/history/workflow/intent-routing-with-history"
  >
