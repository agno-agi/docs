...
A [`.cursorrules`](https://cursor.com/docs/context/rules) file teaches AI coding assistants (like Cursor, Windsurf) how to build better agents with Agno.

<Note>
Cursor's primary rules format is now [Project Rules](https://cursor.com/docs/context/rules) (`.cursor/rules/*.mdc`).
</Note>
...
curl -o .cursorrules https://raw.githubusercontent.com/agno-agi/agno/v2.7.4/.cursorrules
...
<Card title="View .cursorrules on GitHub" icon="github" href="https://github.com/agno-agi/agno/blob/v2.7.4/.cursorrules">
...
<CardGroup cols={3}>
  <Card title="Agent Examples" icon="code" href="/examples/agents/overview">
