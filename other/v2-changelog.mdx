...
- Knowledge has been completely reworked. See full details in the [Knowledge](/knowledge/what-is-knowledge) section.
...
- Import locations for `embedder`, `document`, `chunking`, `reranker` and `reader` have been moved to `agno.knowledge`. See [examples](/knowledge/what-is-knowledge) for more details.
