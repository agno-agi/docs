...
You can find examples for other databases and advanced scenarios in the [Memory documentation](/context/memory/overview).
...
from any sources. For a full example of the usage, see the [Content Types](/context/knowledge/content-types) page.
