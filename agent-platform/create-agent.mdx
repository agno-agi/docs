...
Because you're running a unified platform (i.e. code, data and logs live in one place), coding agents can manage it end-to-end. The codebase ships six skills that cover the full agent development lifecycle.
