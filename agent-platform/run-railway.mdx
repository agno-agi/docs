...
<Warning>
  `down.sh` confirms the linked project name, deletes the app and database, verifies that the project is gone, and unlinks the directory. All database data is deleted. Pass `--yes` to skip the confirmation.
</Warning>
