...
As the platform grows, component registration, configuration, environment variables, and documentation can drift. The `review-and-improve` skill checks those contracts and fixes mechanical inconsistencies:
