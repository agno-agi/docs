...
Agent code, logs, traces, evals, and service configuration live in one repository. The included coding-agent skills cover setup, agent creation and improvement, eval authoring and repair, repository review, and deployment.
