...
| **CodeSearch**       | Context provider  | Answers questions about the platform codebase, grounded in repository inspection. |
...
> _"Which agents are available in this codebase?"_ → **CodeSearch** answers from the repository files, quoting real paths.
