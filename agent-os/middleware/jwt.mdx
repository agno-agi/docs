...
app.add_middleware(
    JWTMiddleware,
    verification_key="your-jwt-verification-key",  # or use JWT_VERIFICATION_KEY environment variable
...
|-----------|-------------|---------|
| `verification_key` | Key for JWT verification. For RS256, use public key. For HS256, use shared secret. | `JWT_VERIFICATION_KEY` env var |
