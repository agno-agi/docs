...
Set `mcp=True` to serve an MCP server at `/mcp` alongside the REST API. MCP clients such as Claude, Claude Code, and Cursor can then discover your agents, teams, and workflows, run them, and browse past conversations.
