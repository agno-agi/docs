...
Prerequisites:
uv pip install -U fastapi uvicorn sqlalchemy pgvector psycopg openai ddgs mcp
"""
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U fastapi uvicorn sqlalchemy pgvector psycopg openai ddgs mcp agno
    ```
  </Step>
