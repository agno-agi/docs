...
| Isolation | Per-user scoping throughout AgentOS for user-owned data |
...
<CardGroup cols={2}>
  ...
  <Card title="Per-User Data Isolation" icon="user-lock" href="/agent-os/security/authorization/user-isolation">
    Scope user-owned AgentOS data to the caller's user ID.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="users"
    href="https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/07_security/user_isolation.py"
  >
    Scope user-owned data throughout AgentOS with `user_isolation=True`.
  </Card>
</CardGroup>
