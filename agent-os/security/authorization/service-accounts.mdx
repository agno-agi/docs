...
| `403` | The token verified but lacks a scope the tmp/service_accounts_demo.dboute requires (the detail lists the required scopes). Also: minting scopes the caller does not hold. |
...
<video
  ...
  src="/videos/service-accounts.mp4"
></video>
