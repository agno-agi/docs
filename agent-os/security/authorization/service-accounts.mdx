...
| Run the cookbook example | [agent_os_with_service_accounts.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/middleware/agent_os_with_service_accounts.py) |
