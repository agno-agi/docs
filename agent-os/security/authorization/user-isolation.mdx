...
| See the user isolation cookbook example | [user_isolation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/rbac/symmetric/user_isolation.py) |
