...
<Note>
If you're experiencing authorization failures when both security key and JWT verification are enabled, see the [Authorization Failed troubleshooting guide](/faq/rbac-auth-failed) for step-by-step resolution.
</Note>
