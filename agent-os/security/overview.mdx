...
To enable JWT authentication, a public key will be generated for you on the AgentOS Control Plane when you connect your OS. Set this key in the `JWT_VERIFICATION_KEY` environment variable.

The key will be generated in two scenarios:
