...
The Open Source Agent UI is built with Next.js and TypeScript. After the success of the [AgentOS](/agent-os/introduction), the community asked for a self-hosted alternative and we delivered!
