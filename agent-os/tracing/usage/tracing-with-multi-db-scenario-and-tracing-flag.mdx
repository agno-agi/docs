---
title: Tracing with Multi-DB Scenario using tracing=True
description: Learn how to trace your agents with multiple databases with Agno in AgentOS using `tracing=True`
sidebarTitle: Tracing with Multi-DB Scenario using tracing=True
keywords: [tracing, agents, databases, agno, opentelemetry]
---

This guide walks you through tracing your agents with multiple databases with Agno in AgentOS using `tracing=True`
...
if __name__ == "__main__":
    agent_os.serve(app="tracing-with-multi-db-scenario-and-tracing-flag:app", reload=True)
```