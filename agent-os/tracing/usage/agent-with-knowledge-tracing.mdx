...
keywords: [tracing, agents, knowledge, agno, opentelemetry]
---

This guide walks you through tracing your agents with knowledge with Agno in AgentOS
...
if __name__ == "__main__":
    ...
    agent_os.serve(app="agent-with-knowledge-tracing:app")
```