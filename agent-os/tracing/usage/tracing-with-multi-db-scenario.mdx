---
title: Tracing with Multi-DB Scenario using setup_tracing()
description: Learn how to trace your agents with multiple databases with Agno in AgentOS
sidebarTitle: Tracing with Multi-DB Scenario using setup_tracing()
keywords: [tracing, agents, databases, agno, opentelemetry]
---

This guide walks you through tracing your agents with multiple databases with Agno in AgentOS using `setup_tracing()`
...
if __name__ == "__main__":
    agent_os.serve(app="tracing-with-multi-db-scenario:app", reload=True)
```