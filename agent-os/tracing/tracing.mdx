---
title: Tracing
description: Configure tracing for your agents and teams in AgentOS
sidebarTitle: Tracing
keywords: [tracing, agentos, observability, debugging]
---

AgentOS provides built-in tracing support to capture execution details for all your agents and teams. This guide explains how to configure tracing properly based on your database setup.
...
<Warning>
  When agents or teams have **different databases**, you must specify a dedicated `tracing_db` to ensure all traces are stored in one central location.
</Warning>
