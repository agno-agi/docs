...
description: "Give an agent tools to create, update, and run Studio components from chat with human-in-the-loop confirmation."
---
...
<Frame caption="The agents page after the deletion">
  <img
    ...
    alt="Agents list page showing the remaining agents after the deletion"
    style={{ borderRadius: "8px" }}
  />
</Frame>
</div>
...
- [StudioTools cookbook](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/05_agent_os/studio_tool)