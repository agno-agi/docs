...
description: "Connect a local or deployed AgentOS runtime to the Control Plane."
---

Connect a local runtime for development or a deployed runtime to test and operate its agents, teams, and workflows from the [AgentOS Control Plane](https://os.agno.com).

## Before You Connect

| Runtime | Requirements |
|---------|--------------|
| Local | AgentOS running on your machine and reachable from your browser, usually at `http://localhost:7777` |
