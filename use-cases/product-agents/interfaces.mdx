---
title: "Interfaces"
description: "Connect agents to Slack, Telegram, WhatsApp, and browser clients through AgentOS."
---

Register an agent with Slack, Telegram, WhatsApp, or a browser interface.
