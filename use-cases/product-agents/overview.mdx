...
description: "Serve agents across product surfaces with shared database-backed sessions and memory."
---

Serve the same product agent through chat, inline actions, background jobs, and messaging interfaces. A shared AgentOS database keeps sessions and user memory available across those surfaces.
