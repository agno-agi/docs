...
Operations teams use document processing agents to move information from invoices, contracts, forms, and scans into databases, ERPs, and review queues. Agno returns validated Pydantic objects from files and images. Workflows add approvals, batch execution, retries, and schedules.

Define a Pydantic schema and pass the document through `File`. The agent returns a validated instance of that schema.
