...
Document processing agents turn invoices, contracts, forms, and scanned files into typed Python objects. Persist each result, route it for review, or pass it to another system.
