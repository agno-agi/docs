...
description: "Route, coordinate, broadcast, task, or an explicit pipeline. Pick the shape the research question needs."
---
...
- [Team modes cookbook](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/03_teams/02_modes)
- [Workflows](/workflows/overview)
- [Workflow cookbook](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/04_workflows)
