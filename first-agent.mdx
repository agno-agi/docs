...
description: "Build and run an agent that inventories a folder and proposes an organization."
...
<Tip>
All session data is stored in your local database. Only your prompts and tool results go to the model provider.
</Tip>
