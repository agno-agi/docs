...
The code above serves the agent with AgentOS, a FastAPI runtime that exposes agent runs and related operations through REST APIs. You own and host the resulting service.
