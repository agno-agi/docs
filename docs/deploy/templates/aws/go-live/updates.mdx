...
| Configure settings | [Settings](/deploy/templates/aws/configure/settings) | Region, subnets, image repo |
...
<Note>
If you haven't set up ECR yet, see [Getting Started - AWS Setup](/deploy/templates/aws/manage/getting-started#step-1-aws-setup).
</Note>
