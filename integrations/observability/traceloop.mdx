...
- **Decorator Note**: The `@aworkflow` decorator is deprecated. Use `@workflow` for both sync and async operations.

By following these steps, you can effectively integrate Agno with Traceloop, enabling comprehensive observability and monitoring of your AI agents.
