...
<CardGroup cols={3}>
  ...
  <Card title="Grounding & Search" icon="magnifying-glass" href="#grounding--search">
...
Read more about multimodal input:
...
Generate natural speech audio using Gemini's TTS capabilities. See [Google's TTS documentation](https://ai.google.dev/gemini-api/docs/speech-generation) for available voices and options.
