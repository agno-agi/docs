---
title: Memori
description: Memori provides persistent memory capabilities for agents with conversation history, user preferences, and long-term context.
---
...
- **Persistent Memory**: Stores conversation history and context across sessions using SQLite or other databases
- **Attribution**: Track memories by entity (e.g., customer) and process (e.g., support agent)
- **Automatic Integration**: Register Memori with Agno models for seamless memory management
- **Database Flexibility**: Supports SQLite, PostgreSQL, and other SQLAlchemy-compatible databases
