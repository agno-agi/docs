...
Agno agents can transcribe audio files using different tools and models. This page covers OpenAI transcription; see [Audio to Text Transcription](/multimodal/agent/usage/audio-to-text) for the fully multimodal Gemini approach.
