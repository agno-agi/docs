...
description: "Scrape a blog post with Firecrawl, summarize it, and convert the summary to audio with ElevenLabs."
---
...
<Steps>
  ...
  <Step title="Run Agent">
    <Warning>
      This script scrapes the URL with Firecrawl and generates audio with ElevenLabs on every run. Both are metered APIs and may incur provider charges beyond their free tiers.
    </Warning>
    ```bash
    python blog_to_podcast.py
    ```
