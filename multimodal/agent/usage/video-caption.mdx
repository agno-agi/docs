...
description: "Extract audio, transcribe it, generate SRT captions, and embed them back into a video with MoviePyVideoTools and OpenAITools."
---

Create an agent that processes videos to generate and embed captions using MoviePy and OpenAI tools.
