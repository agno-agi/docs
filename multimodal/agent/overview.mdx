...
<Snippet file="caution-compatibility-matrix-for-models.mdx" />
  ...
  <Tab title="Images">
    <CardGroup cols={3}>
      ...
      <Card
        ...
        icon="file-image"
        iconType="duotone"
        href="/multimodal/agent/usage/image-input-for-tools"
      >
  ...
  <Tab title="Audio">
    <CardGroup cols={3}>
      ...
      <Card
        ...
        iconType="duotone"
        href="/multimodal/agent/usage/speech-to-text"
      >
      ...
      <Card
        ...
        icon="music"
        iconType="duotone"
        href="/multimodal/agent/usage/multi-turn-audio"
      >
  ...
  <Tab title="Files">
    <CardGroup cols={3}>
      <Card
        ...
        icon="file-image"
        iconType="duotone"
        href="/multimodal/agent/usage/files_input"
      >
...
- View [Image Agent Examples](/multimodal/agent/usage/image-to-text)
- View [Audio Agent Examples](/multimodal/agent/usage/audio-to-text)
- View [Video Agent Examples](/multimodal/agent/usage/video-caption-agent)