...
For a complete overview of multimodal support, please checkout the [multimodal](/multimodal/overview) documentation.
...
See [Image as input](/multimodal/images/image-input) for more details.
...
- View [Image Team Examples](/multimodal/team/usage/image-to-text)
- View [Audio Team Examples](/multimodal/team/usage/audio-to-text)
- View [Video Team Examples](/multimodal/team/usage/video-caption-generation)