...
description: "Run a team that transcribes a WAV conversation and scores per-speaker sentiment, keeping session history in SqliteDb for follow-up questions."
---
