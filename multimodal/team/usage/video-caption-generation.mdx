...
description: "Use a two-agent team with MoviePyVideoTools and OpenAITools to extract audio, generate SRT captions, and embed them into a video."
---
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        uv pip install agno openai moviepy ffmpeg
        ```
    </Step>
