...
sidebarTitle: "Image to Structured Movie Script"
description: "Use a two-agent team to analyze an image and return a Pydantic MovieScript object via output_schema."
---

Analyze images with a team and return structured movie scripts, using Pydantic models to keep the output format consistent.
