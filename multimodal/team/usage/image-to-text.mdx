...
description: "Analyze an image with one team member and turn the analysis into a short story with another."
---

Turn images into fictional stories with a team: an image analyst describes the image and a creative writer builds a story from it.
