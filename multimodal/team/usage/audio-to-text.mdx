...
description: "Use a two-agent team to transcribe an MP3 with Gemini and analyze the transcript for themes and insights."
---

Transcribe audio with a team, then analyze the transcript for insights and themes.
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        uv pip install agno requests google-genai
        ```
    </Step>
