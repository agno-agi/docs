...
<Tip>
  Examples of ways to do Audio to Text (Transcribe) are:
   - [Using Gemini model](/multimodal/audio/usage/audio-to-text)
   - [Using OpenAI Model](/multimodal/agent/usage/audio-input-output)
...
- View [Multimodal Examples](/multimodal/agent/usage/audio-to-text)
- View [Team Examples](/multimodal/team/usage/audio-to-text)
