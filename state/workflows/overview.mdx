...
<CardGroup cols={3}>
  <Card
    ...
    icon="user"
    href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/state_with_agent.py"
  >
  ...
  <Card
    title="Team Examples"
    icon="users"
    href="https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/state_with_team.py"
  >
