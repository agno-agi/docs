...
- The `agent.get_session_state(session_id=session_id)` method retrieves the session state of a particular session from the database
...
- [State cookbook](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/02_agents/05_state_and_session)
