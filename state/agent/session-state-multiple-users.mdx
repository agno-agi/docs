...
description: "Track separate shopping lists per user and session ID using session state in a multi-user agent."
mode: wide
---

Keep separate session state for each user in a multi-user environment. Every user gets their own shopping lists and sessions.
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    You can access these variables in your tools via `run_context.session_state`.
    """
