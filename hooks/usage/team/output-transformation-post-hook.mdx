...
description: "Use post-hooks to reformat a Team's TeamRunOutput.content with member metadata, a collaboration summary, or an AI-structured layout before returning it."
---
