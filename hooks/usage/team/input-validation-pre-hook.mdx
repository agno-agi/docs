...
description: "Use a pre-hook with an AI validator agent to check a Team's input for relevance, safety, and team suitability before raising InputCheckError."
---
