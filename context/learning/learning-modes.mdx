...
The [learning stores](/context/learning/stores/intro.mdx) associated with a Learning Machine can be configured to operate in one of the three learning modes:
