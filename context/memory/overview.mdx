...
<Tip>
**Memory ≠ Session History:** Memory stores learned user facts ("Sarah prefers email"), [session history](/context/history/overview) stores conversation messages for continuity ("what did we just discuss?").
</Tip>
...
<CardGroup cols={3}>
  <Card
    ...
    icon="robot"
    iconType="duotone"
    href="/context/memory/agent/overview"
  >
  ...
  <Card
    ...
    icon="users"
    iconType="duotone"
    href="/context/memory/team/overview"
  >
  ...
  <Card
    ...
    icon="file-lines"
    iconType="duotone"
    href="/context/memory/working-with-memories/overview"
  >
  ...
  <Card
    ...
    icon="shield-check"
    iconType="duotone"
    href="/context/memory/best-practices"
  >
