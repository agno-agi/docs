...
See more details in the [knowledge](/context/knowledge/overview) documentation.
</Note>
...
<Tip>
  ...
  Base](/context/knowledge/overview#loading-the-knowledge).
</Tip>
...
<Note>
  ...
  documentation](/context/knowledge/filters/overview).
</Note>
