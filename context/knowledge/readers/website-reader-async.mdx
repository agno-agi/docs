...
```python examples/context/knowledge/readers/overview/website_reader_async.py
import asyncio
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U requests beautifulsoup4 sqlalchemy psycopg pgvector agno openai    
    ```
  </Step>
