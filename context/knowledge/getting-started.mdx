...
<CardGroup cols={3}>
  <Card title="Content Types" icon="file-lines" href="/context/knowledge/content-types">
  ...
  <Card title="Search Types" icon="magnifying-glass" href="/context/knowledge/search-and-retrieval/overview">
...
<Card title="Ready for Core Concepts?" icon="graduation-cap" href="/context/knowledge/knowledge-bases">
