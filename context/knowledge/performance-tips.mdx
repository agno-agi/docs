...
Learn more about [choosing chunking strategies](/context/knowledge/chunking/overview).
...
<CardGroup cols={3}>
  ...
  <Card title="Embedders" icon="vector-square" href="/context/knowledge/embedder/overview">
    Choose the right embedder for your use case
  </Card>
  <Card title="Hybrid Search" icon="magnifying-glass" href="/context/knowledge/search-and-retrieval/hybrid-search">
    Combine vector and keyword search for better results
  </Card>
</CardGroup>
