...
For advanced filtering with complex logical conditions (OR, NOT, comparisons), see [Advanced Filtering](/context/knowledge/filters/advanced-filtering).
...
knowledge.insert(path="presentations/", reader=PdfReader())
```
...
<CardGroup cols={3}>
  <Card
    ...
    icon="filter"
    href="/context/knowledge/filters/advanced-filtering"
  >
  ...
  <Card
    ...
    href="/context/knowledge/search-and-retrieval/hybrid-search"
  >
