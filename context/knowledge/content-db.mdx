...
<Note>
You need a contents database with your Knowledge base to use [agentic filtering](/context/knowledge/filters/agentic-filters).
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Getting Started" icon="rocket" href="/context/knowledge/getting-started">
