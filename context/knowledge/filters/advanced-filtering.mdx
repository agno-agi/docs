...
For basic filtering with dictionary format, see [Search & Retrieval](/context/knowledge/search-and-retrieval/overview).
...
<Note>
You need a [contents database](/context/knowledge/content-db) with your Knowledge base to use agentic filtering.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/context/knowledge/search-and-retrieval/overview"
  >
  ...
  <Card
    ...
    icon="database" 
    href="/context/knowledge/content-db"
  >
  ...
  <Card
    ...
    icon="book-open"
    href="/context/knowledge/knowledge-bases" 
  >
  ...
  <Card
    ...
    icon="gauge"
    href="/context/knowledge/performance-tips"
  >
