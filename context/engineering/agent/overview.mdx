...
| `enable_agentic_knowledge_filters` | `bool`      | `False` | If True, let the agent choose the knowledge filters. See [knowledge](/context/knowledge/filters/overview) for more information.                                                      |
...
See the [full example](/context/engineering/agent/filter-tool-calls-from-history) for a complete demonstration.
