...
| `add_memories_to_context`        | `bool`      | `False` | If True, add the user memories to the context. See [memory](/context/memory/overview) for more information.                                                                 |
| `add_dependencies_to_context`    | `bool`      | `False` | If True, add the dependencies to the context. See [dependencies](/context/dependencies/overview) for more information.                                                      |
| `add_session_state_to_context`   | `bool`      | `False` | If True, add the session state to the context. See [state](/context/state/overview) for more information.                                                                   |
| `add_knowledge_to_context`       | `bool`      | `False` | If True, add retrieved knowledge to the context, to enable RAG. See [knowledge](/context/knowledge/overview) for more information.                                          |
| `enable_agentic_knowledge_filters` | `bool`      | `False` | If True, let the team choose the knowledge filters. See [knowledge](/context/knowledge/filters/overview) for more information.                                       |
...
Learn about agentic knowledge filters in more detail in the [knowledge filters](/context/knowledge/filters/overview) section.
...
See [dependencies](/context/dependencies/overview) for how to do dependency injection for your user message.
...
See more details on [sessions](/context/history/overview).
...
See the [full example](/context/engineering/team/filter-tool-calls-from-history) for a complete demonstration.
