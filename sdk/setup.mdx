...
Agno supports Anthropic, Gemini, Groq, Mistral, Cohere, Ollama, and other providers. This example needs a model that supports tool calling. Set the provider's API key and change the `model=` argument. See [Models](/models/overview).
