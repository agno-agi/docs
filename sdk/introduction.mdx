...
The Agno SDK provides three primitives for an agent platform: agents, teams, and workflows. Agents handle individual tasks, teams coordinate multiple agents, and workflows define execution paths.
