...
| **MCP Agent** | Connect to external services via Model Context Protocol |
...
Pal stores your data in DuckDB and remembers schemas, research findings, and error patterns in the learning system. **Pal is a work in progress. It's not perfect, but it's a great starting point.**
...
Your multi-agent system is now live in production.
