...
This occurs because JWT verification is preferred over security key. Learn more about [security key](https://docs.agno.com/agent-os/security/overview#security-key-authentication).
