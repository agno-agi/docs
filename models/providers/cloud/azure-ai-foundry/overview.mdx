...
Use various open source models hosted on Azure's infrastructure. Learn more [here](https://learn.microsoft.com/azure/ai-foundry/concepts/foundry-models-overview).
...
For the complete list of available models, visit the [Azure AI Foundry documentation](https://learn.microsoft.com/azure/ai-foundry/concepts/foundry-models-overview).
