...
description: Search a PgVector knowledge base from an Azure AI Foundry agent.
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U azure-ai-inference aiohttp openai sqlalchemy pgvector pypdf psycopg agno
    ```
  </Step>
