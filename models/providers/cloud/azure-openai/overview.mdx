...
export AZURE_OPENAI_ENDPOINT=***  # Of the form https://<your-resource-name>.openai.azure.com
# Optional:
...
setx AZURE_OPENAI_ENDPOINT ***  # Of the form https://<your-resource-name>.openai.azure.com
# Optional:
...
Prompt caching happens automatically with the `AzureOpenAI` model. Read more about how OpenAI handles caching in [their docs](https://platform.openai.com/docs/guides/prompt-caching).
