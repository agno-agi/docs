...
Use Claude models through Azure AI Foundry. This uses Anthropic's native Messages API instead of the chat completions endpoint that [Azure AI Foundry](/models/providers/cloud/azure-ai-foundry/overview) uses for other models.
