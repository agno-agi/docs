...
description: Enable user memories and session summaries for a Llama agent backed by PostgresDb.
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install sqlalchemy psycopg pgvector llama-api-client agno
    ```
  </Step>
