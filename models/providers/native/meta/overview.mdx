...
Agno also provides `LlamaOpenAI`, a client that calls the Llama API through its OpenAI-compatible endpoint (`https://api.llama.com/compat/v1/`). Use it in place of `Llama` when you want OpenAI-style request handling:
