...
description: "Run an OpenAIResponses agent on the o4-mini-deep-research model with max_tool_calls=1 to produce a cited, data-backed report on semaglutide's economic impact on healthcare."
---
