...
See the [Interactions API documentation](https://ai.google.dev/gemini-api/docs/interactions).
...
|-----------|------|---------|-------------|
| `id` | `str` | `"gemini-3.7-flash"` | The model identifier. Mutually exclusive with `agent`. |
