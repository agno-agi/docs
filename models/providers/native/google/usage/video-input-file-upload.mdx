...
description: "Upload a video to Gemini's Files API, poll until it's ready, and pass it to an agent."
---

## Code

```python cookbook/90_models/google/gemini/video_input_file_upload.py
import time
