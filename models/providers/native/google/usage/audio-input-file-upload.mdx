...
description: Upload an audio file with the Gemini Files API and pass the uploaded file to an agent.
---

## Code

```python cookbook/90_models/google/gemini/audio_input_file_upload.py
