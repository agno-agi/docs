...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="shuffle"
    iconType="duotone"
    href="/models/providers/gateways/ramp/overview"
  >
    Route requests across model providers with Ramp Router.
  </Card>
  <Card
    title="Requesty"
    icon="robot"
...
| -------- | -------------- |
| Provider APIs | `anthropic`, `cohere`, `dashscope`, `deepseek`, `google`, `google-interactions`, `inception`, `internlm`, `llama-openai`, `meta`, `minimax`, `mistral`, `moonshot`, `open-responses`, `openai`, `openai-chat`, `openai-responses`, `perplexity`, `vercel`, `xai`, `xai-responses`, `xiaomi` |
...
| Hosted inference and gateways | `aimlapi`, `cerebras`, `cerebras-openai`, `cloudflare`, `cometapi`, `deepinfra`, `fireworks`, `groq`, `huggingface`, `langdb`, `litellm`, `litellm-openai`, `n1n`, `nebius`, `neosantara`, `nexus`, `nvidia`, `openrouter`, `openrouter-responses`, `portkey`, `ramp`, `requesty`, `sambanova`, `siliconflow`, `together`, `tuning-engines` |
