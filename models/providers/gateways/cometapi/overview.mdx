...
See all CometAPI supported models and pricing [here](https://www.cometapi.com/pricing/).

## Authentication

Set your `COMETAPI_KEY` environment variable. Get your API key from [here](https://www.cometapi.com/console/token).
