...
<Warning>
Agno v2.7.4 defaults `CerebrasOpenAI.id` to the retired `llama-4-scout-17b-16e-instruct` model. Set `id="gpt-oss-120b"` or another current [Cerebras model](https://inference-docs.cerebras.ai/models/overview) explicitly.
</Warning>
