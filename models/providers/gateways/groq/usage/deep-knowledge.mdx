...
description: Answer questions by iteratively searching a knowledge base using Groq, OpenAI embeddings, and LanceDB.
---

## Code

```python cookbook/90_models/groq/deep_knowledge.py
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U openai lancedb sqlalchemy typer inquirer agno groq
    ```
  </Step>
