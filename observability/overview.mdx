...
<Note>
OpenTelemetry-compatible backends including Arize Phoenix, Langfuse, Laminar, Langsmith, Langtrace, Logfire, Maxim, OpenLIT, Traceloop, and Weave are supported by Agno out of the box.
</Note>
