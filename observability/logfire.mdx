...
[Logfire](https://pydantic.dev/logfire) is Pydantic's observability platform that provides comprehensive tracing and monitoring for AI applications. By integrating Agno with Logfire, you can utilize OpenInference to send traces and gain insights into your agent's performance.
...
2. **Setup Logfire Account**
   ...
   - Sign up for an account at [Logfire](https://logfire.pydantic.dev/).
