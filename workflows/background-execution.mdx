...
description: "Run an asynchronous workflow in the background and poll its persisted status."
mode: wide
---
...
<Note>
You can also use WebSocket for background workflows. See the [Workflow WebSocket](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/04_workflows/06_advanced_concepts/background_execution) examples.
</Note>

## Developer Resources

- [Background Execution Poll](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/background_execution/background_poll.py)
- [Background Execution WebSocket](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/background_execution/websocket_server.py)
