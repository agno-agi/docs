...
description: Stream workflow and step lifecycle events from an asynchronous workflow.
---

Set `stream=True` and `stream_events=True`, then iterate over the asynchronous event stream.
