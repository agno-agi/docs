...
Tracing leverages [OpenTelemetry](https://opentelemetry.io/) to instrument Agno agents, teams, and workflows, capturing traces and spans.
...
- **Low Overhead**: Batch processing exports traces in the background
