...
- See the [Guardrails](/execution-control/guardrails/overview) documentation for more details.
...
You can see complete examples of pre-hooks in the [Examples](/execution-control/hooks/usage/agent/input-transformation-pre-hook) section.
...
You can see complete examples of post-hooks in the [Examples](/execution-control/hooks/usage/agent/input-transformation-pre-hook) section.
...
You can learn more about them in the [Guardrails](/execution-control/guardrails/overview) section.
...
- View [Agent Examples](/execution-control/hooks/usage/agent/input-transformation-pre-hook)
- View [Team Examples](/execution-control/hooks/usage/team/input-transformation-pre-hook)
