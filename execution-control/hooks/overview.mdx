...
- [Agent Examples](/execution-control/hooks/usage/agent/input-transformation-pre-hook)
- [Team Examples](/execution-control/hooks/usage/team/input-transformation-pre-hook)
