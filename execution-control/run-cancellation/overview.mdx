...
description: Learn how to cancel an Agent, Team, or Workflow run.
---
...
<CardGroup cols={3}>
  <Card
    ...
    icon="user-astronaut"
    iconType="duotone"
    href="/execution-control/run-cancellation/usage/agent-cancel-run"
  >
  ...
  <Card
    ...
    icon="users"
    iconType="duotone"
    href="/execution-control/run-cancellation/usage/team-cancel-run"
  >
  ...
  <Card
    ...
    iconType="duotone"
    href="/execution-control/run-cancellation/usage/workflow-cancel-run"
  >
