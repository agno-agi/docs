...
1. **[User Confirmation](/execution-control/hitl/user-confirmation)**: Require explicit user approval before executing a tool
2. **[User Input](/execution-control/hitl/user-input)**: Gather specific information from users during execution
3. **[Dynamic User Input](/execution-control/hitl/dynamic-user-input)**: Have the agent collect user input as it needs it
4. **[External Tool Execution](/execution-control/hitl/external-execution)**: Execute tools outside of the agent's control
...
<CardGroup cols={3}>
  <Card
    ...
    icon="circle-check"
    href="/execution-control/hitl/user-confirmation"
  >
  ...
  <Card
    title="User Input"
    icon="keyboard"
    href="/execution-control/hitl/user-input"
  >
  ...
  <Card
    ...
    icon="comments"
    href="/execution-control/hitl/dynamic-user-input"
  >
  ...
  <Card
    ...
    icon="plug"
    href="/execution-control/hitl/external-execution"
  >
...
- View more [Examples](/execution-control/hitl/usage/)
