...
Agents can process images, audio, video, and files as input, and generate images and audio as output. This section introduction Multimodal I/O, checkout the [full guide](/multimodal/overview) for more details.
...
For detailed guides and examples, see the [Multimodal documentation](/multimodal/overview):

- [Image input](/multimodal/images/image-input)
- [Audio input](/multimodal/audio/audio_input)
- [Video input](/multimodal/video/video_input)
- [Image generation](/multimodal/images/image-output)
- [Audio generation](/multimodal/audio/audio_output)