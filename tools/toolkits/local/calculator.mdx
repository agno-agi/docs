---
title: Calculator
description: "CalculatorTools gives an agent add, subtract, multiply, divide, and other math operations for step-by-step calculations."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/calculator.py)
