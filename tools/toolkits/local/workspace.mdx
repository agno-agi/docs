...
See [Workspace with confirmation](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py) for the full pause/resume example, and [User Confirmation](/hitl/user-confirmation) for the HITL pattern.

## Developer Resources

- [Tools source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/workspace.py)
- [Basic usage](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/workspace_tools/basic_usage.py)
- [With confirmation](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py)
