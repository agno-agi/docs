---
title: Docker
description: "DockerTools gives an agent full control over Docker containers, images, volumes, and networks."
---
...
```python cookbook/91_tools/docker_tools.py
import sys
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/docker.py)
