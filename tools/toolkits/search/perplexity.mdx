...
The following example requires the `httpx` and `openai` libraries and an API key from [Perplexity](https://console.perplexity.ai/).
...
- [Example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/perplexity_tools.py)
- [PerplexitySearch source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/perplexity.py)
