---
title: DuckDuckGo
description: "Search the web with DuckDuckGoTools, a convenience wrapper around WebSearchTools defaulting to the DuckDuckGo backend."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/duckduckgo.py)
