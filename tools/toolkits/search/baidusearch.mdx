...
The following example requires the `baidusearch` and `pycountry` libraries. To install them, run the following command:

```shell
uv pip install -U baidusearch pycountry
```
