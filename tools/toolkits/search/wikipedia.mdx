---
title: Wikipedia
description: "Search Wikipedia with WikipediaTools and optionally add results to a Knowledge base."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/wikipedia.py)
