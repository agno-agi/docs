---
title: Web Search
description: "Search the web with WebSearchTools using the DDGS meta-search library across backends like Google, Bing, DuckDuckGo, Brave, Yandex, and Yahoo."
---
...
The following example requires the `ddgs` and `openai` libraries.
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/websearch.py)
- [Cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/websearch_tools.py)
