---
title: Searxng
description: "Search a self-hosted Searxng instance for web, image, news, and other category results with SearxngTools."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/searxng.py)
