---
title: Pubmed
description: "Search PubMed for articles with PubmedTools' search_pubmed function, returning expanded article detail when results_expanded is set."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/pubmed.py)
