---
title: Exa
description: "Search the web, retrieve URL content, find similar pages, and get AI-powered answers with ExaTools."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/exa.py)
