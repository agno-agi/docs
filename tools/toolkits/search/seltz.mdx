---
title: Seltz
description: "Run AI-powered semantic search against the Seltz gRPC API with SeltzTools."
---
...
The following example requires the `seltz` library and an API key from [Seltz](https://seltz.ai).
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/seltz.py)
