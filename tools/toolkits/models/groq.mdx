---
title: Groq
description: "GroqTools gives an agent access to Groq's Whisper transcription, translation, and TTS APIs."
---
...
if response and response.audio:
    ...
    save_base64_data(base64_audio, str(output_path))
```
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/models/groq.py)
- [Transcription Example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/groq/transcription_agent.py)
- [Translation Example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/groq/translation_agent.py)
