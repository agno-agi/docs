---
title: Gemini
description: "Generate images and videos from an agent using Google's Gemini API and Vertex AI (Imagen and Veo)."
---
...
- [Toolkit](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/models/gemini.py)
