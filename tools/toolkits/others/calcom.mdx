---
title: Cal.com
description: "CalComTools enable an Agent to check availability, create, reschedule, and cancel Cal.com bookings."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/calcom.py)
