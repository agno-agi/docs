...
description: MLXTranscribeTools transcribes audio files with Apple's MLX Whisper model, optimized for Apple Silicon.
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/mlx_transcribe.py)
