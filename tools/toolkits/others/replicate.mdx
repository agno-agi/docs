---
title: Replicate
description: "Generate images and videos from text prompts with ReplicateTools and the Replicate platform."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/replicate.py)
