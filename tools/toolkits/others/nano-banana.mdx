---
title: Nano Banana
description: NanoBananaTools generates images with Google's Gemini 2.5 Flash Image model (Nano Banana).
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/nano_banana.py)
