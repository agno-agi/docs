---
title: Linear
description: "LinearTools let an agent create, update, and query issues and users in Linear over its GraphQL API."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/linear.py)
