...
```shell
uv pip install -U sqlalchemy psycopg pgvector
```
...
- [Tools source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/llms_txt.py)
- [Agentic mode example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/llms_txt_tools.py)
- [Knowledge mode example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/llms_txt_tools_knowledge.py)
