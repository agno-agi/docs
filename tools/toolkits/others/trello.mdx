---
title: Trello
description: Enable an Agent to create and manage Trello boards, lists, and cards.
---
...
The following agent will create a board called `ai-agent`, add lists called `todo` and `doing`, and create a card called `create agent` in each list.
...
- [Tools Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/trello.py)
