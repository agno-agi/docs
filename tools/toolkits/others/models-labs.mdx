---
title: ModelsLabs
description: ModelsLabTools generates images, video, and audio from text prompts using the ModelsLab API.
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/models_labs.py)
