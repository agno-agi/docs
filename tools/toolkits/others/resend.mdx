---
title: Resend
description: "Send transactional emails from an Agent with ResendTools and the Resend API."
---
...
```shell
uv pip install -U resend openai
```
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/resend.py)
