---
title: Dalle
description: "Generate images from a text prompt using OpenAI's DALL-E models."
---

**DalleTools** enable an Agent to generate images from a text prompt using OpenAI's DALL-E API.
