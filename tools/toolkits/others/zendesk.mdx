---
title: Zendesk
description: "Search Zendesk Help Center articles for an Agent with ZendeskTools."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/zendesk.py)
