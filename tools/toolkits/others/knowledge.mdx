...
<Note>
KnowledgeTools is the read side of knowledge. To ingest, inspect, and remove content with an agent, see [Knowledge Management Tools](/tools/toolkits/others/knowledge-management).
</Note>
