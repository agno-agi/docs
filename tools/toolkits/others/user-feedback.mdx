...
```shell
uv pip install -U openai sqlalchemy
```
...
- [Tools source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/user_feedback.py)
- [Cookbook example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/10_human_in_the_loop/user_feedback.py)
