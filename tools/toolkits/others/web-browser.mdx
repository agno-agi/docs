...
- [Tools Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/webbrowser.py)
- [Cookbook Example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/webbrowser_tools.py)
