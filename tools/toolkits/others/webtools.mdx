---
title: Web Tools
description: Expand shortened URLs and return their final destinations with WebTools.
---
...
- [Tools Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/webtools.py)
