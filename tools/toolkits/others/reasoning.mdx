...
**ReasoningTools** enable an Agent to think and analyze step-by-step before responding.
...
- [Tools Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/reasoning.py)
