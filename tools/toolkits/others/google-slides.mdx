---
title: Google Slides
description: "GoogleSlidesTools create, edit, and read Google Slides presentations, including slides, tables, and embedded videos."
---
...
The [slides cookbook](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/91_tools/google/slides) covers four scenarios:
...
- [Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/google/slides.py)
- [Cookbook](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/91_tools/google/slides)
