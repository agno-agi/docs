...
The following example requires the `matplotlib` and `openai` libraries.
...
- [Tools Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/visualization.py)
