---
title: AWS SES
description: "AWSSESTool lets agents send email through Amazon Simple Email Service (SES)."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/aws_ses.py)
