---
title: Composio
description: "ComposioTools connect an Agent to GitHub, Gmail, Salesforce, and 1000+ other actions through Composio."
---
...
```python cookbook/91_tools/composio_tools.py
