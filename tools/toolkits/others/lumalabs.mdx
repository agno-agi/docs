---
title: Lumalabs
description: "LumaLabTools let an agent generate text-to-video and image-to-video content using the Luma AI Dream Machine API."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/lumalab.py)
