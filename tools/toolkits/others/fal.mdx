---
title: Fal
description: FalTools enable an Agent to generate and transform images and videos using the Fal AI platform.
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/fal.py)
