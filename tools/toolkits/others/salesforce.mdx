...
| `add_instructions` | `bool` | `True` | Pass the toolkit instructions to the agent. |
...
- [Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/salesforce.py)
- [Cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/salesforce_tools.py)
