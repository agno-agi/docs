---
title: Eleven Labs
description: "Generate speech and sound effects from text using the ElevenLabs API."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/eleven_labs.py)
