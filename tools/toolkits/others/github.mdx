---
title: GitHub
description: GithubTools enable an Agent to manage GitHub repositories, issues, and pull requests.
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/github.py)
