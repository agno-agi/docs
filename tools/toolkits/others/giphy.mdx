---
title: Giphy
description: GiphyTools enable an Agent to search and retrieve GIFs from GIPHY.
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/giphy.py)
