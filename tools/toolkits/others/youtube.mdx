---
title: Youtube
description: "YouTubeTools let an agent fetch captions, metadata, and timestamps for a YouTube video from its URL."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/youtube.py)
