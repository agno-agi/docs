---
title: Jira
description: "JiraTools let an agent search, create, and comment on Jira issues, and log worklogs against them."
---
...
```python cookbook/91_tools/jira_tools.py
...
| `enable_add_worklog` | `bool` | `True` | Enable the add_worklog functionality. |
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/jira.py)
