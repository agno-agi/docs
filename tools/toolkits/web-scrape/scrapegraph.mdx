...
5. **scrape**: Get raw HTML content from websites
...
```shell
uv pip install -U agno scrapegraph-py openai
```

Get API keys from [ScrapeGraphAI](https://scrapegraphai.com) and [OpenAI](https://platform.openai.com/api-keys), then set both environment variables:
...
```bash Windows
$Env:SGAI_API_KEY="your_scrapegraph_api_key_here"
...
<Note>See the [Startup Analyst example](/examples/tools/scrapegraph-tools)</Note>
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/scrapegraph.py)
- [Tests](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/tests/unit/tools/test_scrapegraph.py)
