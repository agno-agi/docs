---
title: Jina Reader
description: "JinaReaderTools calls the Jina Reader API to expose read_url and search_query functions that fetch and search web content."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/jina.py)
