---
title: Browserbase
description: "Navigate pages, take screenshots, and extract page content with BrowserbaseTools using sync and async browser sessions."
---
...
```shell
uv pip install browserbase playwright openai
...
```python cookbook/91_tools/browserbase_tools.py
...
| `parse_html` | `bool` | `True` | Extract only visible text content instead of raw HTML. Reduces token usage. |
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/browserbase.py)
