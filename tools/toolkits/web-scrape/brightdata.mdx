---
title: BrightData
description: "BrightDataTools enable an Agent to scrape webpages as markdown, capture screenshots, run search engine queries, and pull structured data feeds from LinkedIn, Amazon, Instagram, and more."
---
...
- [Tools Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/brightdata.py)
