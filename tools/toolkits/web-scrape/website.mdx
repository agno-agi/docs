---
title: Website Tools
description: "WebsiteTools exposes a read_url function to read a website's contents, or an add_website_to_knowledge function when a Knowledge instance is passed in."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/website.py)
