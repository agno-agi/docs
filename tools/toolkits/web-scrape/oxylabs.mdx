---
title: Oxylabs
description: "OxylabsTools give an Agent access to Oxylabs' SERP, Amazon product, and universal web scraping APIs."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/oxylabs.py)
