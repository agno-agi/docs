---
title: Spider
description: "SpiderTools wraps the Spider API to expose search_web, scrape, and crawl functions that return web search, scrape, and crawl results."
---

**SpiderTools** is an open-source web scraper and crawler that returns LLM-ready data. To start using Spider, you need an API key from the [Spider dashboard](https://spider.cloud).
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/spider.py)
