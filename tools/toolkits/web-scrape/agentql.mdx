---
title: AgentQL
description: "Scrape web page text or extract data with a custom query using AgentQLTools."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/agentql.py)
