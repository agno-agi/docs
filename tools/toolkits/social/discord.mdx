---
title: Discord
description: "Send messages, read history, and manage channels in Discord with DiscordTools."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/discord.py)
