---
title: Slack
description: "SlackTools enables an Agent to message, search, and manage Slack channels, threads, files, and users through 12 configurable methods."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Source Code" icon="github" href="https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/slack.py">
