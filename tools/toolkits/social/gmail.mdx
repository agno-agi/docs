---
title: Gmail
description: "Read, search, send, and organize Gmail messages with GmailTools using OAuth or a service account."
---
...
- [Source Code](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/google/gmail.py)
- [Cookbook Examples](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/91_tools/google/gmail)
