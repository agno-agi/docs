---
title: Webex
description: "WebexTools enables an Agent to send messages to Webex spaces and list available rooms through the Webex API."
---
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/webex.py)
