---
title: Zoom
description: "Schedule, list, and manage Zoom meetings and recordings with ZoomTools using Server-to-Server OAuth credentials."
---
...
For exact per-plan values, refer to [Zoom API Rate Limits](https://developers.zoom.us/docs/api/rate-limits/).

## Developer Resources

- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/zoom.py)
