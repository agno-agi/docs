...
```shell
uv pip install -U sqlalchemy openai
```
...
```python cookbook/91_tools/sql_tools.py
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/sql.py)
