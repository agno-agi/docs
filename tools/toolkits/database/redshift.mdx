...
```python cookbook/91_tools/redshift_tools.py
...
| `run_query`            | Executes a SQL query and returns the result (not restricted to read-only). Parameters include `query` (str) to specify the SQL query. Returns the result of the query execution.                                                                                                       |
...
- [Tools Source](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/redshift.py)
- [Example](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/redshift_tools.py)
