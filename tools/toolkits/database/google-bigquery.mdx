...
<Note>
The legacy aliases `enable_list_tables`, `enable_describe_table`, and `enable_run_sql_query` are also accepted. When one is passed, it overrides the matching bare flag.
</Note>
