...
```shell
uv pip install duckdb openai
```

For more installation options, see [DuckDB documentation](https://duckdb.org/docs/installation).

## Example

The following agent will analyze the movies file using SQL and return the result.

```python cookbook/91_tools/duckdb_tools.py
...
- [Tools](https://github.com/agno-agi/agno/blob/v2.7.4/libs/agno/agno/tools/duckdb.py)
