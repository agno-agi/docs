...
sidebarTitle: Stripe
description: Create and manage Stripe customers, products, prices, and payment links from natural language using the Stripe MCP server.
---
...
2. Set Environment Variables: export STRIPE_SECRET_KEY=*** and export OPENAI_API_KEY=*** (the agent uses the default OpenAI model).
