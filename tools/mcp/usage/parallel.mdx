...
description: "Connect a Claude agent to Parallel's streamable-http MCP server for web_search and web_fetch tools, with an optional PARALLEL_API_KEY to raise the keyless rate limit."
