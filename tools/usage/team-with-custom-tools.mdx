...
description: "Combine an `@tool`-decorated FAQ lookup with a web-search agent member so a team answers from a knowledge base first and falls back to search."
---
