...
See the [image input example](/features/multimodal/agent/usage/image-input-for-tool) and [file input example](/features/multimodal/agent/usage/file-input-for-tool) for an advanced example using media.
