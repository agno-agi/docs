...
<CardGroup cols={3}>
  ...
  <Card title="LlamaIndex" icon="link" iconType="duotone" href="/knowledge/vector-stores/llamaindex/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Distributed Deployment" icon="gauge" href="/knowledge/vector-stores/qdrant/overview">
