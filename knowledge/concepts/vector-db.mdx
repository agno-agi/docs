...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="link"
    iconType="duotone"
    href="/knowledge/vector-stores/langchain/overview"
  >
  ...
  <Card
    ...
    icon="robot"
    iconType="duotone"
    href="/knowledge/vector-stores/llamaindex/overview"
    hidden
  >
...
<CardGroup cols={3}>
  <Card title="Development & Testing" icon="laptop-code" href="/knowledge/vector-stores/lancedb/overview">
    **LanceDB** - Fast, local, no setup required
  </Card>
  <Card title="Production at Scale" icon="server" href="/knowledge/vector-stores/pgvector/overview">
...
<CardGroup cols={3}>
  ...
  <Card title="Embeddings" icon="vector-square" href="/knowledge/concepts/embedder/overview">
