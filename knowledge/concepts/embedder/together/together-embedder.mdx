...
<Warning>
  The Agno v2.7.4 default, `togethercomputer/m2-bert-80M-32k-retrieval`, was removed on February 6, 2026. Together's current serverless catalog lists `intfloat/multilingual-e5-large-instruct` with 1024 dimensions. See [Together deprecations](https://docs.together.ai/docs/deprecations) and [serverless models](https://docs.together.ai/docs/serverless/models).
</Warning>
