...
<Note>
You need a contents database with your Knowledge base to use [agentic filtering](/knowledge/concepts/filters/overview).
</Note>
...
- **[PostgreSQL](/database/providers/postgres/overview)** - Recommended for production
- **[SQLite](/database/providers/sqlite/overview)** - Great for development and single-user applications  
- **[MySQL](/database/providers/mysql/overview)** - Enterprise-ready relational database
- **[MongoDB](/database/providers/mongo/overview)** - Document-based NoSQL option
- **[Redis](/database/providers/redis/overview)** - In-memory option for high performance
- **[In-Memory](/database/providers/in-memory/overview)** - Temporary storage for testing
- **Cloud Options** - [DynamoDB](/database/providers/dynamodb/overview), [Firestore](/database/providers/firestore/overview), [GCS](/database/providers/gcs/overview)
