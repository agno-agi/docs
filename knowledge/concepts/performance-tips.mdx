...
Learn more about [choosing chunking strategies](/knowledge/concepts/chunking/overview).
...
<CardGroup cols={3}>
  ...
  <Card title="Embedders" icon="vector-square" href="/knowledge/concepts/embedder/overview">
