...
Ready to build your first intelligent agent? This guide will walk you through creating an agent that can answer questions about your documents in just a few minutes.
...
<Steps>
  ...
  <Step title="Set up your API key">
    ...
    ```
    <Note>This tutorial uses OpenAI, but Agno supports [many other models](/models/overview).</Note>
  </Step>
</Steps>
...
knowledge = Knowledge(
    vector_db=PgVector(table_name="vectors", db_url="postgresql+psycopg://ai:ai@localhost:5532/ai"),
)
...
<CardGroup cols={3}>
  ...
  <Card title="Search Types" icon="magnifying-glass" href="/knowledge/concepts/search-and-retrieval/overview">
...
<Card title="Ready for Core Concepts?" icon="graduation-cap" href="/knowledge/knowledge-bases">
