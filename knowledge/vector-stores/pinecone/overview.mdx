...
<Card title="Async Support ⚡">
  <div className="mt-2">
    <p>
      Pinecone also supports asynchronous operations with <code>ainsert()</code> and <code>aprint_response()</code>.
    </p>
...
| Task | Guide |
|------|-------|
| Insert, search, and delete content | [Pinecone usage](/knowledge/vector-stores/pinecone/usage/pinecone-db) |
| Call async Agno methods | [Async Pinecone usage](/knowledge/vector-stores/pinecone/usage/async-pinecone-db) |