...
description: "Load and query a ClickHouse knowledge base asynchronously with ainsert() and aprint_response()."
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "clickhouse-connect[async]" pypdf openai agno
    ```
  </Step>
