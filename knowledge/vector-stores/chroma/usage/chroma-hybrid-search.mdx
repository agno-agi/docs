---
title: ChromaDB Hybrid Search
description: "Combine dense vector search and full-text keyword search in one ChromaDB query with RRF fusion."
---

Hybrid search in ChromaDB combines dense vector similarity search
