...
<Tip>
  Examples of ways to do Audio to Text (Transcribe) are:
   - [Using Gemini model](/features/multimodal/audio/usage/audio-to-text)
   - [Using OpenAI Model](/features/multimodal/agent/usage/audio-input-output)
   - [Using `OpenAI Tool`](/tools/toolkits/models/openai#1-transcribing-audio)
   - [Using `Groq Tool`](/tools/toolkits/models/groq#1-transcribing-audio)
</Tip>
...
- View [Multimodal Examples](/features/multimodal/agent/usage/audio-to-text)
- View [Team Examples](/features/multimodal/team/usage/audio-to-text)
- View [OpenAI Toolkit](/tools/toolkits/models/openai)
