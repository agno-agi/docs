...
For a complete overview of multimodal support, please checkout the [multimodal](/features/multimodal/overview) documentation.

<Tip>
Not all models support multimodal inputs and outputs.
To see which models support multimodal inputs and outputs, please checkout the [compatibility matrix](/models/compatibility).
</Tip>
...
See [Image as input](/features/multimodal/images/image-input) for more details.
...
- View [Image Team Examples](/features/multimodal/team/usage/image-to-text)
- View [Audio Team Examples](/features/multimodal/team/usage/audio-to-text)
- View [Video Team Examples](/features/multimodal/team/usage/video-caption-generation)