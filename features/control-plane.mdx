...
sidebarTitle: Agent Control Plane
description: "Test, inspect, and operate AgentOS runtimes from one web interface."
---

The AgentOS Control Plane gives developers one place to run, inspect, and improve the agents, teams, and workflows served by AgentOS. Connect a local or deployed runtime, test real inputs, follow each run through its session and trace, and manage the knowledge, memory, evaluations, approvals, and schedules behind the system.
...
Test a component, inspect the run, manage the state around it, and repeat against local or deployed runtimes.
...
<CardGroup cols={2}>
  ...
  <Card title="Knowledge and memory" icon="database" href="/agent-os/control-plane#knowledge">
  ...
  <Card title="Full Control Plane guide" icon="book" href="/agent-os/control-plane">
    Explore each view with videos, configuration details, and links to the underlying APIs.
  </Card>
</CardGroup>
