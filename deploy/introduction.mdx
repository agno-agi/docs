...
<Steps>
  <Step title="Start from a template">
    ...
    **Blank canvas**: deploy a clean installation of AgentOS to your infrastructure.
    ...
    **Pre-built solutions**: production-ready codebases with apps already
    wired up.
  ...
  <Step title="Add apps">
    ...
    <CardGroup cols={3}>
      ...
      <Card
        ...
        href="/deploy/apps/research-agent"
      >
      ...
      <Card
        ...
        icon="book"
        href="/deploy/apps/knowledge-agent"
      >
