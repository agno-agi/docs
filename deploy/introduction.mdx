...
These platforms similar to Railway accept a Dockerfile, build it, and host your service with minimal configuration.  
...
Explore all templates [here](/deploy/templates).
