...
The setup prompt points every coding agent to `.agents/skills/setup-platform/SKILL.md` directly. Claude Code also discovers the skills through the Starter's committed `.claude/skills` symlink. Codex and Cursor can link to the same `.agents/skills/` directory.
