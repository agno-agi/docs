...
- **Six [skills](/deploy/templates/improve-agents)** that coding agents can invoke to set up, build, test, and improve the project.
...
curl https://<your-public-url>/agents   # 401: protected API routes require a token
```

Webhook interfaces verify their own signatures.
