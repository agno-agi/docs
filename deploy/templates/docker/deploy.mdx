...
Choose self-hosted Docker when you want the same Compose stack locally and in production on infrastructure you control. The [agentos-docker](https://github.com/agno-agi/agentos-docker) template runs AgentOS and PostgreSQL with Docker Compose.
...
```bash
curl -o /dev/null -w '%{http_code}\n' "https://<your-public-url>/health"  # 200
curl -o /dev/null -w '%{http_code}\n' "https://<your-public-url>/agents"  # 401
```
