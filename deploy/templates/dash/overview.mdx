...
title: "Dash"
sidebarTitle: "Dash"
description: "Data agent that grounds SQL analysis in five context layers and can save fixes as learnings."
---
...
`railway_env.sh` reads the remaining values from `.env.production` and sets them on the Railway service. It is safe to run repeatedly.
