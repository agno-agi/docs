...
Full source: [cookbook/09_evals/performance/instantiate_agent_with_tool.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/instantiate_agent_with_tool.py)
