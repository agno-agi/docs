...
description: "Track memory growth and top allocations for a PostgresDb-backed team using ReasoningTools across five concurrent users."
...
<Steps>
  ...
  <Step title="Execute all four team runs">
...
Full source: [cookbook/09_evals/performance/team_response_with_memory_and_reasoning.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/team_response_with_memory_and_reasoning.py)
