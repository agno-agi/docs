...
description: "Track memory growth for a PostgresDb-backed team answering five users concurrently, each in its own session."
...
Full source: [cookbook/09_evals/performance/team_response_with_memory_multi_user.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/team_response_with_memory_multi_user.py)
