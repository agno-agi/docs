...
description: "Benchmark Team construction cost over 1000 iterations with PerformanceEval."
...
Full source: [cookbook/09_evals/performance/instantiate_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/instantiate_team.py)
