...
description: "Benchmark agent run latency with update_memory_on_run enabled against a SqliteDb over 5 iterations."
...
Full source: [cookbook/09_evals/performance/response_with_memory_updates.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/response_with_memory_updates.py)
