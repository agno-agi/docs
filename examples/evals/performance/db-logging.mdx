...
description: "Run a single-iteration agent run benchmark and persist its PerformanceEval results to the eval_runs_cookbook table in PostgresDb."
...
Full source: [cookbook/09_evals/performance/db_logging.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/db_logging.py)
