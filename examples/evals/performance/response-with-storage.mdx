...
Full source: [cookbook/09_evals/performance/response_with_storage.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/response_with_storage.py)
