...
description: "Benchmark an async agent.arun call over 10 iterations with PerformanceEval.arun, printing runtime and memory results."
...
Full source: [cookbook/09_evals/performance/async_function.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/async_function.py)
