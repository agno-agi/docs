...
description: "Benchmark memory growth across 5 async runs of a weather team with persistent memory and history in Postgres."
source: cookbook/09_evals/performance/team_response_with_memory_simple.py
---
...
Full source: [cookbook/09_evals/performance/team_response_with_memory_simple.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/team_response_with_memory_simple.py)
