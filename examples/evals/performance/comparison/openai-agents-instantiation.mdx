...
description: "Benchmark 1000 OpenAI Agents SDK agent constructions with a function tool using Agno's PerformanceEval."
...
Full source: [cookbook/09_evals/performance/comparison/openai_agents_instantiation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/comparison/openai_agents_instantiation.py)
