...
description: "Benchmark 1000 PydanticAI agent constructions, including an inline @agent.tool_plain weather tool, via Agno's PerformanceEval."
...
Full source: [cookbook/09_evals/performance/comparison/pydantic_ai_instantiation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/comparison/pydantic_ai_instantiation.py)
