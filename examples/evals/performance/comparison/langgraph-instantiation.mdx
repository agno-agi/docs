...
Full source: [cookbook/09_evals/performance/comparison/langgraph_instantiation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/performance/comparison/langgraph_instantiation.py)
