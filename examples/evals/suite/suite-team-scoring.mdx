...
description: "Run eval Cases against a Team and grade each answer with a numeric 1-10 judge and threshold."
...
Full source: [cookbook/09_evals/suite/suite_team_scoring.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/suite/suite_team_scoring.py)
