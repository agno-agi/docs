...
description: "Persist ReliabilityEval tool-call results to a Postgres eval_runs table via PostgresDb."
...
Full source: [cookbook/09_evals/reliability/db_logging.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/reliability/db_logging.py)
