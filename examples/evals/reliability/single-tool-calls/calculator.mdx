...
description: "Assert a single expected tool call and validate its arguments with expected_tool_call_arguments."
...
Full source: [cookbook/09_evals/reliability/single_tool_calls/calculator.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/reliability/single_tool_calls/calculator.py)
