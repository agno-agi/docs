...
description: "Check whether a news-research team makes the expected delegation and web search tool calls."
...
Full source: [cookbook/09_evals/reliability/team/ai_news.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/reliability/team/ai_news.py)
