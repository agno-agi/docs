...
description: "Score a factorial tool call using ReliabilityEval.arun() driven by asyncio.run."
...
Full source: [cookbook/09_evals/reliability/reliability_async.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/reliability/reliability_async.py)
