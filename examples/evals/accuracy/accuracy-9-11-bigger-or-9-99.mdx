...
description: "Score an agent that must use CalculatorTools to answer whether 9.11 or 9.9 is bigger, with an o4-mini judge."
...
Full source: [cookbook/09_evals/accuracy/accuracy_9_11_bigger_or_9_99.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/accuracy/accuracy_9_11_bigger_or_9_99.py)
