...
description: "Persist AccuracyEval runs to a PostgresDb eval_runs_cookbook table while scoring a calculator agent."
...
Full source: [cookbook/09_evals/accuracy/db_logging.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/accuracy/db_logging.py)
