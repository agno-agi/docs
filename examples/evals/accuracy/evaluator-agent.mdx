...
description: "Score an agent's step-by-step calculator math against an expected answer using a custom evaluator agent with an AccuracyAgentResponse output schema."
...
Full source: [cookbook/09_evals/accuracy/evaluator_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/accuracy/evaluator_agent.py)
