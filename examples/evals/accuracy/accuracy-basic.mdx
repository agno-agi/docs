...
description: "Run AccuracyEval with run() and arun() over a multi-step calculator prompt, using 1 and 3 iterations."
...
Full source: [cookbook/09_evals/accuracy/accuracy_basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/accuracy/accuracy_basic.py)
