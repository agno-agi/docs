...
description: "Accumulate evaluator token usage into an agent's run_output via the run_metrics parameter of evaluate_answer, surfacing it under the eval_model key of metrics.details."
...
Full source: [cookbook/09_evals/accuracy/accuracy_eval_metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/accuracy/accuracy_eval_metrics.py)
