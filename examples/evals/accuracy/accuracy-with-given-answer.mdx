...
description: "Grade a pre-computed output string with AccuracyEval.run_with_output(), no agent execution required."
...
Full source: [cookbook/09_evals/accuracy/accuracy_with_given_answer.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/accuracy/accuracy_with_given_answer.py)
