...
description: "Score a two-agent English/Spanish routing Team on its refusal response to a French prompt."
...
Full source: [cookbook/09_evals/accuracy/accuracy_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/accuracy/accuracy_team.py)
