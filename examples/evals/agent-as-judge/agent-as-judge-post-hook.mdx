...
description: "Attach AgentAsJudgeEval as an agent post_hook and read stored scores back from SqliteDb and AsyncSqliteDb."
...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_post_hook.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/agent_as_judge/agent_as_judge_post_hook.py)
