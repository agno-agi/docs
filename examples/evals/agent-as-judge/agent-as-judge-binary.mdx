...
description: "Judge a customer-service agent reply as pass or fail against a professional-tone criterion using AgentAsJudgeEval backed by SqliteDb."
...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_binary.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/agent_as_judge/agent_as_judge_binary.py)
