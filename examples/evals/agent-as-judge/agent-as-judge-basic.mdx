...
description: "Run numeric-scored agent-as-judge evaluations synchronously against PostgresDb and asynchronously against AsyncSqliteDb, with an on_fail callback and stored eval runs."
...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/agent_as_judge/agent_as_judge_basic.py)
