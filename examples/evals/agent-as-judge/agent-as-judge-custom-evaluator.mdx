...
description: "Score agent output with AgentAsJudgeEval using a strict custom evaluator_agent instead of the default judge."
...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_custom_evaluator.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/agent_as_judge/agent_as_judge_custom_evaluator.py)
