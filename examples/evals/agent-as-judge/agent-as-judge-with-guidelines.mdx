...
description: "Steer numeric AgentAsJudgeEval scoring with additional_guidelines that require units, variant context, and technical completeness."
...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_with_guidelines.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/agent_as_judge/agent_as_judge_with_guidelines.py)
