...
description: "Judge a researcher/writer Team response with binary AgentAsJudgeEval scoring persisted to SqliteDb."
...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/agent_as_judge/agent_as_judge_team.py)
