...
description: "Attach AgentAsJudgeEval as an agent post_hook and read the evaluator's token usage from run_output.metrics.details['eval_model']."
...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_eval_metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/09_evals/agent_as_judge/agent_as_judge_eval_metrics.py)
