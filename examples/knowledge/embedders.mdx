...
description: 30 examples covering 29 embedding providers including OpenAI, Cohere, and HuggingFace.
---
...
| Google | `from agno.knowledge.embedder.gemini import GeminiEmbedder` | text-embedding-004 |
...
## All 30 Embedder Examples

| Provider | Examples |
|----------|----------|
| OpenAI | `openai_embedder.py`, `openai_embedder_batching.py` |
| Azure | `azure_embedder.py`, `azure_embedder_batching.py` |
| Cohere | `cohere_embedder.py`, `cohere_embedder_batching.py` |
| Google | `gemini_embedder.py`, `gemini_embedder_batching.py` |
| Mistral | `mistral_embedder.py`, `mistral_embedder_batching.py` |
| HuggingFace | `huggingface_embedder.py` |
| Ollama | `ollama_embedder.py` |
| Jina | `jina_embedder.py`, `jina_embedder_batching.py` |
| Fireworks | `fireworks_embedder.py`, `fireworks_embedder_batching.py` |
| AWS Bedrock | `aws_bedrock_embedder.py` |
| Nebius | `nebius_embedder.py` |
| LangDB | `langdb_embedder.py` |
| SentenceTransformers | `sentence_transformer_embedder.py` |
| Voyage | `voyage_embedder.py` |
...
- [Vector Databases](/examples/knowledge/vector-databases) - 25+ databases
