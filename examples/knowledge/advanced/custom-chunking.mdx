...
description: "Implement a custom ParagraphChunking strategy that splits documents on double newlines for well-structured prose."
...
Full source: [cookbook/07_knowledge/04_advanced/02_custom_chunking.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/04_advanced/02_custom_chunking.py)
