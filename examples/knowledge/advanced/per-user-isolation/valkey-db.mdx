---
title: "Per-User Knowledge Isolation with Valkey"
description: "Give each user a private view of one shared knowledge base."
source: cookbook/07_knowledge/04_advanced/07_per_user_isolation/valkey_db.py
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno glide-sync valkey-glide-sync
    ```
  </Step>
...
Full source: [cookbook/07_knowledge/04_advanced/07_per_user_isolation/valkey_db.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/04_advanced/07_per_user_isolation/valkey_db.py)
