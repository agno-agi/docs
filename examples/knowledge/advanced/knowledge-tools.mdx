...
description: "Provide agents with think, search, and analyze tools for multi-step knowledge reasoning."
...
Full source: [cookbook/07_knowledge/04_advanced/04_knowledge_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/04_advanced/04_knowledge_tools.py)
