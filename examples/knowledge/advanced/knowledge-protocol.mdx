...
description: "Implement KnowledgeProtocol for an in-memory source with custom context and synchronous or asynchronous document retrieval."
...
Full source: [cookbook/07_knowledge/04_advanced/05_knowledge_protocol.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/04_advanced/05_knowledge_protocol.py)
