...
description: "Provide a custom retriever function for non-vector data sources such as SQL queries, API calls, or file lookups."
...
Full source: [cookbook/07_knowledge/04_advanced/01_custom_retriever.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/04_advanced/01_custom_retriever.py)
