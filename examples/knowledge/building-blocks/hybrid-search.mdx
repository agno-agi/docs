...
description: "Compare vector search, keyword search, and hybrid approaches to find the right strategy for your knowledge base."
...
Full source: [cookbook/07_knowledge/02_building_blocks/02_hybrid_search.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/02_building_blocks/02_hybrid_search.py)
