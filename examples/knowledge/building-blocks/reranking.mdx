...
description: "Implement two-stage retrieval with Cohere reranking to improve search result relevance."
...
Full source: [cookbook/07_knowledge/02_building_blocks/03_reranking.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/02_building_blocks/03_reranking.py)
