...
<Steps>
  ...
  <Step title="Run the example">
    ...
    ```bash
    python cookbook/07_knowledge/02_building_blocks/05_agentic_filtering.py
    ```
  </Step>
</Steps>

Full source: [cookbook/07_knowledge/02_building_blocks/05_agentic_filtering.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/02_building_blocks/05_agentic_filtering.py)
