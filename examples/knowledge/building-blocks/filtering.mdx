...
Full source: [cookbook/07_knowledge/02_building_blocks/04_filtering.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/02_building_blocks/04_filtering.py)
