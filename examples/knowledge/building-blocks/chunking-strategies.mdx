...
description: "Compare four chunking strategies for different content types and use cases."
...
Full source: [cookbook/07_knowledge/02_building_blocks/01_chunking_strategies.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/02_building_blocks/01_chunking_strategies.py)
