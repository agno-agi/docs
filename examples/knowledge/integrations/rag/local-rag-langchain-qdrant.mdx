...
Full source: [cookbook/07_knowledge/05_integrations/rag/local_rag_langchain_qdrant.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/rag/local_rag_langchain_qdrant.py)
