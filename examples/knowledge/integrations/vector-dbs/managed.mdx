...
Full source: [cookbook/07_knowledge/05_integrations/vector_dbs/03_managed.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/vector_dbs/03_managed.py)
