...
Full source: [cookbook/07_knowledge/05_integrations/readers/docling/docling_markup.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/readers/docling/docling_markup.py)
