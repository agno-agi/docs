---
title: "Docling Reader: Image Documents"
description: "Examples of using Docling to process image files with OCR capabilities."
source: cookbook/07_knowledge/05_integrations/readers/docling/docling_images.py
---
...
Full source: [cookbook/07_knowledge/05_integrations/readers/docling/docling_images.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/readers/docling/docling_images.py)
