...
description: "Load a local PDF, an Excel file via an explicit ExcelReader, and a remote PDF URL into Qdrant hybrid search, then query them with an agent."
...
Full source: [cookbook/07_knowledge/05_integrations/readers/01_documents.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/readers/01_documents.py)
