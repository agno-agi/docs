...
description: "Ingest inline CSV and JSON text with CSVReader and JSONReader into Qdrant hybrid search and query the rows with an agent."
...
Full source: [cookbook/07_knowledge/05_integrations/readers/02_data.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/readers/02_data.py)
