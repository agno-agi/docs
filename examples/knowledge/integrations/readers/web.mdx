...
description: "Crawl docs.agno.com with WebsiteReader (max_depth=1, max_links=5) and auto-detect a remote PDF URL into Qdrant hybrid search."
...
Full source: [cookbook/07_knowledge/05_integrations/readers/03_web.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/readers/03_web.py)
