...
Full source: [cookbook/07_knowledge/05_integrations/cloud/04_sharepoint.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/cloud/04_sharepoint.py)
