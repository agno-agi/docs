...
<Steps>
  ...
  <Step title="Install optional cloud clients">
  ...
  <Step title="Configure optional cloud sources">
...
Full source: [cookbook/07_knowledge/05_integrations/cloud/06_multi_source.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/05_integrations/cloud/06_multi_source.py)
