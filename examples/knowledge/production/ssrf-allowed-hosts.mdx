...
Full source: [cookbook/07_knowledge/03_production/05_ssrf_allowed_hosts.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/03_production/05_ssrf_allowed_hosts.py)
