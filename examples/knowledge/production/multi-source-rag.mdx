...
<Steps>
  ...
  <Step title="Run the example">
    ...
    ```bash
    python cookbook/07_knowledge/03_production/01_multi_source_rag.py
    ```
  </Step>
</Steps>

Full source: [cookbook/07_knowledge/03_production/01_multi_source_rag.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/07_knowledge/03_production/01_multi_source_rag.py)
