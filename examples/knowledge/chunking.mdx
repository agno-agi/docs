...
description: 12 examples covering semantic, fixed-size, recursive, and custom chunking.
---
...
## All 12 Chunking Examples

| Strategy | Examples |
|----------|----------|
| Semantic | `semantic_chunking.py`, `semantic_chunking_agno_embedder.py`, `semantic_chunking_chonkie_embedder.py` |
| Fixed Size | `fixed_size_chunking.py` |
| Recursive | `recursive_chunking.py` |
| Document | `document_chunking.py` |
| Code | `code_chunking.py`, `code_chunking_custom_tokenizer.py` |
| Markdown | `markdown_chunking.py` |
| CSV Row | `csv_row_chunking.py` |
| Agentic | `agentic_chunking.py` |
| Custom | `custom_strategy_example.py` |
