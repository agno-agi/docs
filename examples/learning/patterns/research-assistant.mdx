...
Full source: [cookbook/08_learning/07_patterns/research_assistant.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/07_patterns/research_assistant.py)
