...
description: "Automatic decision logging where tool calls are automatically recorded as decisions."
...
Full source: [cookbook/08_learning/09_decision_logs/02_decision_log_always.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/09_decision_logs/02_decision_log_always.py)
