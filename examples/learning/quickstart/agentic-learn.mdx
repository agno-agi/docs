...
Full source: [cookbook/08_learning/00_quickstart/02_agentic_learn.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/00_quickstart/02_agentic_learn.py)
