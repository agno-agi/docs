...
Full source: [cookbook/08_learning/06_quick_tests/02_learning_true_shorthand.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/06_quick_tests/02_learning_true_shorthand.py)
