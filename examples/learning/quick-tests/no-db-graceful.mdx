...
Full source: [cookbook/08_learning/06_quick_tests/03_no_db_graceful.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/06_quick_tests/03_no_db_graceful.py)
