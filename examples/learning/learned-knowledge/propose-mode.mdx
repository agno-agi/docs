...
Full source: [cookbook/08_learning/05_learned_knowledge/02_propose_mode.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/05_learned_knowledge/02_propose_mode.py)
