...
Full source: [cookbook/08_learning/08_custom_stores/01_minimal_custom_store.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/08_custom_stores/01_minimal_custom_store.py)
