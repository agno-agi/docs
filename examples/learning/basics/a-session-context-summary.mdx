...
Full source: [cookbook/08_learning/01_basics/3a_session_context_summary.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/01_basics/3a_session_context_summary.py)
