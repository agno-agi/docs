...
Full source: [cookbook/08_learning/01_basics/2b_user_memory_agentic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/01_basics/2b_user_memory_agentic.py)
