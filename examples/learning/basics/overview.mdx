...
| [Entity Memory: Agentic Mode](/examples/learning/basics/b-entity-memory-agentic) | AGENTIC mode gives the agent search_entities, create_entity, add_fact, add_event, and add_relationship tools to track companies and contacts. |
