...
Full source: [cookbook/08_learning/02_user_profile/01_always_extraction.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/02_user_profile/01_always_extraction.py)
