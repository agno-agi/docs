...
description: Agents that learn, adapt, and improve over time using the Learning Machine system.
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="user"
    iconType="duotone"
    href="/examples/learning/personal-assistant"
  >
  ...
  <Card
    ...
    icon="headset"
    iconType="duotone"
    href="/examples/learning/support-agent"
  >
...
- [Agent Memory](/basics/agents/usage/agent-with-memory) - Simple memory patterns
- [Knowledge](/context/knowledge/overview) - RAG and knowledge bases
- [Agent Examples](/examples/agents/overview) - More agent patterns
