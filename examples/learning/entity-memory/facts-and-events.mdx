...
Full source: [cookbook/08_learning/04_entity_memory/01_facts_and_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/04_entity_memory/01_facts_and_events.py)
