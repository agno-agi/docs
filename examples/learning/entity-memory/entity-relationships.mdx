...
description: "Create and query typed relationships between entities with AGENTIC entity memory."
...
Full source: [cookbook/08_learning/04_entity_memory/02_entity_relationships.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/08_learning/04_entity_memory/02_entity_relationships.py)
