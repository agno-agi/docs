...
Full source: [cookbook/04_workflows/02_conditional_execution/condition_basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/02_conditional_execution/condition_basic.py)
