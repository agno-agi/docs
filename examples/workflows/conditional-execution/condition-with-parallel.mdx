...
description: "Run Hacker News, web, and Exa research conditions in parallel before two synthesis steps."
...
<Steps>
  ...
  <Step title="Exercise all research branches">
...
Full source: [cookbook/04_workflows/02_conditional_execution/condition_with_parallel.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/02_conditional_execution/condition_with_parallel.py)
