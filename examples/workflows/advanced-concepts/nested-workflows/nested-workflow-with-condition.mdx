...
description: "Use Condition steps in nested workflows to conditionally branch execution based on content analysis."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/nested_workflow_with_condition.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/nested_workflow_with_condition.py)
