---
title: "Nested Workflow - Auto-Wrap (Passing Workflow Directly)"
description: "Pass a Workflow directly in steps list for auto-wrapping without explicit Step() wrapper."
source: cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/nested_workflow_pass_direct_workflow.py
---
...
Full source: [cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/nested_workflow_pass_direct_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/nested_workflow_pass_direct_workflow.py)
