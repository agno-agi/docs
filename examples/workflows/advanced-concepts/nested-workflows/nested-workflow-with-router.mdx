...
description: "Use Router steps in nested workflows to delegate tasks to specialist agents based on input keywords."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/nested_workflow_with_router.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/nested_workflow_with_router.py)
