...
description: "Compose a three-level workflow with parallel research branches and nested mini-workflows."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/deeply_nested_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/workflow_as_a_step/deeply_nested_workflow.py)
