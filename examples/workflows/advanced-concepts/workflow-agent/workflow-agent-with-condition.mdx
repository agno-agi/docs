...
description: "Add conditional steps to a WorkflowAgent graph."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/workflow_agent/workflow_agent_with_condition.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/workflow_agent/workflow_agent_with_condition.py)
