...
description: "Expose workflows as tools for agent execution."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/tools/workflow_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/tools/workflow_tools.py)
