...
description: "Build an interactive WebSocket client for authenticating, starting workflows, and rendering streamed workflow events."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/background_execution/websocket_client.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/06_advanced_concepts/background_execution/websocket_client.py)
