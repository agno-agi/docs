...
description: "Run a workflow in async background mode and poll run status until completion."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/background_execution/background_poll.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/background_execution/background_poll.py)
