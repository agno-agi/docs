...
description: "Give a tutoring workflow access to its three most recent runs for a continuing conversation."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/history/continuous_execution.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/history/continuous_execution.py)
