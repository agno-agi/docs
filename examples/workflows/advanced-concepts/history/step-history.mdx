---
title: "Step History"
description: "Control workflow-level and step-level history access for multi-step conversation workflows."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/history/step_history.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/history/step_history.py)
