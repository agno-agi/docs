...
description: "Route customer requests to specialist steps while maintaining shared workflow history for context continuity."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/history/intent_routing_with_history.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/history/intent_routing_with_history.py)
