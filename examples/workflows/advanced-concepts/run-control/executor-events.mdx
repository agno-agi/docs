...
description: "Suppress intermediate executor events while preserving terminal executor events when streaming."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_control/executor_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_control/executor_events.py)
