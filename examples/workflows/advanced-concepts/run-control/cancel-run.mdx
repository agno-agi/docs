---
title: "Cancel Run"
description: "Cancel a workflow run from another thread while it's executing."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_control/cancel_run.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_control/cancel_run.py)
