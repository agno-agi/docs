...
description: "Persist workflows with `to_dict()`, `save()`, and `load()`."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_control/workflow_serialization.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_control/workflow_serialization.py)
