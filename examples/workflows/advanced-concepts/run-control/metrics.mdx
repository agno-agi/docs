...
description: "Extract workflow and step-level execution metrics including duration and token counts."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_control/metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_control/metrics.py)
