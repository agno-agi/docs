---
title: "Event Storage"
description: "Store workflow events while filtering out high-volume event types."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_control/event_storage.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_control/event_storage.py)
