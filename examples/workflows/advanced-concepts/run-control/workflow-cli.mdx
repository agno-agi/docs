---
title: "Workflow CLI"
description: "Use `Workflow.cli_app()` for interactive command-line workflow runs."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_control/workflow_cli.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_control/workflow_cli.py)
