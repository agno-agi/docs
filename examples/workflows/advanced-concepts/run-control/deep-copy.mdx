...
description: "Create independent workflow copies with isolated state using `deep_copy()`."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_control/deep_copy.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_control/deep_copy.py)
