...
description: "Use workflow session state in `Condition` evaluator and executor functions."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/session_state/state_in_condition.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/state_in_condition.py)
