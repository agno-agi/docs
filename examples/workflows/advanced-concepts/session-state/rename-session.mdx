...
description: "Auto-generate a workflow session name after a run."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/session_state/rename_session.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/rename_session.py)
