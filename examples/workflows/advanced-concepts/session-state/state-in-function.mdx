...
description: "Read and mutate workflow session state in custom function executors."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/session_state/state_in_function.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/state_in_function.py)
