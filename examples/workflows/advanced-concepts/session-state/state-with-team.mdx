...
description: "Share session state across team and agent steps in project workflows."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/session_state/state_with_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/state_with_team.py)
