...
description: "Use router selectors with workflow session state for adaptive routing."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/session_state/state_in_router.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/state_in_router.py)
