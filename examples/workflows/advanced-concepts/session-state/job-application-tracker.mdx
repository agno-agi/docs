...
description: "Extract job applications with structured output and persist them in session state across workflow runs."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/session_state/job_application_tracker.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/session_state/job_application_tracker.py)
