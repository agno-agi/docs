...
description: "Access output from multiple prior steps using both named steps and implicit step keys."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/previous_step_outputs/access_previous_outputs.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/previous_step_outputs/access_previous_outputs.py)
