...
description: "Block prompt-injection attacks using PromptInjectionGuardrail in async workflows."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/guardrails/prompt_injection.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/guardrails/prompt_injection.py)
