...
description: "Inject configuration through workflow dependencies to control agent behavior."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_params/workflow_dependencies.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_params/workflow_dependencies.py)
