...
description: "Configure workflow behavior with metadata, dependencies, and session state in a content pipeline."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_params/workflow_all_params.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/run_params/workflow_all_params.py)
