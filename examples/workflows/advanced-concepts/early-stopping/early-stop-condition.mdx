...
description: "Stop an entire workflow when a Condition branch detects policy violations."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_condition.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_condition.py)
