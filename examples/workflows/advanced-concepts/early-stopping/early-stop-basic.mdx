...
description: "Implement early termination with `StepOutput(stop=True)` across direct steps, `Steps` containers, and agent/function workflows."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_basic.py)
