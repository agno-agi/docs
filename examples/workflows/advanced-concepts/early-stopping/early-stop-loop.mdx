...
description: "Halt a Loop when a safety-check step detects sensitive AI-related content."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_loop.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_loop.py)
