...
description: "Stop an entire workflow from a Parallel step when checking input for dangerous content."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_parallel.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/early_stopping/early_stop_parallel.py)
