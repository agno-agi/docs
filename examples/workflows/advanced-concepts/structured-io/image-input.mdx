---
title: "Image Input"
description: "Pass images to workflows and chain vision analysis with web search."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/structured_io/image_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/structured_io/image_input.py)
