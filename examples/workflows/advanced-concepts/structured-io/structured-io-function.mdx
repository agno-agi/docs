...
description: "Return strings and BaseModel objects from custom function steps in workflows with structured I/O and data flow analysis."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/structured_io/structured_io_function.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/structured_io/structured_io_function.py)
