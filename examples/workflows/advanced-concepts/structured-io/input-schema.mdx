---
title: "Input Schema"
description: "Validate workflow input with Pydantic schemas."
source: cookbook/04_workflows/06_advanced_concepts/structured_io/input_schema.py
---
...
<Steps>
  ...
  <Step title="Update the content planner model">
...
Full source: [cookbook/04_workflows/06_advanced_concepts/structured_io/input_schema.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/structured_io/input_schema.py)
