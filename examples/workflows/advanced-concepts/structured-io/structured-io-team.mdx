...
description: "Use structured output schemas across team steps in multi-step workflows."
...
Full source: [cookbook/04_workflows/06_advanced_concepts/structured_io/structured_io_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/06_advanced_concepts/structured_io/structured_io_team.py)
