...
description: "Route media requests to OpenAI image generation or Gemini video generation."
...
Full source: [cookbook/04_workflows/05_conditional_branching/selector_media_pipeline.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/05_conditional_branching/selector_media_pipeline.py)
