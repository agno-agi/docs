...
description: "Return a step name string from a router selector."
...
Full source: [cookbook/04_workflows/05_conditional_branching/string_selector.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/05_conditional_branching/string_selector.py)
