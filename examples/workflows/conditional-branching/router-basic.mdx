---
title: "Router Basic"
description: "Route to HackerNews or web research based on topic keywords."
...
Full source: [cookbook/04_workflows/05_conditional_branching/router_basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/05_conditional_branching/router_basic.py)
