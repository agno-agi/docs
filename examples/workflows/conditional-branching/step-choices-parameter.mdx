...
description: "Access available choices in selector functions to dynamically route between steps."
...
Full source: [cookbook/04_workflows/05_conditional_branching/step_choices_parameter.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/05_conditional_branching/step_choices_parameter.py)
