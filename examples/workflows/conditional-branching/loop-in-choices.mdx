...
Full source: [cookbook/04_workflows/05_conditional_branching/loop_in_choices.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/05_conditional_branching/loop_in_choices.py)
