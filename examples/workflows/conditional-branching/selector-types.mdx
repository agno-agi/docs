...
description: "Use string, step, list, and nested return types in router selectors."
...
Full source: [cookbook/04_workflows/05_conditional_branching/selector_types.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/05_conditional_branching/selector_types.py)
