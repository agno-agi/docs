...
description: "Route to simple web search or iterative deep research loops based on topic complexity."
...
Full source: [cookbook/04_workflows/05_conditional_branching/router_with_loop.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/05_conditional_branching/router_with_loop.py)
