...
Full source: [cookbook/04_workflows/04_parallel_execution/parallel_with_condition.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/04_parallel_execution/parallel_with_condition.py)
