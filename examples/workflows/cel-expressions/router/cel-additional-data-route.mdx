...
description: "Uses additional_data.route to let the caller specify which step to run, useful when the routing decision is made upstream (e.g. UI)."
...
Full source: [cookbook/04_workflows/07_cel_expressions/router/cel_additional_data_route.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/07_cel_expressions/router/cel_additional_data_route.py)
