...
description: "Uses step_choices[0], step_choices[1], etc. to reference steps by their position in the choices list, rather than hardcoding step names."
...
Full source: [cookbook/04_workflows/07_cel_expressions/router/cel_using_step_choices.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/07_cel_expressions/router/cel_using_step_choices.py)
