...
Full source: [cookbook/04_workflows/07_cel_expressions/router/cel_session_state_route.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/07_cel_expressions/router/cel_session_state_route.py)
