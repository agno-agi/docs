...
Full source: [cookbook/04_workflows/07_cel_expressions/loop/cel_step_outputs_check.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/07_cel_expressions/loop/cel_step_outputs_check.py)
