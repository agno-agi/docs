...
Full source: [cookbook/04_workflows/01_basic_workflows/02_step_with_function/step_with_function.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/01_basic_workflows/02_step_with_function/step_with_function.py)
