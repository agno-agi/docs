...
description: "Decision tree mixing Condition and Loop components with user confirmation at each pause point."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/decision_tree/02_multi_component_decision_tree.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/decision_tree/02_multi_component_decision_tree.py)
