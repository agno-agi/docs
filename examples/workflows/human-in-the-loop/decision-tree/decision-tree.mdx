...
description: "Build a multi-step decision tree with sequential Condition pauses at each branch."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/decision_tree/01_decision_tree.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/decision_tree/01_decision_tree.py)
