...
description: "Allow humans to edit step output directly instead of retrying, avoiding extra LLM calls."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/output_review/03_edit_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/output_review/03_edit_output.py)
