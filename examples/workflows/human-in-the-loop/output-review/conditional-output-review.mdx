...
description: "Conditional HITL using the HITL config: the output review only triggers when a condition is met."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/output_review/04_conditional_output_review.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/output_review/04_conditional_output_review.py)
