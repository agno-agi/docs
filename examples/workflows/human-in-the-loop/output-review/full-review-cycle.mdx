...
description: "Handle approve, reject with feedback and retry, and cancel decisions in one HITL workflow."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/output_review/05_full_review_cycle.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/output_review/05_full_review_cycle.py)
