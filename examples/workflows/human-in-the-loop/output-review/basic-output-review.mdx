...
description: "Post-execution output review using the HITL config, where the workflow pauses AFTER a step runs so a human can review the output before it flows to the next step."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/output_review/01_basic_output_review.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/output_review/01_basic_output_review.py)
