---
title: "Dual HITL: Condition Confirmation + Executor Tool Confirmation (Streaming)"
description: "Require confirmation for branch selection, then confirm the tool call inside the chosen branch."
source: cookbook/04_workflows/08_human_in_the_loop/dual_level_hitl/03_condition_and_tool_confirmation.py
---
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/dual_level_hitl/03_condition_and_tool_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/dual_level_hitl/03_condition_and_tool_confirmation.py)
