...
description: "Confirm the agent's tool call during execution, then review the step output after it completes."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/dual_level_hitl/05_output_review_and_tool_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/dual_level_hitl/05_output_review_and_tool_confirmation.py)
