...
description: "Pause workflow execution until the user confirms an agent tool call."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/executor_hitl/01_agent_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/executor_hitl/01_agent_confirmation.py)
