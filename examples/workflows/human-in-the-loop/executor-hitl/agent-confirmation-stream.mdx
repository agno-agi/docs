...
description: "Emit StepExecutorPausedEvent in workflow stream when agent tool needs confirmation."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/executor_hitl/02_agent_confirmation_stream.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/executor_hitl/02_agent_confirmation_stream.py)
