...
description: "Require confirmation for workflow steps with the @pause decorator."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/confirmation/02_custom_function_step_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/confirmation/02_custom_function_step_confirmation.py)
