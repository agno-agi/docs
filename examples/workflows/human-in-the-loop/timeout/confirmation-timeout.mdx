...
description: "Apply automatic timeouts to pre-execution confirmation with HumanReview."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/timeout/02_confirmation_timeout.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/timeout/02_confirmation_timeout.py)
