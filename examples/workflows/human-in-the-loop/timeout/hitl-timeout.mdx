...
description: "Timeout handling for HITL pauses using the HumanReview config class."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/timeout/01_hitl_timeout.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/timeout/01_hitl_timeout.py)
