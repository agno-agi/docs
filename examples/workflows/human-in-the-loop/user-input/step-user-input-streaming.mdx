...
description: "Handle human-in-the-loop pauses with streaming workflow events."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/user_input/03_step_user_input_streaming.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/user_input/03_step_user_input_streaming.py)
