...
description: "Handle step errors by pausing workflow and letting user choose to retry or skip the step."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/error/01_error_retry_skip.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/error/01_error_retry_skip.py)
