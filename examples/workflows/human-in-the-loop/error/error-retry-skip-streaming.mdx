...
description: "Handle step errors with streaming event updates, pausing to let user retry or skip failed steps."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/error/02_error_retry_skip_streaming.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/error/02_error_retry_skip_streaming.py)
