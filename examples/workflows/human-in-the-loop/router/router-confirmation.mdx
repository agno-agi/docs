...
description: "Automatically route requests and require user confirmation to proceed."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/router/04_router_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/router/04_router_confirmation.py)
