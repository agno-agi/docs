...
description: "Let users choose from pre-configured processing packages."
...
Full source: [cookbook/04_workflows/08_human_in_the_loop/router/03_router_nested_choices.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/04_workflows/08_human_in_the_loop/router/03_router_nested_choices.py)
