...
description: "Run WebContextProvider with ExaBackend so an agent searches and fetches web pages through Exa's search + contents API."
...
Full source: [cookbook/12_context/01_web_exa.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/01_web_exa.py)
