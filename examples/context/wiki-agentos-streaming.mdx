...
description: "Serve a WikiContextProvider-backed agent on AgentOS at localhost:7777 so sub-agent tool calls and content stream live into os.agno.com."
...
Full source: [cookbook/12_context/23_wiki_agentos_streaming.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/23_wiki_agentos_streaming.py)
