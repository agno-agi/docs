...
description: "Attach two WikiContextProviders (architecture and operations) to one AgentOS agent and stream nested events from parallel sub-agent tool calls."
...
Full source: [cookbook/12_context/24_multi_context_streaming.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/24_multi_context_streaming.py)
