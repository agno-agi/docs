...
<Steps>
  ...
  <Step title="Accept the run context">
...
Full source: [cookbook/12_context/10_custom_provider.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/10_custom_provider.py)
