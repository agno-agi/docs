...
description: "Mount two WikiContextProvider instances on one agent: a read-write company_knowledge wiki and a read-only company_voice wiki."
...
Full source: [cookbook/12_context/17_wiki_dual.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/17_wiki_dual.py)
