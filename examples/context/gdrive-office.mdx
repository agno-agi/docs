...
description: "Reads .docx, .xlsx and .pptx files from Google Drive via GoogleDriveContextProvider, extracting text with python-docx, openpyxl and python-pptx."
...
Full source: [cookbook/12_context/21_gdrive_office.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/21_gdrive_office.py)
