...
description: "Use one SQLite engine for read and write operations through DatabaseContextProvider."
...
Full source: [cookbook/12_context/04_database_read_write.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/04_database_read_write.py)
