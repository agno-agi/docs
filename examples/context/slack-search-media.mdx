...
description: "Run SlackContextProvider with Gemini sub-agents, enabling search_messages and opt-in media tools for file download and upload."
...
Full source: [cookbook/12_context/06_slack_search_media.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/06_slack_search_media.py)
