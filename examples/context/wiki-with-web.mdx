...
description: "Wires an ExaMCPBackend into WikiContextProvider so a single update_wiki call can search or fetch the web, digest the result, and file it as a wiki page."
...
Full source: [cookbook/12_context/16_wiki_with_web.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/12_context/16_wiki_with_web.py)
