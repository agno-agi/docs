...
description: "Synthesizes a briefing by chaining Slack, workspace, and Parallel web context providers, then posting the result back to Slack."
...
<Steps>
  ...
  <Step title="Prepare Slack channels">
...
Full source: [cookbook/12_context/12_engineering_briefing.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/12_context/12_engineering_briefing.py)
