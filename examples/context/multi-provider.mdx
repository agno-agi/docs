...
description: "Compose filesystem, Exa MCP web, and SQLite database context providers on one agent, bracketing only the web provider's MCP session with asetup/aclose."
...
Full source: [cookbook/12_context/08_multi_provider.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/12_context/08_multi_provider.py)
