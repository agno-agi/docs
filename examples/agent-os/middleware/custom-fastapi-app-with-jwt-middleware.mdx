...
description: "Protect a custom FastAPI app mounted as AgentOS base_app with JWT auth, excluding a /auth/login token-issuing route."
...
Full source: [cookbook/05_agent_os/middleware/custom_fastapi_app_with_jwt_middleware.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/middleware/custom_fastapi_app_with_jwt_middleware.py)
