...
description: "Attach per-IP rate limiting and request/response logging middleware to an AgentOS FastAPI app."
...
Full source: [cookbook/05_agent_os/middleware/agent_os_with_custom_middleware.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/middleware/agent_os_with_custom_middleware.py)
