...
description: "Attach OpenAI moderation, prompt-injection, and PII detection guardrails as pre-hooks on an AgentOS agent and team."
...
Full source: [cookbook/05_agent_os/middleware/guardrails_demo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/middleware/guardrails_demo.py)
