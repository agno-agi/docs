...
description: "Capture the X-APP-UUID header and extract agent response content from streaming and non-streaming /runs responses with a Starlette middleware."
...
Full source: [cookbook/05_agent_os/middleware/extract_content_middleware.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/middleware/extract_content_middleware.py)
