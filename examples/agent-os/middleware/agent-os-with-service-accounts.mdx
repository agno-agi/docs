...
Full source: [cookbook/05_agent_os/07_security/service_accounts.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/07_security/service_accounts.py)
