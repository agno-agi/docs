...
<Steps>
  ...
  <Step title="Create the second database">
...
Full source: [cookbook/05_agent_os/os_config/basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/os_config/basic.py)
