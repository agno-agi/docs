...
Full source: [cookbook/05_agent_os/08_os_config/yaml_config.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/08_os_config/yaml_config.py)
