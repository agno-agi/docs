...
Full source: [cookbook/05_agent_os/13_observability/traces_to_clickhouse.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/13_observability/traces_to_clickhouse.py)
