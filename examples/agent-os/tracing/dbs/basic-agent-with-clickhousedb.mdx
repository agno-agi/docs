...
Full source: [cookbook/05_agent_os/tracing/dbs/basic_agent_with_clickhousedb.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/tracing/dbs/basic_agent_with_clickhousedb.py)
