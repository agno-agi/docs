...
Full source: [cookbook/05_agent_os/tracing/02_basic_team_tracing.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/tracing/02_basic_team_tracing.py)
