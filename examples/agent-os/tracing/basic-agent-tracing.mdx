...
Full source: [cookbook/05_agent_os/tracing/01_basic_agent_tracing.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/tracing/01_basic_agent_tracing.py)
