...
description: "Configure tracing manually with setup_tracing, batching exports to a dedicated traces database."
source: cookbook/05_agent_os/tracing/06_tracing_with_multi_db_scenario.py
---
...
Full source: [cookbook/05_agent_os/tracing/06_tracing_with_multi_db_scenario.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/tracing/06_tracing_with_multi_db_scenario.py)
