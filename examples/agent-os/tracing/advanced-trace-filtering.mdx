...
description: "Build AND/OR/NOT, CONTAINS, IN and range trace queries with the FilterExpr DSL and run them against SqliteDb.get_traces."
...
Full source: [cookbook/05_agent_os/tracing/08_advanced_trace_filtering.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/tracing/08_advanced_trace_filtering.py)
