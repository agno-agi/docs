---
title: "AgentOS Demo"
description: "Serve an AgentOS with a docs-MCP agent over PgVector knowledge plus a Postgres-backed web research team."
...
Full source: [cookbook/05_agent_os/demo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/demo.py)
