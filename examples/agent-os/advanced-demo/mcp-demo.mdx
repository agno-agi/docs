---
title: "MCP Demo"
description: "Define a FastAPI lifespan that connects MCPTools to the GitHub MCP server over stdio."
...
<Steps>
  ...
  <Step title="Choose the GitHub token name">
...
Full source: [cookbook/05_agent_os/advanced_demo/mcp_demo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/advanced_demo/mcp_demo.py)
