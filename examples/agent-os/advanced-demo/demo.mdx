---
title: "AgentOS Demo"
description: "Serve an AgentOS app combining the Sage and Agno Assist agents with the finance reasoning team, plus an AccuracyEval setup."
...
Full source: [cookbook/05_agent_os/advanced_demo/demo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/advanced_demo/demo.py)
