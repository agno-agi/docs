...
description: "Stream a Claude thinking-model chain of thought live from an AgentOS reasoning agent."
...
Full source: [cookbook/05_agent_os/advanced_demo/reasoning_model.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/advanced_demo/reasoning_model.py)
