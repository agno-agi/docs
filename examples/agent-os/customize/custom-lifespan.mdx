...
description: "Pass an asynccontextmanager lifespan to AgentOS to run startup and shutdown hooks around the FastAPI app."
...
Full source: [cookbook/05_agent_os/customize/custom_lifespan.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/customize/custom_lifespan.py)
