...
description: "Send a dependencies payload on an AgentOS run request to fill the {robot_name} placeholder in the agent's instructions."
...
Full source: [cookbook/05_agent_os/customize/pass_dependencies_to_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/customize/pass_dependencies_to_agent.py)
