...
Full source: [cookbook/05_agent_os/customize/update_from_lifespan.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/customize/update_from_lifespan.py)
