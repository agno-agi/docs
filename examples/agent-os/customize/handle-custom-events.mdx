...
description: "Yield a CustomEvent subclass from an async tool that reads session_state, streamed through AgentOS agent and team run endpoints."
...
Full source: [cookbook/05_agent_os/customize/handle_custom_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/customize/handle_custom_events.py)
