...
description: "Use on_route_conflict=\"preserve_base_app\" so custom / and /health routes win over the conflicting AgentOS routes."
...
Full source: [cookbook/05_agent_os/customize/override_routes.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/customize/override_routes.py)
