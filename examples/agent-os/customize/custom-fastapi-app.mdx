...
description: "Mount AgentOS on an existing FastAPI base_app so a custom /customers route is served alongside AgentOS routes."
...
Full source: [cookbook/05_agent_os/customize/custom_fastapi_app.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/customize/custom_fastapi_app.py)
