...
description: "Team member tool marked external_execution so AgentOS pauses the run and the client executes send_email and returns the result via continue_run."
...
<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/05_agent_os/hitl/external_tool_execution.py`. Follow the generated Run step below.
</Warning>
...
Full source: [cookbook/05_agent_os/human_in_the_loop/team/external_tool_execution.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/human_in_the_loop/team/external_tool_execution.py)
