...
description: "Team member's plan_trip tool declares requires_user_input for destination and budget, pausing the AgentOS run until the client supplies the missing fields."
...
<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/05_agent_os/hitl/user_input_required.py`. Follow the generated Run step below.
</Warning>
...
Full source: [cookbook/05_agent_os/human_in_the_loop/team/user_input_required.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/human_in_the_loop/team/user_input_required.py)
