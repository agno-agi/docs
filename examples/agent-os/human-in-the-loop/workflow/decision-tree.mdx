...
description: "Chain confirmation Conditions for analysis depth and output format in one AgentOS workflow."
...
Full source: [cookbook/05_agent_os/human_in_the_loop/workflow/decision_tree.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/human_in_the_loop/workflow/decision_tree.py)
