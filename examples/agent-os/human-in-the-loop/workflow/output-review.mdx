...
description: "Pausing after a step runs so a human can review the step output before the workflow continues in AgentOS."
...
Full source: [cookbook/05_agent_os/human_in_the_loop/workflow/output_review.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/human_in_the_loop/workflow/output_review.py)
