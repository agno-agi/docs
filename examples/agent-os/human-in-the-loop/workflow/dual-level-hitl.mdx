...
description: "One workflow step pauses twice: first for step-level user input of the destination city, then for confirmation of the agent's book_flight tool call."
...
Full source: [cookbook/05_agent_os/human_in_the_loop/workflow/dual_level_hitl.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/human_in_the_loop/workflow/dual_level_hitl.py)
