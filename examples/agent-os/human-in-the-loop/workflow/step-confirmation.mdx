...
Full source: [cookbook/05_agent_os/human_in_the_loop/workflow/step_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/human_in_the_loop/workflow/step_confirmation.py)
