...
description: "Pausing before a Loop starts so a human can decide whether to run the iterative work."
...
Full source: [cookbook/05_agent_os/human_in_the_loop/workflow/loop_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/human_in_the_loop/workflow/loop_confirmation.py)
