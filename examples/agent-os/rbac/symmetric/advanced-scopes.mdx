...
description: "Issue HS256 tokens across five privilege tiers to show global, per-agent, and wildcard scopes filtering the agent list and gating agent runs."
...
Full source: [cookbook/05_agent_os/rbac/symmetric/advanced_scopes.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/rbac/symmetric/advanced_scopes.py)
