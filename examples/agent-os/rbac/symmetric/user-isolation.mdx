...
<Steps>
  ...
  <Step title="Configure the optional JWT secret">
...
Full source: [cookbook/05_agent_os/07_security/user_isolation.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/07_security/user_isolation.py)
