...
description: "Protect AgentOS endpoints with HS256 JWTs via AuthorizationConfig and default scope mappings, minting user and admin test tokens."
...
Full source: [cookbook/05_agent_os/rbac/symmetric/basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/rbac/symmetric/basic.py)
