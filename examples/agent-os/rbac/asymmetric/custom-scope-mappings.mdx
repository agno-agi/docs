...
description: "Attach JWTMiddleware with RS256 keys and a per-endpoint scope_mappings table so routes such as POST /agents/*/runs require multiple custom scopes."
...
<Steps>
  ...
  <Step title="Configure optional JWT keys">
...
Full source: [cookbook/05_agent_os/rbac/asymmetric/custom_scope_mappings.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/rbac/asymmetric/custom_scope_mappings.py)
