...
<Steps>
  ...
  <Step title="Configure an isolated WorkOS environment">
...
Full source: [cookbook/05_agent_os/rbac/asymmetric/workos_byot.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/rbac/asymmetric/workos_byot.py)
