...
description: "Telegram bot that pairs ReasoningTools think/analyze steps with DuckDuckGo search, running on OpenAIChat gpt-5.2 with SQLite session history."
...
Full source: [cookbook/05_agent_os/interfaces/telegram/reasoning_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/telegram/reasoning_agent.py)
