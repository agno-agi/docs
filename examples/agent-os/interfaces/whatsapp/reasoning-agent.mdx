...
Full source: [cookbook/05_agent_os/19_whatsapp/reasoning_agent.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/19_whatsapp/reasoning_agent.py)
