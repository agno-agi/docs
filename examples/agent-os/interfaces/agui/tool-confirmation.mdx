---
title: "Tool Confirmation: Dojo Demo"
description: "Frontend-provided tools: send_email, delete_files (via useHumanInTheLoop)."
source: cookbook/05_agent_os/interfaces/agui/tool_confirmation.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `tool_confirmation.py`, then run:
    ```bash
    python tool_confirmation.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/interfaces/agui/tool_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/agui/tool_confirmation.py)
