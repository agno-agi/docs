...
description: "Serves a recipe-creator plus nutrition-advisor Team over AG-UI at /shared_state, with enable_agentic_state syncing the shared recipe session state to the UI."
...
Full source: [cookbook/05_agent_os/interfaces/agui/team_state_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/agui/team_state_events.py)
