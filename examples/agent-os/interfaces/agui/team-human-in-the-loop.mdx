---
title: "Team Human in the Loop"
description: "Demonstrates team with member tool requiring confirmation."
source: cookbook/05_agent_os/interfaces/agui/team_human_in_the_loop.py
---
...
Full source: [cookbook/05_agent_os/interfaces/agui/team_human_in_the_loop.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/agui/team_human_in_the_loop.py)
