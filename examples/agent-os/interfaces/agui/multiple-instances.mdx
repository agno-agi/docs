...
description: "Mount two agents on separate AG-UI endpoints with the prefix parameter."
source: cookbook/05_agent_os/interfaces/agui/multiple_instances.py
---
...
Full source: [cookbook/05_agent_os/interfaces/agui/multiple_instances.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/agui/multiple_instances.py)
