...
Full source: [cookbook/05_agent_os/16_agui/multiple_instances.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/16_agui/multiple_instances.py)
