...
Full source: [cookbook/05_agent_os/16_agui/agent_with_media.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/16_agui/agent_with_media.py)
