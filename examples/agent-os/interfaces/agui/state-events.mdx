---
title: "State Events"
description: "Serves a recipe agent over AG-UI at /shared_state, where enable_agentic_state lets the model call update_session_state to sync recipe fields to the UI."
...
Full source: [cookbook/05_agent_os/interfaces/agui/state_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/agui/state_events.py)
