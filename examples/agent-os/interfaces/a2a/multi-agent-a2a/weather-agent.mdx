...
Full source: [cookbook/05_agent_os/15_a2a/multi_agent/weather_agent.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/15_a2a/multi_agent/weather_agent.py)
