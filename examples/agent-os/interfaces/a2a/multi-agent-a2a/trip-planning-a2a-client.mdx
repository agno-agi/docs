...
Full source: [cookbook/05_agent_os/15_a2a/multi_agent/trip_planning_a2a_client.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/15_a2a/multi_agent/trip_planning_a2a_client.py)
