...
description: "A multi-tool research agent that exercises many different tool types to stress-test the Slack streaming plan block UI."
source: cookbook/05_agent_os/interfaces/slack/streaming_deep_research.py
---
...
Full source: [cookbook/05_agent_os/interfaces/slack/streaming_deep_research.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/streaming_deep_research.py)
