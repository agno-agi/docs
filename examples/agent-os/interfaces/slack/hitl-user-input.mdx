...
description: "Support-intake agent that drafts a ticket title and body but declares priority and component as user_input_fields, pausing Slack with an input form the requester fills before the tool runs."
...
Full source: [cookbook/05_agent_os/interfaces/slack/hitl_user_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/hitl_user_input.py)
