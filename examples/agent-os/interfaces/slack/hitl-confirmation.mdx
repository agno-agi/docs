...
description: "Pause irreversible subscription cancellation for an Approve or Deny decision in Slack."
...
Full source: [cookbook/05_agent_os/interfaces/slack/hitl_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/hitl_confirmation.py)
