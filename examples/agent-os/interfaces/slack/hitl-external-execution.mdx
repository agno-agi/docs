...
Full source: [cookbook/05_agent_os/17_slack/hitl_external_execution.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/17_slack/hitl_external_execution.py)
