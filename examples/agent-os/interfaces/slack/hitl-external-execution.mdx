...
description: "Slack agent whose kubectl tool is external_execution=True, so the engineer runs the command locally and pastes output back for analysis against internal runbooks."
...
Full source: [cookbook/05_agent_os/interfaces/slack/hitl_external_execution.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/hitl_external_execution.py)
