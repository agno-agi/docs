...
Full source: [cookbook/05_agent_os/17_slack/hitl_incident_commander.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/17_slack/hitl_incident_commander.py)
