...
description: "Persist approval records for schema migrations so Slack approvals survive restarts and leave an audit trail."
...
Full source: [cookbook/05_agent_os/interfaces/slack/hitl_required_approval.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/hitl_required_approval.py)
