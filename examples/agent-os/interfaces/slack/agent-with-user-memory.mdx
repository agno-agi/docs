...
description: "Slack personal assistant that captures names, hobbies, and preferences with MemoryManager and recalls them in later chats."
source: cookbook/05_agent_os/interfaces/slack/agent_with_user_memory.py
---
...
Full source: [cookbook/05_agent_os/interfaces/slack/agent_with_user_memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/agent_with_user_memory.py)
