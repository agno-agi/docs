...
description: "Incident-commander agent forced to call a tool every turn, with approval, external-execution, and user-input pauses in Slack."
...
Full source: [cookbook/05_agent_os/interfaces/slack/hitl_audit_flow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/hitl_audit_flow.py)
