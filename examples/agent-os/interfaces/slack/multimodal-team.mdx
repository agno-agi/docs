...
description: "Legacy Slack team example with image analysis, web research, and DalleTools generation."
...
Full source: [cookbook/05_agent_os/interfaces/slack/multimodal_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/multimodal_team.py)
