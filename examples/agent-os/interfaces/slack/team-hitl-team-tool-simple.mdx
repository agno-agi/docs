...
description: "Pause a Slack team run for Approve/Deny when the team-level deployment tool is called."
...
Full source: [cookbook/05_agent_os/interfaces/slack/team_hitl_team_tool_simple.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/team_hitl_team_tool_simple.py)
