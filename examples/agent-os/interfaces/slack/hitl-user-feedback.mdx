...
description: "Travel concierge that calls ask_user via UserFeedbackTools, so Slack renders a single TaskCard of multi- and single-select preference questions whose answers feed the itinerary draft."
...
Full source: [cookbook/05_agent_os/interfaces/slack/hitl_user_feedback.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/hitl_user_feedback.py)
