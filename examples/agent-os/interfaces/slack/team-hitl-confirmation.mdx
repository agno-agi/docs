...
description: "Propagate a team member's weather-tool confirmation pause to Approve and Deny buttons in Slack."
...
Full source: [cookbook/05_agent_os/interfaces/slack/team_hitl_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/team_hitl_confirmation.py)
