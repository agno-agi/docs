...
description: "Pause a Slack team run so the user fills in destination and budget fields before the trip-planning tool executes."
...
Full source: [cookbook/05_agent_os/interfaces/slack/team_hitl_user_input_simple.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/slack/team_hitl_user_input_simple.py)
