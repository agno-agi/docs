...
Full source: [cookbook/05_agent_os/studio_tool/studio_hitl_agent_os.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/studio_tool/studio_hitl_agent_os.py)
