...
Full source: [cookbook/05_agent_os/22_studio/studio_tools_agent.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/22_studio/studio_tools_agent.py)
