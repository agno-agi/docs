...
description: "Serve an agent with FileGenerationTools through AgentOS to produce JSON, CSV, PDF, DOCX, TXT, and HTML files returned as base64 artifacts."
...
Full source: [cookbook/05_agent_os/file_generation/file_generation_os.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/file_generation/file_generation_os.py)
