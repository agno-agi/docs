...
description: "WorkflowFactory that rebuilds a two-step draft-then-edit content pipeline per request with tenant-specific agent instructions."
...
Full source: [cookbook/05_agent_os/factories/workflow/01_basic_workflow_factory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/factories/workflow/01_basic_workflow_factory.py)
