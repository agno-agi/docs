...
Full source: [cookbook/05_agent_os/factories/agent/04_tiered_model_factory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/factories/agent/04_tiered_model_factory.py)
