...
description: "AgentFactory whose Hacker News tool is marked requires_confirmation, pausing the run until it is approved or rejected via the /continue endpoint."
...
Full source: [cookbook/05_agent_os/factories/agent/05_hitl_factory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/factories/agent/05_hitl_factory.py)
