...
curated_source: cookbook/05_agent_os/factories/agent/03_jwt_role_factory.py
---
...
Full source: [cookbook/05_agent_os/factories/agent/03_jwt_role_factory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/factories/agent/03_jwt_role_factory.py)
