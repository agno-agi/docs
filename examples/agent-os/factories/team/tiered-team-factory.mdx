...
Full source: [cookbook/05_agent_os/factories/team/02_tiered_team_factory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/factories/team/02_tiered_team_factory.py)
