...
description: "Serve a Docling-backed markdown knowledge agent with PgVector through AgentOS."
...
Full source: [cookbook/05_agent_os/knowledge/agentos_docling_markdown_analyst.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/knowledge/agentos_docling_markdown_analyst.py)
