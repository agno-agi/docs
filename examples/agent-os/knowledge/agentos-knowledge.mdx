...
description: "Serve an AgentOS agent over hybrid-search PgVector knowledge, toggling between PostgresDb and AsyncPostgresDb with a USE_ASYNC flag."
...
Full source: [cookbook/05_agent_os/knowledge/agentos_knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/knowledge/agentos_knowledge.py)
