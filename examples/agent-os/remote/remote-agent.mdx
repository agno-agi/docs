...
Full source: [cookbook/05_agent_os/20_remote/01_remote_agent.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/20_remote/01_remote_agent.py)
