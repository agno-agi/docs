...
Full source: [cookbook/05_agent_os/20_remote/servers/adk_server.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/20_remote/servers/adk_server.py)
