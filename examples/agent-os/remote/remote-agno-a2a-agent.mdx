...
description: "Call Agno agents exposed over the A2A REST interface with RemoteAgent, covering single-shot, streaming, and agent-card lookup."
...
Full source: [cookbook/05_agent_os/remote/03_remote_agno_a2a_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/remote/03_remote_agno_a2a_agent.py)
