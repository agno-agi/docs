...
Full source: [cookbook/05_agent_os/remote/04_remote_adk_agent.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/remote/04_remote_adk_agent.py)
