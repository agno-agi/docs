...
description: "Add an A2A-protocol RemoteAgent (REST transport) alongside a local Agent in one cross-framework Team."
...
Full source: [cookbook/05_agent_os/remote/07_a2a_agent_as_team_member.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/remote/07_a2a_agent_as_team_member.py)
