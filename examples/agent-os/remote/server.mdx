...
description: "Start an AgentOS server with two agents, a team, a QA workflow, and ChromaDb knowledge for client examples."
source: cookbook/05_agent_os/remote/server.py
---
...
Full source: [cookbook/05_agent_os/remote/server.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/remote/server.py)
