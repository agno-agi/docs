---
title: "SingleStore"
description: "Back an AgentOS agent, team, and AccuracyEval with SingleStoreDb using custom session, eval, memory, and metrics tables."
...
<Steps>
  ...
  <Step title="Prepare SingleStore">
...
Full source: [cookbook/05_agent_os/dbs/singlestore.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/singlestore.py)
