...
description: "Run AgentOS on Postgres with PostgresDb and AsyncPostgresDb backends, the async setup adding a persisted workflow alongside the agent and team."
...
Full source: [cookbook/05_agent_os/02_databases/postgres.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/02_databases/postgres.py)
