---
title: "Dynamo"
description: "Back an AgentOS agent, team, and AccuracyEval with DynamoDb for sessions, memories, and summaries."
...
Full source: [cookbook/05_agent_os/dbs/dynamo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/dynamo.py)
