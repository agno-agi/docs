---
title: "GCS JSON"
description: "Back an AgentOS agent, team, and AccuracyEval with GcsJsonDb, storing all state as JSON objects in a GCS bucket."
...
Full source: [cookbook/05_agent_os/dbs/gcs_json.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/gcs_json.py)
