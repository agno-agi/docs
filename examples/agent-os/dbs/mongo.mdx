...
description: "Run AgentOS on MongoDB with parallel MongoDb and AsyncMongoDb backends, each wired to an agent, team, and accuracy eval."
...
Full source: [cookbook/05_agent_os/dbs/mongo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/mongo.py)
