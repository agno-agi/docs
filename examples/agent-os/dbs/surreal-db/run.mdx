...
<Steps>
  ...
  <Step title="Enable the promised research tools">
  ...
  <Step title="Keep one MCP lifespan">
...
Full source: [cookbook/05_agent_os/dbs/surreal_db/run.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/surreal_db/run.py)
