---
title: "Neon"
description: "Use a NEON_DB_URL-backed PostgresDb for AccuracyEval in an AgentOS with an agent and team."
...
Full source: [cookbook/05_agent_os/dbs/neon.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/neon.py)
