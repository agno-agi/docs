...
description: "Run AgentOS on MySQL with MySQLDb (pymysql) and AsyncMySQLDb (asyncmy) backends and custom session, eval, memory, and metrics tables."
...
Full source: [cookbook/05_agent_os/dbs/mysql.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/mysql.py)
