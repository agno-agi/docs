---
title: "Firestore"
description: "Back an AgentOS agent, team, and AccuracyEval with FirestoreDb using explicit session, memory, eval, metrics, and knowledge collections."
...
Full source: [cookbook/05_agent_os/dbs/firestore.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/firestore.py)
