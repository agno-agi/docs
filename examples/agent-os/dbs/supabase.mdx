---
title: "Supabase"
description: "Point PostgresDb at a Supabase project by building its connection URL from SUPABASE_PROJECT and SUPABASE_PASSWORD env vars."
...
Full source: [cookbook/05_agent_os/dbs/supabase.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/dbs/supabase.py)
