...
Full source: [cookbook/05_agent_os/workflow/workflow_with_conditional.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/workflow/workflow_with_conditional.py)
