...
Full source: [cookbook/05_agent_os/workflow/workflow_with_router.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/workflow/workflow_with_router.py)
