...
description: "Nest three levels of workflows, with a Parallel step wrapping a Condition-gated fact check, served through AgentOS on Postgres."
...
Full source: [cookbook/05_agent_os/workflow/workflow_with_workflow_as_step.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/workflow/workflow_with_workflow_as_step.py)
