...
description: "Run a nested deep-research Loop through a Router before the report-writing step."
...
Full source: [cookbook/05_agent_os/workflow/workflow_with_nested_steps.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/workflow/workflow_with_nested_steps.py)
