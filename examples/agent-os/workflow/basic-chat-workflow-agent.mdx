...
description: "Serve a story-writing workflow on AgentOS where a WorkflowAgent decides when to run write, conditional-edit, format, and reference steps backed by Postgres."
...
Full source: [cookbook/05_agent_os/workflow/basic_chat_workflow_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/workflow/basic_chat_workflow_agent.py)
