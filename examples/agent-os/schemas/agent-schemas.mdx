...
description: "Serve two AgentOS agents: a HackerNews agent with a Pydantic input_schema and a movie agent with a MovieScript output_schema."
...
Full source: [cookbook/05_agent_os/schemas/agent_schemas.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/schemas/agent_schemas.py)
