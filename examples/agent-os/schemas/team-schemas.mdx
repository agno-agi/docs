...
description: "Serve two AgentOS teams: one validating requests with a Pydantic input_schema, one returning a ResearchReport output_schema."
...
Full source: [cookbook/05_agent_os/schemas/team_schemas.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/schemas/team_schemas.py)
