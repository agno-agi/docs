...
Full source: [cookbook/05_agent_os/approvals/agent/approval_user_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/approvals/agent/approval_user_input.py)
