...
Full source: [cookbook/02_agents/11_approvals/approval_user_input.py](https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/11_approvals/approval_user_input.py)
