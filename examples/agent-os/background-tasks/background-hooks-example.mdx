...
description: "Enable AgentOS-wide background hooks with run_hooks_in_background=True so all pre- and post-hooks run after the API response is sent."
...
Full source: [cookbook/05_agent_os/background_tasks/background_hooks_example.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/background_tasks/background_hooks_example.py)
