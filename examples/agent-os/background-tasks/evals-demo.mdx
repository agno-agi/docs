---
title: "Evals Demo"
description: "Register an AccuracyEval for a calculator agent backed by PostgresDb and browse eval runs through the AgentOS eval endpoints."
...
Full source: [cookbook/05_agent_os/background_tasks/evals_demo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/background_tasks/evals_demo.py)
