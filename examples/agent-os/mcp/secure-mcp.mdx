---
title: "Secure and scope an AgentOS MCP server"
description: "Protect ``/mcp`` with an OS security key plus a database-backed ``agno_pat_`` service account."
source: cookbook/05_agent_os/14_mcp/secure_mcp.py
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "agno[os]" fastmcp openai
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/14_mcp/secure_mcp.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/14_mcp/secure_mcp.py)
