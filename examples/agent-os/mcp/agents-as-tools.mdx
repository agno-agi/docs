---
title: "Serve agents as MCP tools"
description: "Turn the default MCP surface off and serve agents directly as tools."
source: cookbook/05_agent_os/14_mcp/agents_as_tools.py
---
...
Full source: [cookbook/05_agent_os/14_mcp/agents_as_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/14_mcp/agents_as_tools.py)
