---
title: "Expose one custom MCP tool"
description: "Replace the eight built-in AgentOS MCP tools with one purpose-built tool."
source: cookbook/05_agent_os/14_mcp/custom_tools.py
---
...
Full source: [cookbook/05_agent_os/14_mcp/custom_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/14_mcp/custom_tools.py)
