...
description: "AgentOS sales-analyst agent that queries Shopify orders, products and customers via ShopifyTools, with chat quick prompts for top sellers and revenue trends."
...
Full source: [cookbook/05_agent_os/integrations/shopify_demo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/integrations/shopify_demo.py)
