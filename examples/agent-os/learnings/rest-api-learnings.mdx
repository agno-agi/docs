...
Full source: [cookbook/05_agent_os/11_learnings/rest_api_learnings.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/11_learnings/rest_api_learnings.py)
