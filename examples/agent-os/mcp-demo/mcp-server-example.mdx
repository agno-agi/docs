...
description: "Enable an LLM-friendly MCP server at /mcp on an AgentOS serving a web research agent via mcp_server=True."
...
Full source: [cookbook/05_agent_os/mcp_demo/mcp_server_example.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/mcp_server_example.py)
