...
description: "Run AgentOS as the OAuth authorization server for /mcp, with access gated by a deployer connect secret."
...
Full source: [cookbook/05_agent_os/mcp_demo/oauth_builtin_example.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/oauth_builtin_example.py)
