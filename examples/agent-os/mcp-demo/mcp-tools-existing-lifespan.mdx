...
description: "Pass a custom FastAPI lifespan to AgentOS alongside agent MCPTools, whose lifespan AgentOS still manages."
...
Full source: [cookbook/05_agent_os/mcp_demo/mcp_tools_existing_lifespan.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/mcp_tools_existing_lifespan.py)
