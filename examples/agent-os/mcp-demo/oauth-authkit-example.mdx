...
description: "Delegate MCP OAuth to WorkOS AuthKit by passing its external AuthProvider as mcp_auth."
...
Full source: [cookbook/05_agent_os/mcp_demo/oauth_authkit_example.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/oauth_authkit_example.py)
