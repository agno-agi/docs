...
Full source: [cookbook/05_agent_os/mcp_demo/mcp_tools_advanced_example.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/mcp_tools_advanced_example.py)
