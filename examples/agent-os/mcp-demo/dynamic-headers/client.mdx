...
description: "Forward per-run user and session context from AgentOS to an MCP server with dynamic HTTP headers."
...
Full source: [cookbook/05_agent_os/mcp_demo/dynamic_headers/client.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/dynamic_headers/client.py)
