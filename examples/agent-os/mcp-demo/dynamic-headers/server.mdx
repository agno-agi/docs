...
Full source: [cookbook/05_agent_os/mcp_demo/dynamic_headers/server.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/dynamic_headers/server.py)
