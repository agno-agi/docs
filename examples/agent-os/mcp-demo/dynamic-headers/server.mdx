---
title: "Server"
description: "Log the user, tenant, and agent headers received by a local FastMCP greeting tool."
...
Full source: [cookbook/91_tools/mcp/dynamic_headers/server.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/mcp/dynamic_headers/server.py)
