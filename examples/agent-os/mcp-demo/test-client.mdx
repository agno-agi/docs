...
<Steps>
  ...
  <Step title="Start the AgentOS MCP server">
...
Full source: [cookbook/05_agent_os/mcp_demo/test_client.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/mcp_demo/test_client.py)
