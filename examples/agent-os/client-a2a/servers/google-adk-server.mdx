...
Full source: [cookbook/05_agent_os/client_a2a/servers/google_adk_server.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/client_a2a/servers/google_adk_server.py)
