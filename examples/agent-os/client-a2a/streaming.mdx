...
Full source: [cookbook/05_agent_os/client_a2a/02_streaming.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client_a2a/02_streaming.py)
