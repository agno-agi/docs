...
Full source: [cookbook/05_agent_os/client_a2a/05_connect_to_google_adk.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/client_a2a/05_connect_to_google_adk.py)
