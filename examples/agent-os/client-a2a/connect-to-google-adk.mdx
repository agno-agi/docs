...
description: "Cross-framework A2A communication: Agno client -> Google ADK server."
source: cookbook/05_agent_os/client_a2a/05_connect_to_google_adk.py
---

```python connect_to_google_adk.py
...
<Steps>
  ...
  <Step title="Start the Google ADK server">
...
Full source: [cookbook/05_agent_os/client_a2a/05_connect_to_google_adk.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client_a2a/05_connect_to_google_adk.py)
