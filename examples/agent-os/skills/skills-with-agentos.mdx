...
Full source: [cookbook/05_agent_os/skills/skills_with_agentos.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/skills/skills_with_agentos.py)
