...
| [Scheduler Tools Agent](/examples/agent-os/scheduler/scheduler-tools-agent) | Give an AgentOS agent SchedulerTools to create, list, update, and run recurring schedules from natural-language requests. |
