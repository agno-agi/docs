---
title: "Manage Schedules over REST"
description: "Use raw HTTP to create, list, read, update, enable, disable, trigger, page through run history, and delete a schedule served by 01_run_in_agentos.py."
source: cookbook/05_agent_os/12_scheduler/02_rest_api.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `rest_api.py`, then run:
    ```bash
    python rest_api.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/12_scheduler/02_rest_api.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/12_scheduler/02_rest_api.py)
