...
description: "Runs an AgentOS on port 7777 with cron scheduling and Postgres, then creates a 5-minute greeter schedule via POST /schedules."
...
Full source: [cookbook/05_agent_os/scheduler/basic_schedule.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/scheduler/basic_schedule.py)
