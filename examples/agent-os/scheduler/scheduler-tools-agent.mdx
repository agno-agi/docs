...
<Steps>
  ...
  <Step title="Start the chat process">
...
Full source: [cookbook/05_agent_os/12_scheduler/04_scheduler_tools_agent.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/12_scheduler/04_scheduler_tools_agent.py)
