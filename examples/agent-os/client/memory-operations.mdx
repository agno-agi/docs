...
description: "Full CRUD over a remote user's memories with AgentOSClient: create, list, get, update topics, read memory topics and per-user stats, then delete and verify."
...
Full source: [cookbook/05_agent_os/client/03_memory_operations.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/03_memory_operations.py)
