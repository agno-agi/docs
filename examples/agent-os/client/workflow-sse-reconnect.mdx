...
description: "Tests SSE stream reconnection for workflow runs using background=True, stream=True."
source: cookbook/05_agent_os/client/13_workflow_sse_reconnect.py
---
...
```python workflow_sse_reconnect.py
"""
...
Full source: [cookbook/05_agent_os/client/13_workflow_sse_reconnect.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/13_workflow_sse_reconnect.py)
