...
<Steps>
  ...
  <Step title="Run the example">
    ...
    ```bash
    python cookbook/05_agent_os/client/07_run_workflows.py
    ```
  </Step>
</Steps>

Full source: [cookbook/05_agent_os/client/07_run_workflows.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/07_run_workflows.py)
