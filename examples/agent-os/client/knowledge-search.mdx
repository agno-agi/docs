...
Full source: [cookbook/05_agent_os/client/05_knowledge_search.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/05_knowledge_search.py)
