...
<Steps>
  ...
  <Step title="Start the confirmation server">
...
Full source: [cookbook/05_agent_os/client/12_continue_run_sse_reconnect.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/12_continue_run_sse_reconnect.py)
