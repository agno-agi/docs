...
description: "Create, list, inspect, rename, and delete AgentOS sessions and read their runs with AgentOSClient."
...
Full source: [cookbook/05_agent_os/client/04_session_management.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/04_session_management.py)
