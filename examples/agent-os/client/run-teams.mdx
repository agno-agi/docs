...
<Steps>
  ...
  <Step title="Run the example">
    ...
    ```bash
    python cookbook/05_agent_os/client/06_run_teams.py
    ```
  </Step>
</Steps>

Full source: [cookbook/05_agent_os/client/06_run_teams.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/06_run_teams.py)
