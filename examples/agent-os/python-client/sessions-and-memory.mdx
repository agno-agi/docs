...
description: "Manage AgentOS sessions and user memories with the Python client."
source: cookbook/05_agent_os/03_python_client/03_sessions_and_memory.py
---

```python sessions_and_memory.py
...
<Steps>
  ...
  <Step title="Run the example">
    ...
    ```bash
    python cookbook/05_agent_os/03_python_client/03_sessions_and_memory.py
    ```
  </Step>
</Steps>

Full source: [cookbook/05_agent_os/03_python_client/03_sessions_and_memory.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/03_python_client/03_sessions_and_memory.py)
