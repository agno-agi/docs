---
title: "Connect to AgentOS and inspect its configuration"
description: "Both the synchronous ``get_config`` method and its asynchronous ``aget_config`` twin."
source: cookbook/05_agent_os/03_python_client/01_connect.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    ...
    ```bash
    python cookbook/05_agent_os/03_python_client/01_connect.py
    ```
  </Step>
</Steps>

Full source: [cookbook/05_agent_os/03_python_client/01_connect.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/03_python_client/01_connect.py)
