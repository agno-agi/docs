...
Full source: [cookbook/90_models/vertexai/claude/image_input_bytes.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/vertexai/claude/image_input_bytes.py)
