---
title: "Memory"
description: "Store personalized memories and session summaries with Claude on Vertex AI using PostgreSQL."
source: cookbook/90_models/vertexai/claude/memory.py
---

<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/92_models/anthropic/memory.py`. Follow the generated Run step below.
</Warning>
...
Full source: [cookbook/90_models/vertexai/claude/memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/vertexai/claude/memory.py)
