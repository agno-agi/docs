...
Full source: [cookbook/90_models/vertexai/claude/basic_with_timeout.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/vertexai/claude/basic_with_timeout.py)
