...
<Steps>
  ...
  <Step title="Fix the Claude import">
...
Full source: [cookbook/90_models/vertexai/claude/adaptive_thinking.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/vertexai/claude/adaptive_thinking.py)
