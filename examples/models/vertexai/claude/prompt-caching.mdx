...
description: "Cache the system prompt with Claude on Vertex AI to reduce processing time and costs."
...
Full source: [cookbook/90_models/vertexai/claude/prompt_caching.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/vertexai/claude/prompt_caching.py)
