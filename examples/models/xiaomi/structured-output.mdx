...
description: "Return a MovieScript Pydantic object from MiMo with `use_json_mode=True`, since MiMo supports JSON mode but not native json_schema structured outputs."
...
Full source: [cookbook/90_models/xiaomi/structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/xiaomi/structured_output.py)
