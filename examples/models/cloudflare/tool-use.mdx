...
description: "Give a Cloudflare AI Gateway agent web search with WebSearchTools and stream the tool-calling run."
...
Full source: [cookbook/90_models/cloudflare/tool_use.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/cloudflare/tool_use.py)
