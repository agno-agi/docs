...
description: "Switch Cloudflare AI Gateway models by passing a catalog binding to `Cloudflare(id=...)` or a `cloudflare:` model string."
...
Full source: [cookbook/90_models/cloudflare/switch_model.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/cloudflare/switch_model.py)
