...
description: "Run a Workers AI model through Cloudflare AI Gateway in sync, async, and streaming modes."
...
Full source: [cookbook/90_models/cloudflare/basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/cloudflare/basic.py)
