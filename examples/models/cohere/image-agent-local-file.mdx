...
Full source: [cookbook/90_models/cohere/image_agent_local_file.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/cohere/image_agent_local_file.py)
