...
description: "Configure an OpenRouter agent with an ordered fallback model list so a request failing on rate limits, timeouts, or overload retries on the next model."
...
Full source: [cookbook/90_models/openrouter/chat/dynamic_model_router.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openrouter/chat/dynamic_model_router.py)
