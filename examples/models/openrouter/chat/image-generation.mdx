...
description: "Generate an image with Gemini 2.5 Flash Image through OpenRouter and display the returned bytes."
...
Full source: [cookbook/90_models/openrouter/chat/image_generation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openrouter/chat/image_generation.py)
