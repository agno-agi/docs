...
Full source: [cookbook/90_models/mistral/structured_output_with_tool_use.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/mistral/structured_output_with_tool_use.py)
