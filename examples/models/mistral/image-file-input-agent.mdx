...
description: "Analyze sample.jpeg with Ministral 14B and search for related news."
...
Full source: [cookbook/90_models/mistral/image_file_input_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/mistral/image_file_input_agent.py)
