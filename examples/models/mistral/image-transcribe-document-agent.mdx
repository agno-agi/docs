...
description: "Transcribe a document image with a Ministral 14B agent."
...
Full source: [cookbook/90_models/mistral/image_transcribe_document_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/mistral/image_transcribe_document_agent.py)
