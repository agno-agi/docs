...
description: "Extract receipt data into a structured schema with Ministral 14B."
...
Full source: [cookbook/90_models/mistral/image_ocr_with_structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/mistral/image_ocr_with_structured_output.py)
