...
Full source: [cookbook/90_models/cometapi/image_agent_with_memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/cometapi/image_agent_with_memory.py)
