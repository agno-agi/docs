---
title: "Multi Model"
description: "Test and compare different models available through CometAPI."
...
Full source: [cookbook/90_models/cometapi/multi_model.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/cometapi/multi_model.py)
