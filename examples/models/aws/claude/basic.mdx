---
title: "Claude Basic"
description: "Run Claude on AWS Bedrock through the aws.Claude model class in sync, async, and streaming modes."
...
Full source: [cookbook/90_models/aws/claude/basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/aws/claude/basic.py)
