...
description: "Configure Claude 4.6 adaptive thinking with effort levels on AWS Bedrock."
...
Full source: [cookbook/90_models/aws/claude/adaptive_thinking.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/aws/claude/adaptive_thinking.py)
