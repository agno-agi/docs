...
Full source: [cookbook/90_models/aws/claude/append_trailing_user_message.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/aws/claude/append_trailing_user_message.py)
