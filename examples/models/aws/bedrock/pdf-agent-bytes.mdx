...
Full source: [cookbook/90_models/aws/bedrock/pdf_agent_bytes.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/aws/bedrock/pdf_agent_bytes.py)
