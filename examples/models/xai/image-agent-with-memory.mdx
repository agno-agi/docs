...
description: "Analyze an image with Grok 4.5 and retain history for follow-up questions."
...
Full source: [cookbook/90_models/xai/image_agent_with_memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/xai/image_agent_with_memory.py)
