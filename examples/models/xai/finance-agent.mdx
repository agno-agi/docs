---
title: "Finance Agent"
description: "Use YFinanceTools with Grok to report stock prices, analyst recommendations, company data, and news."
...
Full source: [cookbook/90_models/xai/finance_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/xai/finance_agent.py)
