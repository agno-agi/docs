...
description: "Combine ReasoningTools and YFinance on Grok 4.3 to write a stock report with visible reasoning."
...
Full source: [cookbook/90_models/xai/reasoning_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/xai/reasoning_agent.py)
