...
description: "Answer questions from a PDF stored in PgVector knowledge with OpenAIResponses."
source: cookbook/90_models/openai/responses/knowledge.py
---
...
Full source: [cookbook/90_models/openai/responses/knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/responses/knowledge.py)
