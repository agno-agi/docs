...
Full source: [cookbook/90_models/openai/responses/pdf_input_url.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/responses/pdf_input_url.py)
