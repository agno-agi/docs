...
Full source: [cookbook/90_models/openai/responses/zdr_reasoning_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/openai/responses/zdr_reasoning_agent.py)
