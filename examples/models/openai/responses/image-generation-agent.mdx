...
description: "Generate an image with the OpenAITools toolkit (gpt-image-1) and save the base64 result to disk."
source: cookbook/90_models/openai/responses/image_generation_agent.py
---

The agent uses `OpenAITools` with `gpt-image-1` to generate an image.
