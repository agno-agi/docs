...
Full source: [cookbook/90_models/openai/responses/structured_output_with_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/responses/structured_output_with_tools.py)
