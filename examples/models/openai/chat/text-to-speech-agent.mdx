...
description: "Generate speech with the OpenAITools speech toolkit and save the returned audio to tmp/speech_output.mp3."
...
Full source: [cookbook/90_models/openai/chat/text_to_speech_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/chat/text_to_speech_agent.py)
