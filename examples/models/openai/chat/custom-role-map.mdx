...
description: "Point OpenAIChat at Mistral's base_url and remap the `model` role to `assistant` via role_map."
...
Full source: [cookbook/90_models/openai/chat/custom_role_map.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/chat/custom_role_map.py)
