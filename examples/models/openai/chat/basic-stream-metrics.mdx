...
Full source: [cookbook/90_models/openai/chat/basic_stream_metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/chat/basic_stream_metrics.py)
