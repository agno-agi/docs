...
| [Retry](/examples/models/openai/chat/retry) | Set retries, delay_between_retries, and exponential_backoff on OpenAIChat using an invalid model ID to trigger them. |
...
| [OpenAI With Retries](/examples/models/openai/chat/with-retries) | Configure model retries with delays and exponential backoff against a failing model ID. |
