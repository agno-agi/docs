...
| [OpenAI Verbosity Control](/examples/models/openai/chat/verbosity-control) | Control response length with the gpt-5 verbosity parameter in a finance report agent. |
