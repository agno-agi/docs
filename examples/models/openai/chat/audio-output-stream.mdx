...
Full source: [cookbook/90_models/openai/chat/audio_output_stream.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/chat/audio_output_stream.py)
