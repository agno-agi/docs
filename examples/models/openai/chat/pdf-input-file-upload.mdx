...
Full source: [cookbook/90_models/openai/chat/pdf_input_file_upload.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/chat/pdf_input_file_upload.py)
