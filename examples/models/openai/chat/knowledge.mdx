...
description: "Load a PDF into PgVector-backed knowledge and answer questions from its contents."
source: cookbook/90_models/openai/chat/knowledge.py
---
...
Full source: [cookbook/90_models/openai/chat/knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/openai/chat/knowledge.py)
