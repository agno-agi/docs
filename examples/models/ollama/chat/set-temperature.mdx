...
Full source: [cookbook/90_models/ollama/chat/set_temperature.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/ollama/chat/set_temperature.py)
