---
title: "Ollama Cloud"
description: "Run gpt-oss:120b on Ollama Cloud with OLLAMA_API_KEY instead of a local Ollama server."
...
Full source: [cookbook/90_models/ollama/chat/ollama_cloud.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/ollama/chat/ollama_cloud.py)
