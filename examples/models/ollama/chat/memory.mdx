---
title: "Memory"
description: "Persist user memories and session summaries in Postgres with a local qwen2.5 Ollama agent."
source: cookbook/90_models/ollama/chat/memory.py
---

<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/92_models/ollama/memory.py`. Follow the generated Run step below.
</Warning>
...
Full source: [cookbook/90_models/ollama/chat/memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/ollama/chat/memory.py)
