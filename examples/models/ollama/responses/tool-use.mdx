...
Full source: [cookbook/90_models/ollama/responses/tool_use.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/ollama/responses/tool_use.py)
