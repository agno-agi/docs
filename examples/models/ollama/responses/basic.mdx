---
title: "Basic"
description: "Use Ollama's OpenAI-compatible /v1/responses endpoint with an Agent."
...
Full source: [cookbook/90_models/ollama/responses/basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/ollama/responses/basic.py)
