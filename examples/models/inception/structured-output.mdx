...
description: "Generate a MovieScript schema with Mercury 2 using JSON mode and native structured output."
source: cookbook/90_models/inception/structured_output.py
---
...
Full source: [cookbook/90_models/inception/structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/inception/structured_output.py)
