...
| Example | Description |
|---------|-------------|
| [Cerebras Basic](/examples/models/cerebras/basic) | Run Llama 3.3 70B on Cerebras across sync, async, and streaming modes. |
...
| [Cerebras Tool Use](/examples/models/cerebras/tool-use) | Give a Cerebras Llama 3.3 agent web search with WebSearchTools. |
