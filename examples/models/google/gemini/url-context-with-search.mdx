...
Full source: [cookbook/90_models/google/gemini/url_context_with_search.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/url_context_with_search.py)
