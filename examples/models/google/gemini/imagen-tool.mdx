---
title: "Imagen Tool"
description: "Generate an image with the GeminiTools Imagen toolkit driven by a GPT-4o agent and save the result as a PNG."
...
Full source: [cookbook/90_models/google/gemini/imagen_tool.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/imagen_tool.py)
