...
Full source: [cookbook/90_models/google/gemini/video_input_youtube.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/video_input_youtube.py)
