...
Full source: [cookbook/90_models/google/gemini/parallel_grounding.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/parallel_grounding.py)
