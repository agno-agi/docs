...
description: "Return an event plan as a Pydantic schema with enums, formats, and nested objects."
source: cookbook/90_models/google/gemini/structured_output.py
---
...
Full source: [cookbook/90_models/google/gemini/structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/structured_output.py)
