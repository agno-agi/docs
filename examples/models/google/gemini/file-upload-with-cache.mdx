...
description: "Upload a transcript with the Gemini Files API, cache it with a 5-minute TTL, and query the cached content to cut prompt tokens."
...
Full source: [cookbook/90_models/google/gemini/file_upload_with_cache.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/file_upload_with_cache.py)
