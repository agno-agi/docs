---
title: "External URL Input"
description: "Pass a public HTTPS PDF URL straight to Gemini 3.5 Flash with File(url=...), no download step."
...
Full source: [cookbook/90_models/google/gemini/external_url_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/external_url_input.py)
