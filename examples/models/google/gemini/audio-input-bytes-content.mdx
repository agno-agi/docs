...
Full source: [cookbook/90_models/google/gemini/audio_input_bytes_content.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/audio_input_bytes_content.py)
