...
Full source: [cookbook/90_models/google/gemini/agent_with_thinking_budget.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/agent_with_thinking_budget.py)
