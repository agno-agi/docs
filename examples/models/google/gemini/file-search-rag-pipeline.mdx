...
Full source: [cookbook/90_models/google/gemini/file_search_rag_pipeline.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/file_search_rag_pipeline.py)
