...
Full source: [cookbook/90_models/google/gemini/file_search_image_upload.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/file_search_image_upload.py)
