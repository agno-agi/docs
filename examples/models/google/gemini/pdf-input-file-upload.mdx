...
description: "Upload a PDF to the Gemini Files API, then ask an agent to summarize it and suggest a recipe from it."
...
Full source: [cookbook/90_models/google/gemini/pdf_input_file_upload.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/pdf_input_file_upload.py)
