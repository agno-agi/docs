...
Full source: [cookbook/90_models/google/gemini/file_search_basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/file_search_basic.py)
