...
description: "Generate an S3 pre-signed URL with boto3 and pass it straight to Gemini to summarize the PDF without downloading it."
...
Full source: [cookbook/90_models/google/gemini/s3_url_file_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini/s3_url_file_input.py)
