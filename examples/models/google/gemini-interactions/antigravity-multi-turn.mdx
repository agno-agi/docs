...
Full source: [cookbook/90_models/google/gemini_interactions/antigravity_multi_turn.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini_interactions/antigravity_multi_turn.py)
