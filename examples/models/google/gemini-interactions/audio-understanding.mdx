...
description: "Send an audio clip URL to a GeminiInteractions agent and have it describe what it hears."
...
Full source: [cookbook/90_models/google/gemini_interactions/audio_understanding.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/google/gemini_interactions/audio_understanding.py)
