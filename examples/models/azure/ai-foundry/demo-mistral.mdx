...
description: "Run Mistral Large through Azure AI Foundry with a single prompt."
source: cookbook/90_models/azure/ai_foundry/demo_mistral.py
---
...
Full source: [cookbook/90_models/azure/ai_foundry/demo_mistral.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/azure/ai_foundry/demo_mistral.py)
