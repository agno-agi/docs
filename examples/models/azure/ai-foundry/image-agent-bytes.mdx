...
description: "Migrate an Azure AI Foundry image-bytes agent from retired Llama 3.2 Vision to Llama 4 Scout."
...
Full source: [cookbook/90_models/azure/ai_foundry/image_agent_bytes.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/azure/ai_foundry/image_agent_bytes.py)
