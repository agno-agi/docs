...
description: "Load a recipe PDF into PgVector with AzureOpenAIEmbedder and query it from an agent."
source: cookbook/90_models/azure/openai/knowledge.py
---
...
Full source: [cookbook/90_models/azure/openai/knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/azure/openai/knowledge.py)
