...
description: "Return a MovieScript Pydantic object from a watsonx agent with output_schema."
source: cookbook/90_models/ibm/watsonx/structured_output.py
---
...
Full source: [cookbook/90_models/ibm/watsonx/structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/ibm/watsonx/structured_output.py)
