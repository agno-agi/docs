...
Full source: [cookbook/90_models/ibm/watsonx/structured_output.py](https://github.com/agno-agi/agno/blob/main/cookbook/90_models/ibm/watsonx/structured_output.py)
