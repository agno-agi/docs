...
description: "Append a trailing user turn so Claude 4.6+ models that reject assistant prefill work through LiteLLM."
...
Full source: [cookbook/90_models/litellm/append_trailing_user_message.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/litellm/append_trailing_user_message.py)
