...
Full source: [cookbook/90_models/litellm_openai/audio_input_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/litellm_openai/audio_input_agent.py)
