...
description: "Fetch stock prices with YFinance tools from a Llama 4 Maverick agent in sync and async modes."
source: cookbook/90_models/meta/llama/tool_use.py
---
...
Full source: [cookbook/90_models/meta/llama/tool_use.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/meta/llama/tool_use.py)
