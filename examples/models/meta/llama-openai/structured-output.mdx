---
title: "Llama OpenAI Structured Output"
description: "Return a MovieScript Pydantic model from Llama 4 Maverick through the OpenAI-compatible client."
source: cookbook/90_models/meta/llama_openai/structured_output.py
---
...
Full source: [cookbook/90_models/meta/llama_openai/structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/meta/llama_openai/structured_output.py)
