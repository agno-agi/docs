---
title: "Llama OpenAI Image Input Bytes"
description: "Send image bytes to Llama 4 Maverick and fetch related news with web search tools."
source: cookbook/90_models/meta/llama_openai/image_input_bytes.py
---
...
Full source: [cookbook/90_models/meta/llama_openai/image_input_bytes.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/meta/llama_openai/image_input_bytes.py)
