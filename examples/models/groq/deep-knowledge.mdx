...
description: "DeepKnowledge - An AI Agent that iteratively searches a knowledge base to answer questions."
source: cookbook/90_models/groq/deep_knowledge.py
---
...
Full source: [cookbook/90_models/groq/deep_knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/groq/deep_knowledge.py)
