---
title: "DB"
description: "Store Groq agent sessions in Postgres so follow-up questions keep context."
source: cookbook/90_models/groq/db.py
---
...
Full source: [cookbook/90_models/groq/db.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/groq/db.py)
