---
title: "Knowledge"
description: "Answer questions from a PDF knowledge base in PgVector with a Groq agent."
source: cookbook/90_models/groq/knowledge.py
---
...
Full source: [cookbook/90_models/groq/knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/groq/knowledge.py)
