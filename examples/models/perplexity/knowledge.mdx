---
title: "Knowledge"
description: "Answer questions from a PDF knowledge base in PgVector using a Perplexity sonar-pro agent."
source: cookbook/90_models/perplexity/knowledge.py
---
...
Full source: [cookbook/90_models/perplexity/knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/perplexity/knowledge.py)
