...
description: "Return a Pydantic MovieScript through Together with a model that supports structured outputs."
...
<Steps>
  ...
  <Step title="Use a structured-output model">
...
Full source: [cookbook/90_models/together/structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/together/structured_output.py)
