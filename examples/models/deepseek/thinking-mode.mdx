...
description: "Enable or disable DeepSeek V4 thinking mode and inspect reasoning_content."
...
Full source: [cookbook/90_models/deepseek/thinking_mode.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/deepseek/thinking_mode.py)
