...
description: "Use Claude's xlsx skill to create Excel spreadsheets through Agno agents."
...
Full source: [cookbook/90_models/anthropic/skills/agent_with_excel.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/skills/agent_with_excel.py)
