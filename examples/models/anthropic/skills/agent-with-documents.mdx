...
description: "Use Claude's docx skill to create Word documents through Agno agents."
...
Full source: [cookbook/90_models/anthropic/skills/agent_with_documents.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/skills/agent_with_documents.py)
