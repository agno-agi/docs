...
description: "Let Claude 4.6 decide its own thinking depth with thinking={\"type\": \"adaptive\"} and an effort level."
...
Full source: [cookbook/90_models/anthropic/adaptive_thinking.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/adaptive_thinking.py)
