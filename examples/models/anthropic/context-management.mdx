...
Full source: [cookbook/90_models/anthropic/context_management.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/context_management.py)
