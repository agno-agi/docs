...
description: "Send a PDF to Claude as raw bytes and read citations from the run output."
source: cookbook/90_models/anthropic/pdf_input_bytes.py
---
...
Full source: [cookbook/90_models/anthropic/pdf_input_bytes.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/pdf_input_bytes.py)
