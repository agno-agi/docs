...
description: "Combine a strict-mode Function schema with a Pydantic output_schema so Claude validates both the tool input and the final response."
...
Full source: [cookbook/90_models/anthropic/structured_output_strict_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/structured_output_strict_tools.py)
