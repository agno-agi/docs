---
title: "Betas"
description: "Enable the 1M-token context beta on Claude via the betas parameter and print every beta available in the installed anthropic SDK."
...
Full source: [cookbook/90_models/anthropic/betas.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/betas.py)
