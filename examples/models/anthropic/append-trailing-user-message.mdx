...
description: "Append a trailing user turn with append_trailing_user_message when a Claude 4.6 conversation ends on an assistant message."
...
Full source: [cookbook/90_models/anthropic/append_trailing_user_message.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/append_trailing_user_message.py)
