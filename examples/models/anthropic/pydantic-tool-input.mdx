...
description: "Pass nested, Optional, Union, List, and deeply nested Pydantic models as tool inputs to Claude."
...
Full source: [cookbook/90_models/anthropic/pydantic_tool_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/anthropic/pydantic_tool_input.py)
