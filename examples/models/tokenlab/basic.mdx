...
description: "Run synchronous, streaming, and asynchronous agent responses through TokenLab with GPT-5.4 Mini."
...
Full source: [cookbook/90_models/tokenlab/basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/90_models/tokenlab/basic.py)
