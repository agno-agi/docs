...
Full source: [cookbook/03_teams/14_run_control/background_execution_metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/14_run_control/background_execution_metrics.py)
