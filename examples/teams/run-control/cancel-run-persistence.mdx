...
Full source: [cookbook/03_teams/14_run_control/cancel_run_persistence.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/14_run_control/cancel_run_persistence.py)
