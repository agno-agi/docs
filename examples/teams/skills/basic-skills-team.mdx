...
Full source: [cookbook/02_agents/16_skills/basic_skills_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/16_skills/basic_skills_team.py)
