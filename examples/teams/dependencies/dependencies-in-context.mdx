...
source: cookbook/03_teams/17_dependencies/dependencies_in_context.py
---
...
Full source: [cookbook/03_teams/17_dependencies/dependencies_in_context.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/17_dependencies/dependencies_in_context.py)
