...
Full source: [cookbook/03_teams/04_structured_input_output/output_schema_override.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/04_structured_input_output/output_schema_override.py)
