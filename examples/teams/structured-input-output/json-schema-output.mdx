...
Full source: [cookbook/03_teams/04_structured_input_output/json_schema_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/04_structured_input_output/json_schema_output.py)
