...
Full source: [cookbook/03_teams/02_modes/route/02_specialist_router.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/02_modes/route/02_specialist_router.py)
