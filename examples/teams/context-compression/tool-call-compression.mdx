...
Full source: [cookbook/03_teams/10_context_compression/tool_call_compression.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/10_context_compression/tool_call_compression.py)
