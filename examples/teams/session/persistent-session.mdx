...
Full source: [cookbook/03_teams/07_session/persistent_session.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/07_session/persistent_session.py)
