...
Full source: [cookbook/03_teams/07_session/share_session_with_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/07_session/share_session_with_agent.py)
