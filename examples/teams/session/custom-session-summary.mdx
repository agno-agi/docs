...
Full source: [cookbook/03_teams/07_session/custom_session_summary.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/07_session/custom_session_summary.py)
