...
Full source: [cookbook/03_teams/18_guardrails/prompt_injection.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/18_guardrails/prompt_injection.py)
