...
Full source: [cookbook/03_teams/18_guardrails/openai_moderation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/18_guardrails/openai_moderation.py)
