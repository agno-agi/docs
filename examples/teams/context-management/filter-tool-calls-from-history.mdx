...
Full source: [cookbook/03_teams/09_context_management/filter_tool_calls_from_history.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/09_context_management/filter_tool_calls_from_history.py)
