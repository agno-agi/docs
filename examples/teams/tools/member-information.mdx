...
Full source: [cookbook/03_teams/03_tools/member_information.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/03_tools/member_information.py)
