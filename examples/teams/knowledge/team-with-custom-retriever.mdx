...
Full source: [cookbook/03_teams/05_knowledge/04_team_with_custom_retriever.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/05_knowledge/04_team_with_custom_retriever.py)
