...
Full source: [cookbook/03_teams/02_modes/tasks/05_parallel_tasks.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/02_modes/tasks/05_parallel_tasks.py)
