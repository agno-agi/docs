...
Full source: [cookbook/03_teams/11_reasoning/reasoning_multi_purpose_team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/11_reasoning/reasoning_multi_purpose_team.py)
