...
Full source: [cookbook/03_teams/16_search_coordination/03_distributed_infinity_search.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/16_search_coordination/03_distributed_infinity_search.py)
