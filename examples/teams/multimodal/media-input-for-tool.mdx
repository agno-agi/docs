...
Full source: [cookbook/03_teams/19_multimodal/media_input_for_tool.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/19_multimodal/media_input_for_tool.py)
