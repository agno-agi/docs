...
Full source: [cookbook/03_teams/22_metrics/01_team_metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/22_metrics/01_team_metrics.py)
