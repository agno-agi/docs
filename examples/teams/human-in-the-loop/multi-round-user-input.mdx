---
title: "Multi-Round User Input"
description: "Demonstrates chained HITL where a member pauses multiple times for user input."
source: cookbook/03_teams/20_human_in_the_loop/multi_round_user_input.py
---
...
Full source: [cookbook/03_teams/20_human_in_the_loop/multi_round_user_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/20_human_in_the_loop/multi_round_user_input.py)
