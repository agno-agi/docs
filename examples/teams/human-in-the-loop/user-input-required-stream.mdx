...
Full source: [cookbook/03_teams/20_human_in_the_loop/user_input_required_stream.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/20_human_in_the_loop/user_input_required_stream.py)
