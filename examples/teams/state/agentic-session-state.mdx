...
Full source: [cookbook/03_teams/21_state/agentic_session_state.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/21_state/agentic_session_state.py)
