...
description: "Broadcast the same research task to every member with TeamMode.broadcast, fanning it out to Reddit and HackerNews researchers."
...
Full source: [cookbook/03_teams/01_quickstart/03_delegate_to_all_members.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/01_quickstart/03_delegate_to_all_members.py)
