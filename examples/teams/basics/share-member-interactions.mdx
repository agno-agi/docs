...
description: "Give support team members each other's requests and responses from the current run with share_member_interactions=True."
...
Full source: [cookbook/03_teams/01_quickstart/07_share_member_interactions.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/01_quickstart/07_share_member_interactions.py)
