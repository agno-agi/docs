...
description: "Give each member its own conversation history with add_history_to_context while the leader routes questions by language."
source: cookbook/03_teams/01_quickstart/06_history_of_members.py
---
...
Full source: [cookbook/03_teams/01_quickstart/06_history_of_members.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/01_quickstart/06_history_of_members.py)
