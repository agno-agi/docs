...
Full source: [cookbook/03_teams/01_quickstart/nested_teams.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/01_quickstart/nested_teams.py)
