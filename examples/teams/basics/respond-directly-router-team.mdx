...
description: "Route each question to the member agent that speaks its language with TeamMode.route and return that member's answer directly."
...
Full source: [cookbook/03_teams/01_quickstart/02_respond_directly_router_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/01_quickstart/02_respond_directly_router_team.py)
