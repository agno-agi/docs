...
description: "Delegate the same task to every team member with TeamMode.broadcast."
...
Full source: [cookbook/03_teams/01_quickstart/broadcast_mode.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/01_quickstart/broadcast_mode.py)
