...
source: cookbook/03_teams/15_distributed_rag/01_distributed_rag_pgvector.py
---
...
Full source: [cookbook/03_teams/15_distributed_rag/01_distributed_rag_pgvector.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/15_distributed_rag/01_distributed_rag_pgvector.py)
