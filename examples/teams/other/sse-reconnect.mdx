...
curated_source: cookbook/05_agent_os/client/11_team_sse_reconnect.py
---
...
Full source: [cookbook/05_agent_os/client/11_team_sse_reconnect.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/client/11_team_sse_reconnect.py)
