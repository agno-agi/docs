...
Full source: [cookbook/03_teams/12_learning/01_team_always_learn.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/12_learning/01_team_always_learn.py)
