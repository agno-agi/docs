...
<Warning>
  This example imports `LearningMode` from a module that does not exist in Agno v2.7.4. Update the import before running.
</Warning>
...
<Steps>
  ...
  <Step title="Fix the LearningMode import">
...
Full source: [cookbook/03_teams/12_learning/10_team_agentic_learning.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/03_teams/12_learning/10_team_agentic_learning.py)
