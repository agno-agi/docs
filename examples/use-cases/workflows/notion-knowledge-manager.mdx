...
description: A workflow that manages knowledge in Notion database.
---

## Overview

This workflow uses `NotionTools` to create, update and search for Notion pages with specific tags in a database.
...
The following example demonstrates how to use `NotionTools` to create, update and search for Notion pages with specific tags in a database.
