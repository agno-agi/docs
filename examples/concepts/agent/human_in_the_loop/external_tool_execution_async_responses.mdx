---
title: External Tool Execution Async Responses
sidebarTitle: External Async Responses API
keywords: [external execution, async, OpenAI Responses, gpt-4.1-mini, tool-call id]
description: This example demonstrates external tool execution using OpenAI Responses API with gpt-4.1-mini model. It shows how to handle tool-call IDs and execute multiple external tools in a loop until completion.
mode: wide
---
