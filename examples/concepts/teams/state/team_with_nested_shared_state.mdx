---
title: "Team with Nested Shared State"
sidebarTitle: "Nested Shared State"
mode: wide
---
...
<Steps>
    ...
    <Step title="Create a Python file">
        Create a file `team_with_nested_shared_state.py`
    </Step>

    <Step title="Add code to file">
        ```python team_with_nested_shared_state.py
"""
