...
- [Basic Conversational Workflow (sync non-streaming)](https://github.com/agno-agi/agno/blob/main/cookbook/workflows/_06_advanced_concepts/_08_workflow_agent/sync/basic_workflow_agent.py)
- [Basic Conversational Workflow (async non-streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/_06_advanced_concepts/_08_workflow_agent/async/basic_workflow_agent.py)
- [Basic Conversational Workflow (async streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/_06_advanced_concepts/_08_workflow_agent/async/basic_workflow_agent_stream.py)