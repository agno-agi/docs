---
title: Access Session State in Condition Evaluator Function
description: This example demonstrates how to access session state in the evaluator function of a condition step
---
