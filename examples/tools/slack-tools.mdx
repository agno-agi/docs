---
title: "Slack Tools"
description: "Environment variables: SLACK_TOKEN         Bot token (xoxb-) for standard Slack APIs SLACK_USER_TOKEN    User token (xoxp-) required for search_messages."
...
Full source: [cookbook/91_tools/slack_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/slack_tools.py)
