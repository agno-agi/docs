---
title: "WebSearch Tools"
description: "Search the web and news with WebSearchTools across DuckDuckGo, Google, Bing, and Brave backends."
source: cookbook/91_tools/websearch_tools.py
---
...
Full source: [cookbook/91_tools/websearch_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/websearch_tools.py)
