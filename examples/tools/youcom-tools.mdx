---
title: "You.com Tools"
description: "Search the web with YouTools, including a domain-allowlisted agent limited to cnbc.com, reuters.com and bloomberg.com."
...
Full source: [cookbook/91_tools/youcom_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/youcom_tools.py)
