...
description: "Verify per-tool instructions from a bare @tool function and a Toolkit both reach agent._tool_instructions via parse_tools."
...
Full source: [cookbook/91_tools/tool_decorator/toolkit_per_tool_instructions.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_decorator/toolkit_per_tool_instructions.py)
