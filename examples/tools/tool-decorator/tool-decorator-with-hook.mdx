...
description: "Attach a custom duration-logging hook to a tool via @tool(tool_hooks=[...]) to time each tool call."
...
Full source: [cookbook/91_tools/tool_decorator/tool_decorator_with_hook.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_decorator/tool_decorator_with_hook.py)
