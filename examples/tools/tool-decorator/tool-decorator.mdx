...
description: "Decorate generator functions and class static methods with @tool, including show_result and async variants."
...
Full source: [cookbook/91_tools/tool_decorator/tool_decorator.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_decorator/tool_decorator.py)
