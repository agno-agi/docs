...
Full source: [cookbook/91_tools/tool_decorator/async_tool_decorator.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_decorator/async_tool_decorator.py)
