...
Full source: [cookbook/91_tools/tool_decorator/tool_decorator_on_class_method.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_decorator/tool_decorator_on_class_method.py)
