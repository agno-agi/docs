...
description: "Extract structured data, markdown, and raw HTML from a page using ScrapeGraphTools smartscraper, markdownify, and scrape."
...
Full source: [cookbook/91_tools/scrapegraph_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/scrapegraph_tools.py)
