---
title: "Daytona"
description: "Run agent-generated Python, JavaScript, and TypeScript in a remote Daytona sandbox with file and shell operations."
---
...
For details, see [Daytona cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/daytona_tools.py).
