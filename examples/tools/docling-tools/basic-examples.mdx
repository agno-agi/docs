...
Full source: [cookbook/91_tools/docling_tools/basic_examples.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/docling_tools/basic_examples.py)
