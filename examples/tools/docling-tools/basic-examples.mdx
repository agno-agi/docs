...
Full source: [cookbook/91_tools/docling_tools/basic_examples.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/docling_tools/basic_examples.py)
