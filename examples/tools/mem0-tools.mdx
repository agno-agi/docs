---
title: "Mem0"
description: "Add, search, list, and delete user memories across sessions with Mem0Tools using all-functions and restricted configurations."
---
...
```
For details, see [Mem0 tools cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mem0_tools.py).
