...
description: "Search the web with PerplexitySearch, including a variant filtered by recency window and allowed domains."
...
Full source: [cookbook/91_tools/perplexity_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/perplexity_tools.py)
