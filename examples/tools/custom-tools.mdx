...
description: 18 examples covering the @tool decorator, async tools, caching, and more.
---
...
## All 18 Custom Tool Examples

| Example | Description |
|---------|-------------|
| `tool_decorator.py` | Basic tool decorator usage |
| `tool_decorator_async.py` | Async tool functions |
| `async_tool_decorator.py` | Alternative async pattern |
| `tool_decorator_with_instructions.py` | Tools with custom instructions |
| `tool_decorator_with_hook.py` | Tools with pre/post hooks |
| `tool_decorator_on_class_method.py` | Class methods as tools |
| `cache_tool_calls.py` | Caching tool results |
| `stop_after_tool_call.py` | Stop execution after tool call |
