...
description: "Sync-generator, async-generator, and async-coroutine toolkit tools that each receive a Pydantic SearchParams model and stream custom progress events."
...
<Steps>
  ...
  <Step title="Enable custom events">
...
Full source: [cookbook/91_tools/async_generator_tool_with_pydantic_args.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/async_generator_tool_with_pydantic_args.py)
