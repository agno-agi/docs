...
description: "Configure ArxivTools with enable_search_arxiv / enable_read_arxiv_papers and all=True to control which ArXiv functions an agent can call."
...
Full source: [cookbook/91_tools/arxiv_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/arxiv_tools.py)
