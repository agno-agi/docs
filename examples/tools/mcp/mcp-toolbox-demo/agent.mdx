---
title: "Agent"
description: "Load MCPToolbox hotel-management and booking-system toolsets, or load them manually with auth token getters and bound params, then drive an interactive CLI hotel agent."
