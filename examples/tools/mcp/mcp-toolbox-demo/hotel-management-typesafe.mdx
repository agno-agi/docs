...
Full source: [cookbook/91_tools/mcp/mcp_toolbox_demo/hotel_management_typesafe.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/mcp/mcp_toolbox_demo/hotel_management_typesafe.py)
