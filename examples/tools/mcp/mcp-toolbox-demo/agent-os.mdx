...
Full source: [cookbook/91_tools/mcp/mcp_toolbox_demo/agent_os.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/mcp_toolbox_demo/agent_os.py)
