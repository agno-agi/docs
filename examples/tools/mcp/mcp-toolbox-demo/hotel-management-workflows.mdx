...
Full source: [cookbook/91_tools/mcp/mcp_toolbox_demo/hotel_management_workflows.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/mcp_toolbox_demo/hotel_management_workflows.py)
