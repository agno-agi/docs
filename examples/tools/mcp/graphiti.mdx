---
title: "MCP Graphiti Agent - A personal diary assistant"
description: "Use Agno's MCP integration together with Graphiti, to build a personal diary assistant."
source: cookbook/91_tools/mcp/graphiti.py
---
...
Full source: [cookbook/91_tools/mcp/graphiti.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/graphiti.py)
