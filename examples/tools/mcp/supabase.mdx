...
description: "Use the Supabase MCP server to create projects, database schemas, and edge functions."
source: cookbook/91_tools/mcp/supabase.py
---
...
Full source: [cookbook/91_tools/mcp/supabase.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/supabase.py)
