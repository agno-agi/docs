...
Show how to connect to MCP servers that use the SSE transport using our MCPTools and MultiMCPTools classes. Check the README.md file for instructions on how to run these examples.
...
Full source: [cookbook/91_tools/mcp/sse_transport/client.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/mcp/sse_transport/client.py)
