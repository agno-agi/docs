---
title: "‍ Mem0 MCP - Personalized Code Reviewer"
description: "Use Agno's MCP integration together with Mem0, to build a personalized code reviewer."
source: cookbook/91_tools/mcp/mem0.py
---

<Warning>
  The v2.7.4 source targets the archived local Mem0 MCP SSE server. Mem0's maintained service is an authenticated Streamable HTTP endpoint. Update the connection before running. See [Mem0 MCP](https://docs.mem0.ai/platform/mem0-mcp).
</Warning>
...
<Steps>
  ...
  <Step title="Use the maintained Mem0 MCP endpoint">
...
Full source: [cookbook/91_tools/mcp/mem0.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/mem0.py)
