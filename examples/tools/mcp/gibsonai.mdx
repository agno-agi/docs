...
description: "Connect a local GibsonAI MCP server to an Agno agent."
source: cookbook/91_tools/mcp/gibsonai.py
---
...
<Steps>
  ...
  <Step title="Authenticate GibsonAI">
...
Full source: [cookbook/91_tools/mcp/gibsonai.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/gibsonai.py)
