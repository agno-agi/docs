---
title: "MCP Filesystem Agent - Your Personal File Explorer!"
description: "Create a filesystem agent that uses MCP to explore, analyze, and provide insights about files and directories."
source: cookbook/91_tools/mcp/filesystem.py
---
...
Full source: [cookbook/91_tools/mcp/filesystem.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/filesystem.py)
