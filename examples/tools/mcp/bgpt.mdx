...
description: "Query the hosted BGPT MCP server over Streamable HTTP to search papers and surface methods, sample sizes, limitations, and conflicts of interest."
...
<Steps>
  ...
  <Step title="Configure optional BGPT access">
...
Full source: [cookbook/91_tools/mcp/bgpt.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/bgpt.py)
