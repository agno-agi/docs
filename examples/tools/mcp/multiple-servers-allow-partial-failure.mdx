...
Full source: [cookbook/91_tools/mcp/multiple_servers_allow_partial_failure.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/multiple_servers_allow_partial_failure.py)
