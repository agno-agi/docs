...
Full source: [cookbook/91_tools/mcp/streamable_http_transport/client.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/streamable_http_transport/client.py)
