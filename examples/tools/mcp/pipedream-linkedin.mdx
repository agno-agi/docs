...
The pinned source uses a retired Pipedream per-app SSE URL and cannot connect to the current service without code and authentication changes. See [Pipedream MCP](https://pipedream.com/docs/connect/mcp) for the current connection flows.
...
Full source: [cookbook/91_tools/mcp/pipedream_linkedin.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/mcp/pipedream_linkedin.py)
