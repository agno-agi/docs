...
description: "Search Airbnb listings with an OpenAI gpt-4o agent connected to the @openbnb/mcp-server-airbnb stdio MCP server."
...
Full source: [cookbook/91_tools/mcp/airbnb.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/airbnb.py)
