...
Full source: [cookbook/91_tools/mcp/dynamic_headers/server.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/dynamic_headers/server.py)
