---
title: "Structured Content Agent"
description: "Some MCP servers declare an output schema and return their answer as `structuredContent`."
source: cookbook/91_tools/mcp/structured_content.py
---
...
Full source: [cookbook/91_tools/mcp/structured_content.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/structured_content.py)
