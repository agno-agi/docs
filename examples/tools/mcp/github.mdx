---
title: "MCP GitHub Agent - Your Personal GitHub Explorer!"
description: "Create a GitHub agent that uses MCP to explore, analyze, and provide insights about GitHub repositories."
source: cookbook/91_tools/mcp/github.py
---
...
Full source: [cookbook/91_tools/mcp/github.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/github.py)
