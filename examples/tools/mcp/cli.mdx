...
<Warning>
  The pinned v2.7.2 source starts an older npm GitHub MCP server. This page intentionally substitutes [GitHub's official MCP server](https://github.com/github/github-mcp-server) Docker image and adds the matching Docker setup.
</Warning>
