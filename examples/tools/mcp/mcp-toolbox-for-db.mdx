...
description: "Connect an agent to an MCP Toolbox for Databases server and load hotel-management and booking-system toolsets via MCPToolbox."
...
Full source: [cookbook/91_tools/mcp/mcp_toolbox_for_db.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/mcp/mcp_toolbox_for_db.py)
