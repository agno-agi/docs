---
title: "X"
description: "Read your X profile and home timeline, and post or reply, with XTools."
---
...
```
For details, see [X tools cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/x_tools.py).
