...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno firecrawl firecrawl-py openai
    ```
  </Step>
...
Full source: [cookbook/91_tools/firecrawl_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/firecrawl_tools.py)
