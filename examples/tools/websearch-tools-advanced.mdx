...
description: "Configure WebSearchTools time limits, regions, and DDGS backends for text and news search."
...
<Steps>
  ...
  <Step title="Keep text-search settings on the text tool">
  ...
  <Step title="Run every regional comparison">
...
Full source: [cookbook/91_tools/websearch_tools_advanced.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/websearch_tools_advanced.py)
