...
description: "Tune WebSearchTools with timelimit, region, and backend (duckduckgo, google, bing, brave, yandex, yahoo) options, plus news-only and multi-region agent setups."
