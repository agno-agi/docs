...
description: "Build general, tech, and finance search agents with ParallelTools using include_domains filters and result-count limits."
...
Full source: [cookbook/91_tools/parallel/news_search.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/parallel/news_search.py)
