...
description: "Compare the Parallel Task API's auto, JSON, string, and text output schemas on one research query."
...
Full source: [cookbook/91_tools/parallel/output_schemas.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/parallel/output_schemas.py)
