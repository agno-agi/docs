...
description: "Configure ParallelTools Task API with text and JSON output schemas to produce cited market reports and structured industry data."
...
Full source: [cookbook/91_tools/parallel/market_research.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/parallel/market_research.py)
