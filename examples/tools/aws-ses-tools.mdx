---
title: "AWS SES"
description: "Research AI news with web search and email the summary from a verified SES sender address using AWSSESTool."
---
...
```
For details, see [AWS SES cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/aws_ses_tools.py).
