...
description: "Generate bar, line, pie, scatter, and histogram charts with VisualizationTools and matplotlib, scoped per agent via enable_ flags and output_dir."
---
...
```
For details, see [Visualization tools cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/visualization_tools.py).
