...
description: "Generate JSON, CSV, PDF, TXT, DOCX and HTML files from agent responses with FileGenerationTools, persisting them to an output directory."
...
Full source: [cookbook/91_tools/file_generation_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/file_generation_tools.py)
