...
description: "Read an llms.txt index with LLMsTxtTools, then fetch only the documentation pages the agent decides are relevant."
source: cookbook/91_tools/llms_txt_tools.py
---

The llms.txt format (https://llmstxt.org) is a standardized way for websites to provide LLM-friendly documentation indexes.
...
Full source: [cookbook/91_tools/llms_txt_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/llms_txt_tools.py)
