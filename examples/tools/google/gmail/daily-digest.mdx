...
description: "Summarize recent emails into a structured daily digest grouped by category and tagged with priority."
...
Full source: [cookbook/91_tools/google/gmail/daily_digest.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/google/gmail/daily_digest.py)
