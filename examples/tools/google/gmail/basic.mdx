---
title: "Basic"
description: "Configure Gmail agents with include_tools/exclude_tools for read-only, send-blocked, label-management, and full-access variants."
...
Full source: [cookbook/91_tools/google/gmail/basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/google/gmail/basic.py)
