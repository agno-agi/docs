...
<Steps>
  ...
  <Step title="Configure the optional output sheet">
...
Full source: [cookbook/91_tools/google/sheets/action_tracker.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/google/sheets/action_tracker.py)
