...
description: "Browses Drive folders with list_files and uploads or downloads local files with write tools enabled."
...
Full source: [cookbook/91_tools/google/drive/folder_organizer.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/google/drive/folder_organizer.py)
