...
Full source: [cookbook/91_tools/google/slides/presentation_builder.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/google/slides/presentation_builder.py)
