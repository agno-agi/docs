...
Full source: [cookbook/91_tools/google/calendar/meeting_scheduler.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/google/calendar/meeting_scheduler.py)
