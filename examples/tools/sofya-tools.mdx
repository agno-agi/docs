---
title: "Sofya Tools"
description: "Toggle SofyaTools between web search, markdown URL extraction, and cited deep-research report generation."
...
Full source: [cookbook/91_tools/sofya_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/sofya_tools.py)
