...
description: "Bulk-load every page linked from an llms.txt index into a PgVector knowledge base, then answer questions with semantic search."
...
Full source: [cookbook/91_tools/llms_txt_tools_knowledge.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/llms_txt_tools_knowledge.py)
