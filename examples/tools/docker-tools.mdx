---
title: "Docker Tools"
description: "Configure DockerTools with include_tools and exclude_tools for container-management, delete-free, and full-access agents."
...
Full source: [cookbook/91_tools/docker_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/docker_tools.py)
