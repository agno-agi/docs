...
- Install dependencies: `uv pip install -U agno anthropic`.
- Export your Spotify access token: `export SPOTIFY_TOKEN=your_spotify_token`.
- Export your Anthropic API key: `export ANTHROPIC_API_KEY=your_anthropic_api_key`.
