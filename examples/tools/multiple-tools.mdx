...
description: "Combine WebSearchTools and YFinanceTools in one agent to produce a streamed NVDA report from news and financials."
---
...
```
For details, see [Multiple tool cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/multiple_tools.py).
