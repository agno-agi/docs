...
description: "Configure DuckDuckGoTools with timelimit, region, backend, fixed_max_results, and timeout to build week-scoped, region-localized, and news-only search agents."
...
Full source: [cookbook/91_tools/duckduckgo_tools_advanced.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/duckduckgo_tools_advanced.py)
