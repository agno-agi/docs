...
description: "YFinance Tools - Stock Market Analysis and Financial Data."
source: cookbook/91_tools/yfinance_tools.py
---
...
Full source: [cookbook/91_tools/yfinance_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/yfinance_tools.py)
