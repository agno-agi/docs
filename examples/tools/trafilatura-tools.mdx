---
title: "TrafilaturaTools Cookbook"
description: "Extract clean page text with TrafilaturaTools across txt, markdown, JSON and XML output, precision/recall tuning, metadata-only mode, crawling and HTML-to-text."
source: cookbook/91_tools/trafilatura_tools.py
---

Various ways to use TrafilaturaTools for web scraping and text extraction. TrafilaturaTools provides powerful capabilities for extracting clean, readable text from web pages and converting raw HTML into structured, meaningful data.
...
Full source: [cookbook/91_tools/trafilatura_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/trafilatura_tools.py)
