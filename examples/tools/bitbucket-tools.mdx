---
title: "Bitbucket"
description: "List open pull requests, repositories and commits for a Bitbucket workspace and repo slug with BitbucketTools."
---
...
```
For details, see [Bitbucket cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/bitbucket_tools.py).