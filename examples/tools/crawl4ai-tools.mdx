...
description: "Compare three Crawl4aiTools agents: default crawling with pruning, an explicit enable_crawl agent, and a raw full-page agent without pruning."
source: cookbook/91_tools/crawl4ai_tools.py
---

Use Crawl4aiTools for web crawling and content extraction. Crawl4aiTools has a single enable_ flag: enable_crawl.
