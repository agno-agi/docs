...
description: "Define three Crawl4aiTools configurations and execute the two pruning configurations."
...
Full source: [cookbook/91_tools/crawl4ai_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/crawl4ai_tools.py)
