...
description: "Swap a customer ID for the full profile stored in session_state by rewriting tool arguments inside a tool_hook."
...
Full source: [cookbook/91_tools/tool_hooks/tool_hook_in_toolkit_with_state.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_hooks/tool_hook_in_toolkit_with_state.py)
