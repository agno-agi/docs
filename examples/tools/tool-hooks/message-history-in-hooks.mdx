...
Full source: [cookbook/91_tools/tool_hooks/message_history_in_hooks.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_hooks/message_history_in_hooks.py)
