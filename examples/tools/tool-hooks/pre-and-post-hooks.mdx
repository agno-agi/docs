...
Full source: [cookbook/91_tools/tool_hooks/pre_and_post_hooks.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_hooks/pre_and_post_hooks.py)
