...
description: "Nest validation and logging hooks around toolkit tools to block customer ID 123 and strip the name field from results, in sync and async variants."
...
Full source: [cookbook/91_tools/tool_hooks/tool_hooks_in_toolkit_nested.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_hooks/tool_hooks_in_toolkit_nested.py)
