...
description: "Block deletion and retrieval of customer ID 123 with a validation tool_hook wrapped around a custom Toolkit."
...
Full source: [cookbook/91_tools/tool_hooks/tool_hook_in_toolkit.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_hooks/tool_hook_in_toolkit.py)
