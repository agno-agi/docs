...
description: "Chain two nested tool hooks so the first swaps a customer ID for the profile stored in session_state before the toolkit function runs."
...
Full source: [cookbook/91_tools/tool_hooks/tool_hook_in_toolkit_with_state_nested.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/tool_hooks/tool_hook_in_toolkit_with_state_nested.py)
