...
description: "Step 1: Log In to ClickUp Step 2: Navigate to Settings (usually a circle with your initials) click on it Step 3: Access the Apps Section: In the settings sidebar on the left, scroll down until you find Apps."
source: cookbook/91_tools/clickup_tools.py
---
...
Full source: [cookbook/91_tools/clickup_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/clickup_tools.py)
