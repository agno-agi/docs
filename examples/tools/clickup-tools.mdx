---
title: "ClickUp Tools"
description: "List ClickUp spaces and manage tasks with ClickUpTools using CLICKUP_API_KEY and MASTER_SPACE_ID."
...
Full source: [cookbook/91_tools/clickup_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/clickup_tools.py)
