---
title: "E2B Tools"
description: "Run Python, manage files, and expose sandbox servers with E2BTools."
source: cookbook/91_tools/e2b_tools.py
---
...
Full source: [cookbook/91_tools/e2b_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/e2b_tools.py)
