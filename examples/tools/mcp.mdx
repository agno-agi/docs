...
sidebarTitle: MCP
description: 40 examples covering Model Context Protocol servers, transports, and integrations.
---
...
```python cookbook/90_tools/mcp/brave.py
import asyncio
from agno.agent import Agent
from agno.tools.mcp import MCPTools
...
```python cookbook/90_tools/mcp/supabase.py
import asyncio
from agno.agent import Agent
from agno.tools.mcp import MCPTools
...
```python cookbook/90_tools/mcp/qdrant.py
import asyncio
from agno.agent import Agent
from agno.tools.mcp import MCPTools
...
```python cookbook/90_tools/mcp/multiple_servers.py
import asyncio
from agno.agent import Agent
from agno.tools.mcp import MCPTools
...
```python cookbook/90_tools/mcp/include_tools.py
import asyncio
from agno.agent import Agent
from agno.tools.mcp import MCPTools
...
```python cookbook/90_tools/mcp/local_server/server.py
...
```python cookbook/90_tools/mcp/local_server/client.py
import asyncio
from agno.agent import Agent
from agno.tools.mcp import MCPTools
...
```python cookbook/90_tools/mcp/pipedream_slack.py
import asyncio
from agno.agent import Agent
from agno.tools.mcp import MCPTools
...
| Search | `brave.py`, `stagehand.py` |
| Databases | `supabase.py`, `qdrant.py` |
| Multiple Servers | `multiple_servers.py`, `multiple_servers_allow_partial_failure.py` |
| Tool Filtering | `include_tools.py`, `include_exclude_tools.py` |
| Custom Servers | `local_server/`, `dynamic_headers/` |
| Transports | `sse_transport/` |
| Pipedream | `pipedream_slack.py`, `pipedream_google_calendar.py`, `pipedream_linkedin.py` |
