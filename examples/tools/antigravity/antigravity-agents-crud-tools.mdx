...
Full source: [cookbook/91_tools/antigravity/antigravity_agents_crud_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/antigravity/antigravity_agents_crud_tools.py)
