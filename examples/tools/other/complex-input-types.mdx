...
description: "Pass nested Pydantic models and enums as tool arguments so the agent fills validated UserProfile and Task schemas."
source: cookbook/91_tools/other/complex_input_types.py
---
...
Full source: [cookbook/91_tools/other/complex_input_types.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/other/complex_input_types.py)
