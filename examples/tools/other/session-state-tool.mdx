...
description: "Read and write run_context.session_state inside a @tool to cache the last FAQ answer across runs, persisted with SqliteDb."
...
Full source: [cookbook/91_tools/other/session_state_tool.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/other/session_state_tool.py)
