...
Full source: [cookbook/91_tools/other/stop_after_tool_call.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/other/stop_after_tool_call.py)
