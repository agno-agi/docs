...
description: "Register Toolkit methods with stop_after_tool_call_tools so one tool halts the agent run while the others continue."
source: cookbook/91_tools/other/stop_after_tool_call_in_toolkit.py
---
...
Full source: [cookbook/91_tools/other/stop_after_tool_call_in_toolkit.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/other/stop_after_tool_call_in_toolkit.py)
