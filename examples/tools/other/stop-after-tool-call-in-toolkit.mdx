...
Full source: [cookbook/91_tools/other/stop_after_tool_call_in_toolkit.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/other/stop_after_tool_call_in_toolkit.py)
