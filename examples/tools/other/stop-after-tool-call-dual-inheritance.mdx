...
description: "Confirm stop_after_tool_call_tools flags still apply when a Toolkit subclass also inherits from a non-Toolkit base class."
source: cookbook/91_tools/other/stop_after_tool_call_dual_inheritance.py
---
...
Full source: [cookbook/91_tools/other/stop_after_tool_call_dual_inheritance.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/other/stop_after_tool_call_dual_inheritance.py)
