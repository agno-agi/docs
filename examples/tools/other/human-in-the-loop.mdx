...
description: "Require user confirmation in a tool pre-hook before fetching Hacker News stories."
source: cookbook/91_tools/other/human_in_the_loop.py
---
...
Full source: [cookbook/91_tools/other/human_in_the_loop.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/other/human_in_the_loop.py)
