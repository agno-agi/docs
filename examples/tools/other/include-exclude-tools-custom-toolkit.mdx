...
description: "Restrict a custom customer database Toolkit to read-only functions with include_tools."
source: cookbook/91_tools/other/include_exclude_tools_custom_toolkit.py
---
...
Full source: [cookbook/91_tools/other/include_exclude_tools_custom_toolkit.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/other/include_exclude_tools_custom_toolkit.py)
