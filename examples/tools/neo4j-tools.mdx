---
title: "Neo4j"
description: "Translate natural language into Cypher with Neo4jTools to inspect the schema, list labels and traverse multi-hop relationships."
---
...
For details, see [Neo4j cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/neo4j_tools.py).
