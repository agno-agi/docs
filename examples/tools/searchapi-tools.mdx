...
description: "Configure SearchApiTools for Google web, News, Images, and YouTube SERP results using per-engine enable flags or all=True."
...
Full source: [cookbook/91_tools/searchapi_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/searchapi_tools.py)
