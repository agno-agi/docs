---
title: "Webex"
description: "List Webex spaces and post messages to them from an agent with WebexTools."
---
...
For details, see [Webex cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/webex_tools.py).
