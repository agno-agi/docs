---
title: "Airflow"
description: "Save and read Airflow DAG files from a dags_dir with AirflowTools, toggling save/read access via enable_ flags."
---
...
```
For details, see [Airflow cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/airflow_tools.py).
