...
description: "Write and read files in a target directory with LocalFileSystemTools, including a write-only agent that disables read_file."
...
Full source: [cookbook/91_tools/local_file_system_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/local_file_system_tools.py)
