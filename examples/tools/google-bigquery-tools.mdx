...
description: "Configure GoogleBigQueryTools with a Google Cloud project, location, and dataset."
...
Full source: [cookbook/91_tools/google_bigquery_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/google_bigquery_tools.py)
