---
title: "OpenWeather"
description: "Fetch current weather, forecasts, air-quality data, and geocoding from the OpenWeather API inside an Agno agent."
---
...
```
For details, see [OpenWeather cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/openweather_tools.py).
