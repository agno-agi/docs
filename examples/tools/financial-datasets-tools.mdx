...
description: "Query income statements, balance sheets, stock prices, insider trades and news through FinancialDatasetsTools."
---

Enable Agno agents to query financial statements, stock prices, news, insider trades, and other market data through Financial Datasets.
