...
description: "Yield a custom CustomEvent subclass from an async @tool and consume it while streaming agent.arun()."
...
Full source: [cookbook/91_tools/custom_tool_events.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/custom_tool_events.py)
