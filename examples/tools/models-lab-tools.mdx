...
description: "Runnable cookbook example: Models Lab Tools."
...
Full source: [cookbook/91_tools/models_lab_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/models_lab_tools.py)
