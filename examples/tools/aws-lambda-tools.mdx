---
title: "AWS Lambda"
description: "List and invoke AWS Lambda functions in a chosen region with AWSLambdaTools, gating each operation with enable_ flags."
---
...
```
For details, see [AWS Lambda cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/aws_lambda_tools.py).
