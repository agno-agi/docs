...
description: "Approve or reject Workspace write/edit/delete tool calls from the console using pause/resume with a SQLite-backed agent."
...
Full source: [cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py)
