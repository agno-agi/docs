...
Full source: [cookbook/91_tools/workspace_tools/basic_usage.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/workspace_tools/basic_usage.py)
