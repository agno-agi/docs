---
title: "Parallel"
description: "Give agents Parallel's Search, Task (deep research), and Monitor APIs for grounded web lookups, cited research, and scheduled web tracking."
...
For more examples, see the [Parallel cookbook](https://github.com/agno-agi/agno/tree/v2.7.4/cookbook/91_tools/parallel).
