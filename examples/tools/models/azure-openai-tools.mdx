...
description: "Legacy AzureOpenAITools example for image generation with retired DALL-E deployments."
...
<Warning>
  Azure DALL-E 2 and DALL-E 3 deployments are retired, and the v2.7.4 toolkit supports no current image model. Do not run this source as written.
</Warning>
...
Full source: [cookbook/91_tools/models/azure_openai_tools.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/models/azure_openai_tools.py)
