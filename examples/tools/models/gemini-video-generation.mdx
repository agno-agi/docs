...
Full source: [cookbook/91_tools/models/gemini_video_generation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/models/gemini_video_generation.py)
