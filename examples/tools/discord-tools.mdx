---
title: "Discord Tools"
description: "Runnable cookbook example: Discord Tools."
...
Full source: [cookbook/91_tools/discord_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/discord_tools.py)
