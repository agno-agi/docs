---
title: "Nano Banana"
description: "Generate images with Google's Nano Banana model, including custom aspect ratios and saving output to disk."
---
...
```
For details, see [Nano Banana cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/nano_banana_tools.py).
