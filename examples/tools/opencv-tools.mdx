---
title: "OpenCV"
description: "Capture webcam images and video with OpenCVTools, using enable_ flags and show_preview to scope camera access."
---
...
```
For details, see [OpenCV cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/opencv_tools.py).
