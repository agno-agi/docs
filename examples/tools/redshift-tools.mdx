...
description: "Runnable cookbook example: Amazon Redshift Tools Example."
...
Full source: [cookbook/91_tools/redshift_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/redshift_tools.py)
