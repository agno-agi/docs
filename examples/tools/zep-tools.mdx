---
title: "Zep"
description: "Persist and recall user facts across sessions with ZepTools and ZepAsyncTools injected as agent context."
---
...
- Set required environment variables: `export ZEP_API_KEY=<your-zep-api-key>` and `export OPENAI_API_KEY=<your-openai-api-key>`.
...
```
For details, see [Zep tools cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/zep_tools.py).
