...
description: 10 examples covering pre and post execution hooks for tools.
---
...
```python cookbook/90_tools/tool_hooks/pre_and_post_hooks.py
import json
...
```python cookbook/90_tools/tool_hooks/async_pre_and_post_hooks.py
import asyncio
from agno.agent import Agent
from agno.tools import FunctionCall, tool
...
```python cookbook/90_tools/tool_hooks/tool_hook_in_toolkit.py
from agno.agent import Agent
...
```python cookbook/90_tools/tool_hooks/tool_hook_in_toolkit_with_state.py
from agno.agent import Agent
from agno.tools import FunctionCall, Toolkit
...
```python cookbook/90_tools/tool_hooks/tool_hook_in_toolkit_with_state_nested.py
from agno.agent import Agent
from agno.tools import FunctionCall, Toolkit
...
## All 10 Hook Examples

| Example | Description |
|---------|-------------|
| `pre_and_post_hooks.py` | Basic pre/post hooks |
| `async_pre_and_post_hooks.py` | Async hook functions |
| `tool_hook.py` | Simple tool hook |
| `tool_hook_async.py` | Async tool hook |
| `tool_hook_in_toolkit.py` | Hooks in toolkit class |
| `tool_hook_in_toolkit_async.py` | Async toolkit hooks |
| `tool_hook_in_toolkit_with_state.py` | Stateful toolkit hooks |
| `tool_hook_in_toolkit_with_state_nested.py` | Nested stateful hooks |
| `tool_hooks_in_toolkit_nested.py` | Nested toolkit hooks |
| `tool_hooks_in_toolkit_nested_async.py` | Async nested hooks |
...
- [MCP](/examples/tools/mcp) - Model Context Protocol
- [Tools Overview](/examples/tools/overview) - All tool examples
