...
Full source: [cookbook/91_tools/exceptions/stop_agent_exception.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/exceptions/stop_agent_exception.py)
