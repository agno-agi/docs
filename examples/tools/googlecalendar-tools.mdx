...
description: "List, create, update and delete Google Calendar events and find free slots via OAuth with GoogleCalendarTools."
---
     ...
     *(Click for details)*
     <Accordion title="Get the Google OAuth Credentials">
       ...
       5. Select Scope
          ...
          - Search for Google Calendar API (Make Sure you've enabled Google calender API otherwise scopes wont be visible)
...
Full source: [cookbook/91_tools/googlecalendar_tools.py](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/googlecalendar_tools.py)
