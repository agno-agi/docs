---
title: "Shopify"
description: "Analyze Shopify sales, bundles, and inventory trends with ShopifyTools."
---
...
```
For details, see [Shopify tools cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/shopify_tools.py).
