---
title: "Valyu"
description: "Search academic papers, arXiv, and high-fidelity web sources with ValyuTools."
---
...
```
For details, see [Valyu tool cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/valyu_tools.py).
