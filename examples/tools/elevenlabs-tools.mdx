---
title: "Elevenlabs"
description: "Produce voice audio and sound effects with ElevenLabsTools on a Gemini-powered agent and save the result as MP3."
---
...
```
For details, see [Elevenlabs cookbook](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/91_tools/elevenlabs_tools.py).
