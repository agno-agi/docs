...
<CardGroup cols={3}>
  ...
  <Card title="Custom Tools" icon="wrench" iconType="duotone" href="./write-your-own-tool">
    Create and integrate custom tools with your agent.
  </Card>

  <Card title="Research Agent" icon="magnifying-glass" iconType="duotone" href="./research-agent-exa">
    Build an AI research agent using Exa with controlled output steering.
  </Card>

  <Card title="Research Workflow" icon="diagram-project" iconType="duotone" href="./blog-generator-workflow">
  ...
  <Card title="User Memories" icon="memory" iconType="duotone" href="./user-memories-and-summaries">
    Create an Agent that stores user memories and summaries.
  </Card>

  <Card title="Function Retries" icon="rotate" iconType="duotone" href="./retry-function-call">
