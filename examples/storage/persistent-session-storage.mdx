...
description: "Store and retrieve team sessions across runs using PostgreSQL."
...
Full source: [cookbook/06_storage/01_persistent_session_storage.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/01_persistent_session_storage.py)
