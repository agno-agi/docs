...
<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/storage/firestore_storage.py`. Follow the generated Run step below.
</Warning>
...
<Steps>
  ...
  <Step title="Configure Firestore">
...
Full source: [cookbook/06_storage/firestore/firestore_for_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/firestore/firestore_for_agent.py)
