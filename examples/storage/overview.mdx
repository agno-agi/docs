...
description: 45 examples covering 13 database backends for agent persistence and state.
---
...
## All 45 Storage Examples

| Database | Examples |
|----------|----------|
| PostgreSQL | `postgres_for_agent.py`, `postgres_for_team.py`, `postgres_for_workflow.py` |
| SQLite | `sqlite_for_agent.py`, `sqlite_for_team.py`, `sqlite_for_workflow.py` |
| MongoDB | `mongodb_for_agent.py`, `mongodb_for_team.py` |
| Redis | `redis_for_agent.py`, `redis_for_team.py` |
| DynamoDB | `dynamo_for_agent.py`, `dynamo_for_team.py` |
| Firestore | `firestore_for_agent.py` |
| MySQL | `mysql_for_agent.py` |
| SingleStore | `singlestore_for_agent.py` |
| SurrealDB | `surrealdb_for_agent.py` |
| GCS | `gcs_for_agent.py` |
| JSON | `json_for_agent.py` |
| In-Memory | `in_memory_storage_for_agent.py`, `in_memory_storage_for_team.py` |
...
- [Models Examples](/examples/models/overview) - 40+ model providers
- [Tools Examples](/examples/tools/overview) - 194 tool examples
- [Knowledge Examples](/examples/knowledge/overview) - RAG and vector databases
