...
Full source: [cookbook/06_storage/examples/selecting_tables.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/examples/selecting_tables.py)
