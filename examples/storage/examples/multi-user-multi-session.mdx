...
description: "Handle multiple users and sessions with SQLite-backed agent storage."
...
Full source: [cookbook/06_storage/examples/multi_user_multi_session.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/examples/multi_user_multi_session.py)
