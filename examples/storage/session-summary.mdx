...
description: "Automatically summarize agent sessions to reduce context window usage."
...
Full source: [cookbook/06_storage/02_session_summary.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/02_session_summary.py)
