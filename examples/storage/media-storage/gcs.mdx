...
description: "Demonstrates GCSMediaStorage, which offloads media to Google Cloud Storage and keeps only a MediaReference in the database."
...
Full source: [cookbook/06_storage/08_media_storage_gcs.py](https://github.com/agno-agi/agno/blob/main/cookbook/06_storage/08_media_storage_gcs.py)
