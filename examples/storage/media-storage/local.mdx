...
description: "Demonstrates LocalMediaStorage, which writes media to the filesystem and keeps only a MediaReference in the database."
...
Full source: [cookbook/06_storage/05_media_storage_local.py](https://github.com/agno-agi/agno/blob/main/cookbook/06_storage/05_media_storage_local.py)
