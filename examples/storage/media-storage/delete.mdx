...
description: "Delete a session's stored media alongside its rows with delete_media=True."
...
Full source: [cookbook/06_storage/09_media_storage_delete.py](https://github.com/agno-agi/agno/blob/main/cookbook/06_storage/09_media_storage_delete.py)
