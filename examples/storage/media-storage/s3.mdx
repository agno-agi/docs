...
description: "Demonstrates S3MediaStorage, which offloads media to S3-compatible object storage and keeps only a MediaReference in the database."
...
Full source: [cookbook/06_storage/06_media_storage_s3.py](https://github.com/agno-agi/agno/blob/main/cookbook/06_storage/06_media_storage_s3.py)
