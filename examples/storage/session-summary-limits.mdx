...
Full source: [cookbook/06_storage/04_session_summary_limits.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/04_session_summary_limits.py)
