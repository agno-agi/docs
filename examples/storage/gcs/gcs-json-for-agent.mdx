...
description: "Store agent sessions in Google Cloud Storage as JSON blobs."
...
Full source: [cookbook/06_storage/gcs/gcs_json_for_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/gcs/gcs_json_for_agent.py)
