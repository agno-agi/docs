...
description: "Use JSON files as the database for a Workflow."
source: cookbook/06_storage/json_db/json_for_workflows.py
---
...
Full source: [cookbook/06_storage/json_db/json_for_workflows.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/json_db/json_for_workflows.py)
