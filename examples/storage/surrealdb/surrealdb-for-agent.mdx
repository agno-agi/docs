...
Full source: [cookbook/06_storage/surrealdb/surrealdb_for_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/surrealdb/surrealdb_for_agent.py)
