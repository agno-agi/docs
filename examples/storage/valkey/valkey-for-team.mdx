...
description: "Example showing how to use Valkey as the database for a team."
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno ddgs glide-sync openai valkey-glide-sync
    ```
  </Step>
  ...
  <Step title="Run the example">
    Save the code above as `valkey_for_team.py`, then run:
    ```bash
    python valkey_for_team.py
    ```
  </Step>
...
Full source: [cookbook/06_storage/valkey/valkey_for_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/valkey/valkey_for_team.py)
