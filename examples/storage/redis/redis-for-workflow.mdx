...
description: "Use Redis as the storage backend for a workflow."
...
Full source: [cookbook/06_storage/redis/redis_for_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/redis/redis_for_workflow.py)
