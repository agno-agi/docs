...
description: "Use async Postgres as the storage backend for a workflow."
source: cookbook/06_storage/postgres/async_postgres/async_postgres_for_workflow.py
---
...
Full source: [cookbook/06_storage/postgres/async_postgres/async_postgres_for_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/postgres/async_postgres/async_postgres_for_workflow.py)
