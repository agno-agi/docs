...
description: "Store a HackerNews research team's structured article output in MySQL asynchronously."
...
Full source: [cookbook/06_storage/mysql/async_mysql/async_mysql_for_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/mysql/async_mysql/async_mysql_for_team.py)
