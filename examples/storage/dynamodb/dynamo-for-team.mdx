...
description: "Store team sessions and runs in DynamoDB with environment variables or constructor parameters."
...
Full source: [cookbook/06_storage/dynamodb/dynamo_for_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/dynamodb/dynamo_for_team.py)
