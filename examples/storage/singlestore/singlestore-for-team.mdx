...
<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/storage/singlestore_storage/singlestore_storage_for_team.py`. Follow the generated Run step below.
</Warning>
...
Full source: [cookbook/06_storage/singlestore/singlestore_for_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/singlestore/singlestore_for_team.py)
