...
description: "HackerNews team persists sessions in MongoDB with AsyncMongoDb and aprint_response."
source: cookbook/06_storage/mongo/async_mongo/async_mongodb_for_team.py
---
...
Full source: [cookbook/06_storage/mongo/async_mongo/async_mongodb_for_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/06_storage/mongo/async_mongo/async_mongodb_for_team.py)
