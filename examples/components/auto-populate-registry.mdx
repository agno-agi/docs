...
Full source: [cookbook/93_components/auto_populate_registry.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/auto_populate_registry.py)
