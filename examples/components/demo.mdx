...
description: "Register tools, custom functions, Pydantic schemas, models, and a PgVector vector DB in an AgentOS Registry."
...
Full source: [cookbook/93_components/demo.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/demo.py)
