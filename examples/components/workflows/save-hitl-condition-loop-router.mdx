...
description: "Round-trip requires_confirmation, on_reject, and route-selection settings on Condition, Loop, and Router through workflow save/load, then drive the pauses interactively."
...
Full source: [cookbook/93_components/workflows/save_hitl_condition_loop_router.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/workflows/save_hitl_condition_loop_router.py)
