...
description: "Persist a workflow whose step declares a UserInputField schema (tone, length, include_examples), reload it from Postgres, and fill the paused step's fields interactively."
...
Full source: [cookbook/93_components/workflows/save_hitl_user_input_steps.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/workflows/save_hitl_user_input_steps.py)
