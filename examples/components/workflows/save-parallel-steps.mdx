...
description: "Save a Parallel research pipeline (HackerNews plus web) to Postgres and reload it by ID without a Registry, since all steps are agent-backed."
...
Full source: [cookbook/93_components/workflows/save_parallel_steps.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/workflows/save_parallel_steps.py)
