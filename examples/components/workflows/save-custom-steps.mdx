...
description: "Register a custom executor function in a Registry so a saved workflow's non-agent step resolves on load from Postgres."
...
Full source: [cookbook/93_components/workflows/save_custom_steps.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/workflows/save_custom_steps.py)
