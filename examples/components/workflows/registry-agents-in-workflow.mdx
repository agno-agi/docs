...
description: "Expose code-defined agents with stable IDs through the AgentOS /registry endpoint so UI-built workflows resolve them by ID instead of loading them from the database."
...
Full source: [cookbook/93_components/workflows/registry_agents_in_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/workflows/registry_agents_in_workflow.py)
