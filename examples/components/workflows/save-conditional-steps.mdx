...
description: "Save a workflow whose Condition evaluator is a plain function, then reload it from Postgres by registering that function in a Registry."
...
Full source: [cookbook/93_components/workflows/save_conditional_steps.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/workflows/save_conditional_steps.py)
