...
description: "Serve an AgentOS with no explicit registry and read the auto-discovered models, tools, and dbs from the GET /registry endpoint."
...
Full source: [cookbook/93_components/auto_populate_registry_os.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/auto_populate_registry_os.py)
