...
description: "Serve an AgentOS app whose Registry pre-registers DuckDuckGo and calculator tools, a custom function, and OpenAI/Claude/Azure models."
...
Full source: [cookbook/93_components/agent_os_registry.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/agent_os_registry.py)
