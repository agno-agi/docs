...
description: "Register tools, models, dbs, and Pydantic schemas in a Registry so saved agents can be rehydrated from Postgres."
...
Full source: [cookbook/93_components/registry.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/93_components/registry.py)
