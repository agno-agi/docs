...
Full source: [cookbook/00_quickstart/agent_with_structured_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/00_quickstart/agent_with_structured_output.py)
