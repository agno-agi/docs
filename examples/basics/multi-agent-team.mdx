...
description: "Coordinate bull and bear analyst agents under a team leader that synthesizes a balanced investment recommendation."
...
Full source: [cookbook/00_quickstart/multi_agent_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/00_quickstart/multi_agent_team.py)
