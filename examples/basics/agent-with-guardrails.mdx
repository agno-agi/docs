...
Full source: [cookbook/00_quickstart/agent_with_guardrails.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/00_quickstart/agent_with_guardrails.py)
