...
sidebarTitle: History for Specific Step
keywords: [workflow, history, step-level, content creation]
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    ```bash
    touch enable_history_for_step.py
    ```
  </Step>

  <Step title="Add the following code to your Python file">
    ```python enable_history_for_step.py
    """
