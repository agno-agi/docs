...
sidebarTitle: Get History in Function
keywords: [workflow, history, custom function, StepInput]
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    ```bash
    touch get_history_in_function.py
    ```
  </Step>

  <Step title="Add the following code to your Python file">
    ```python get_history_in_function.py
    import json
