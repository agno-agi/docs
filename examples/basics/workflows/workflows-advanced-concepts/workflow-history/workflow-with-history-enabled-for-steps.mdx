...
sidebarTitle: History for Steps
keywords: [workflow, history, multi-step, preference analysis]
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    ```bash
    touch workflow_with_history_enabled_for_steps.py
    ```
  </Step>

  <Step title="Add the following code to your Python file">
    ```python workflow_with_history_enabled_for_steps.py
