...
description: "Add SQLite session storage so the Finance Agent remembers conversations across runs."
...
Full source: [cookbook/00_quickstart/agent_with_storage.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/00_quickstart/agent_with_storage.py)
