...
sidebarTitle: Pydantic Input
keywords: [team input, pydantic, structured input, validation, type safety]
description: This example demonstrates how to use Pydantic models as input to teams, showing how structured data can be passed as messages for more precise and validated input handling.
mode: wide
---
