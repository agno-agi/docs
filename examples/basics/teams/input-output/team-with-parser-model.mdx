---
title: "Team with Parser Model"
sidebarTitle: Parser Model
keywords: [parser model, structured output, pydantic, team output, validation]
description: This example demonstrates using a parser model with teams to generate structured output, creating detailed national park adventure guides with validated Pydantic schemas.
mode: wide
---
