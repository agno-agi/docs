...
keywords: [output model, team output, model switching, response generation]
description: This example shows how to use the output_model parameter to specify the model that should be used to generate the final response from a team.
mode: wide
---
