...
sidebarTitle: Async Streaming
keywords: [async, streaming, structured output, pydantic, real-time, team output]
description: This example demonstrates async structured output streaming from a team using Pydantic models to ensure structured responses while streaming, providing both real-time output and validated data structures asynchronously.
mode: wide
---
