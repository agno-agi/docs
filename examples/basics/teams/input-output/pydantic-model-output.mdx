...
sidebarTitle: Pydantic Output
keywords: [team output, pydantic, structured output, validation, type safety]
description: This example demonstrates how to use Pydantic models as output from teams, showing how structured data can be returned as responses for more precise and validated output handling.
mode: wide
---
