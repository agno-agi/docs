...
sidebarTitle: Messages List Input
keywords: [input, messages, list, multi-turn, conversation]
description: This example demonstrates how to pass input to an agent as a list of Message objects, allowing for multi-turn conversations and context setup.
mode: wide
---
...
<Steps>
  ...
  <Step title="Create a Python file">
    Create a Python file and add the code shown above.
    ```bash
