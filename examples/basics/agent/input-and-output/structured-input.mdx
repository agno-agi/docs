...
keywords: [structured input, pydantic, type safety, validation]
description: This example demonstrates how to use structured Pydantic models as input to agents, enabling type-safe and validated input parameters for complex research tasks.
mode: wide
---
