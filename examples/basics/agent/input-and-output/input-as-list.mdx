...
sidebarTitle: List Input
keywords: [input, list, multimodal]
description: This example demonstrates how to provide input to an agent as a list format for multimodal content combining text and images.
mode: wide
---
