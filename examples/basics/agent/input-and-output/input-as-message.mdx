...
sidebarTitle: Message Input
keywords: [input, message, multimodal, structured content]
description: This example demonstrates how to provide input to an agent using the Message object format for structured multimodal content.
mode: wide
---
