...
keywords: [response, variable, run output, programmatic access]
description: This example demonstrates how to capture and work with agent responses as variables, enabling programmatic access to response data and metadata.
mode: wide
---
