...
keywords: [output model, model switching, agent execution]
description: This example demonstrates how to use the output_model parameter to specify a different model for generating the final response, enabling model switching during agent execution.
mode: wide
---
