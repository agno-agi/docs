...
Full source: [cookbook/00_quickstart/custom_tool_for_self_learning.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/00_quickstart/custom_tool_for_self_learning.py)
