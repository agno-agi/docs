...
description: "Chain data gathering, analysis, and report writing agents into a three-step stock research workflow."
...
Full source: [cookbook/00_quickstart/sequential_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/00_quickstart/sequential_workflow.py)
