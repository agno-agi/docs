...
description: "Enable enable_agentic_memory so the agent itself creates, updates, and deletes user memories during a run."
...
Full source: [cookbook/11_memory/02_agentic_memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/02_agentic_memory.py)
