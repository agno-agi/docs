...
Full source: [cookbook/11_memory/optimize_memories/02_custom_memory_strategy.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/optimize_memories/02_custom_memory_strategy.py)
