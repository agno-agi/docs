...
description: "Memory optimization using the summarize strategy, which combines all memories into one summary for token reduction."
...
Full source: [cookbook/11_memory/optimize_memories/01_memory_summarize_strategy.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/optimize_memories/01_memory_summarize_strategy.py)
