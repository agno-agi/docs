...
description: "Pinned Dakera memory integration that requires current API migration and sends recalled context to OpenAI."
...
Full source: [cookbook/11_memory/integrations/dakera_integration.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/integrations/dakera_integration.py)
