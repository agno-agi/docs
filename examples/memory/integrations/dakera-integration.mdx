...
description: "Wrap a self-hosted Dakera REST memory server in a small httpx store and rebuild an Agno agent across two sessions with decay-weighted recalled facts."
...
<Steps>
  ...
  <Step title="Export your API keys">
    ...
    ```bash Windows
    $Env:DAKERA_API_KEY="demo"
    $Env:OPENAI_API_KEY="your_openai_api_key_here"
    ```
    </CodeGroup>
  </Step>

  <Step title="Start Dakera">
