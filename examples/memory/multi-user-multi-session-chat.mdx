...
description: "A multi-user, multi-session chat flow where user memory is shared across sessions for the same user."
...
Full source: [cookbook/11_memory/05_multi_user_multi_session_chat.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/05_multi_user_multi_session_chat.py)
