...
Full source: [cookbook/11_memory/memory_manager/05_db_tools_control.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/memory_manager/05_db_tools_control.py)
