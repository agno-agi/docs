...
description: "Persist user memories in PostgresDb with update_memory_on_run so the agent creates and updates them after each run."
...
Full source: [cookbook/11_memory/01_agent_with_memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/01_agent_with_memory.py)
