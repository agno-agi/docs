...
description: "Two agents sharing the same user memory."
...
Full source: [cookbook/11_memory/03_agents_share_memory.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/03_agents_share_memory.py)
