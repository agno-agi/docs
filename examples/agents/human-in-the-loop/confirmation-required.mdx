...
description: "Gate a custom HackerNews tool behind requires_confirmation and resume the paused run with agent.continue_run()."
source: cookbook/02_agents/10_human_in_the_loop/confirmation_required.py
---
...
Full source: [cookbook/02_agents/10_human_in_the_loop/confirmation_required.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/10_human_in_the_loop/confirmation_required.py)
