...
Full source: [cookbook/02_agents/10_human_in_the_loop/confirmation_required.py](https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/10_human_in_the_loop/confirmation_required.py)
