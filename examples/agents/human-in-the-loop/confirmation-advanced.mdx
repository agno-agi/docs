...
description: "Confirm or reject tool calls across a custom HackerNews tool and WikipediaTools in one run."
source: cookbook/02_agents/10_human_in_the_loop/confirmation_advanced.py
---
...
Full source: [cookbook/02_agents/10_human_in_the_loop/confirmation_advanced.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/10_human_in_the_loop/confirmation_advanced.py)
