...
Full source: [cookbook/02_agents/10_human_in_the_loop/user_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/10_human_in_the_loop/user_input.py)
