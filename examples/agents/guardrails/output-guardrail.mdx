...
Full source: [cookbook/02_agents/08_guardrails/output_guardrail.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/08_guardrails/output_guardrail.py)
