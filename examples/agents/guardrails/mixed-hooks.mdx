...
description: "Combine a logging pre-hook with PIIDetectionGuardrail; blocked runs return RunStatus.error instead of raising."
...
Full source: [cookbook/02_agents/08_guardrails/mixed_hooks.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/08_guardrails/mixed_hooks.py)
