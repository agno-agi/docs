...
description: "List a run's checkpoint boundaries and fetch truncated snapshots via the AgentOS checkpoint endpoints, then resume from a chosen index."
...
Full source: [cookbook/02_agents/18_checkpointing/03_checkpoint_endpoints.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/18_checkpointing/03_checkpoint_endpoints.py)
