...
description: "Persist an agent conversation through tool exceptions and model failures, then retry the failed run in place with `Agent.acontinue_run()`."
...
Full source: [cookbook/02_agents/18_checkpointing/02_tool_error_persistence.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/18_checkpointing/02_tool_error_persistence.py)
