...
Full source: [cookbook/02_agents/14_advanced/interchange_model/claude_gemini.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/interchange_model/claude_gemini.py)
