...
description: "Set compress_tool_results=True to compress tool call results and save context on search-heavy runs."
...
Full source: [cookbook/02_agents/14_advanced/tool_call_compression.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/tool_call_compression.py)
