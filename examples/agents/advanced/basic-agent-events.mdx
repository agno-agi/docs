...
description: "Stream run lifecycle, tool call, and content events from an agent with stream_events=True."
...
Full source: [cookbook/02_agents/14_advanced/basic_agent_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/basic_agent_events.py)
