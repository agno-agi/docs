...
Full source: [cookbook/02_agents/14_advanced/streaming_metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/streaming_metrics.py)
