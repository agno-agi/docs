...
description: "Inspect per-model metrics detail keys and session-level metrics for an agent using reasoning, compression, memory, culture, summary, and eval models."
...
Full source: [cookbook/02_agents/14_advanced/combined_metrics.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/combined_metrics.py)
