...
description: "Start a background agent run that returns PENDING immediately, then poll for completion or cancel it."
...
<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/02_agents/other/background_execution.py`. Follow the generated Run step below.
</Warning>
...
Full source: [cookbook/02_agents/14_advanced/background_execution.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/background_execution.py)
