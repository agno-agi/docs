...
<Warning>
  This example's source docstring names a removed cookbook path: `cookbook/02_agents/other/custom_cancellation_manager.py`. Follow the generated Run step below.
</Warning>
...
Full source: [cookbook/02_agents/14_advanced/custom_cancellation_manager.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/custom_cancellation_manager.py)
