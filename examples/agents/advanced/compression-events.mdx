...
description: "Stream CompressionStarted and CompressionCompleted events from an agent using compress_tool_results=True."
...
Full source: [cookbook/02_agents/14_advanced/compression_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/compression_events.py)
