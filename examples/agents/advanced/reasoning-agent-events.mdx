...
description: "Stream reasoning_started, reasoning_step, and reasoning_completed events from a reasoning-enabled agent run."
...
Full source: [cookbook/02_agents/14_advanced/reasoning_agent_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/14_advanced/reasoning_agent_events.py)
