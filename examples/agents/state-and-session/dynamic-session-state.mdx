...
description: "Update session state inside a tool hook during an agent run."
...
Full source: [cookbook/02_agents/05_state_and_session/dynamic_session_state.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/dynamic_session_state.py)
