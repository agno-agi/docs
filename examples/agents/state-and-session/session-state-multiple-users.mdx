...
description: "Maintain state for each user in a multi-user environment."
source: cookbook/02_agents/05_state_and_session/session_state_multiple_users.py
---
...
Full source: [cookbook/02_agents/05_state_and_session/session_state_multiple_users.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/session_state_multiple_users.py)
