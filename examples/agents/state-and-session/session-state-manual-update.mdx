...
description: "Modify session state between runs with get_session_state() and update_session_state()."
...
Full source: [cookbook/02_agents/05_state_and_session/session_state_manual_update.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/session_state_manual_update.py)
