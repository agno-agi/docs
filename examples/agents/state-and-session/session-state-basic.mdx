...
description: "Maintain a shopping list in session state and update it from a tool through RunContext."
source: cookbook/02_agents/05_state_and_session/session_state_basic.py
---
...
Full source: [cookbook/02_agents/05_state_and_session/session_state_basic.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/session_state_basic.py)
