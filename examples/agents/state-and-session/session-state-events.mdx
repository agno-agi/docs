...
description: "Stream an agent run and read the final session state from RunCompletedEvent."
...
Full source: [cookbook/02_agents/05_state_and_session/session_state_events.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/session_state_events.py)
