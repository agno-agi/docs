...
description: "Use history in context during runs while store_history_messages=False keeps history messages out of the database."
...
Full source: [cookbook/02_agents/05_state_and_session/session_options.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/session_options.py)
