...
description: "Enable session summaries with enable_session_summaries or a custom SessionSummaryManager, stored in Postgres."
...
Full source: [cookbook/02_agents/05_state_and_session/session_summary.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/session_summary.py)
