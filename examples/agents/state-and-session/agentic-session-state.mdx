...
description: "Let the agent update its own session_state shopping list with enable_agentic_state."
...
Full source: [cookbook/02_agents/05_state_and_session/agentic_session_state.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/agentic_session_state.py)
