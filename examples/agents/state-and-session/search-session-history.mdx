...
Full source: [cookbook/02_agents/05_state_and_session/search_session_history.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/search_session_history.py)
