...
description: "Search a user's previous sessions with search_past_sessions, capped at the last two by num_past_sessions_to_search."
...
Full source: [cookbook/02_agents/05_state_and_session/last_n_session_messages.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/last_n_session_messages.py)
