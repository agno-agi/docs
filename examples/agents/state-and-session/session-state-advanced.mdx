...
description: "Manage a shopping list in session_state with tools that add, remove, and list items through RunContext."
...
Full source: [cookbook/02_agents/05_state_and_session/session_state_advanced.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/05_state_and_session/session_state_advanced.py)
