...
description: "Register a FallbackConfig callback that fires when a fallback model serves the request."
...
Full source: [cookbook/02_agents/17_fallback_models/04_fallback_callback.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/17_fallback_models/04_fallback_callback.py)
