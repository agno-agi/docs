...
description: "Trigger a fallback when the primary model fails mid-run, after a tool call has already executed."
...
Full source: [cookbook/02_agents/17_fallback_models/03_mid_run_fallback.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/17_fallback_models/03_mid_run_fallback.py)
