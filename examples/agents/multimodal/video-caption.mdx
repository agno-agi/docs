---
title: "Video Caption"
description: "Extract a video's audio, transcribe it with OpenAITools, and embed the generated SRT captions back into the video with MoviePyVideoTools."
...
Full source: [cookbook/02_agents/12_multimodal/video_caption.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/12_multimodal/video_caption.py)
