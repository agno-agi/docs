...
Full source: [cookbook/02_agents/12_multimodal/image_to_image.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/12_multimodal/image_to_image.py)
