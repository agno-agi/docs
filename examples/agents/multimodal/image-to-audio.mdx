...
description: "Write a story about a local image with gpt-4o, then narrate it with gpt-audio and save the WAV to tmp/."
source: cookbook/02_agents/12_multimodal/image_to_audio.py
---
...
Full source: [cookbook/02_agents/12_multimodal/image_to_audio.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/12_multimodal/image_to_audio.py)
