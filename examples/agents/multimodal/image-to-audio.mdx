...
Full source: [cookbook/02_agents/12_multimodal/image_to_audio.py](https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/12_multimodal/image_to_audio.py)
