...
Full source: [cookbook/02_agents/04_tools/03_team_callable_members.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/04_tools/03_team_callable_members.py)
