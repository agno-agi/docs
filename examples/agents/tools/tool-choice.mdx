---
title: "Tool Choice"
description: "Compare tool_choice values none, auto, and a forced get_weather call across three agents."
...
Full source: [cookbook/02_agents/04_tools/tool_choice.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/04_tools/tool_choice.py)
