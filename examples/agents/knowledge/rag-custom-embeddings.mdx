...
description: "Build agentic RAG over multilingual documents with SentenceTransformer embeddings and a BAAI reranker in PgVector."
source: cookbook/02_agents/07_knowledge/rag_custom_embeddings.py
---
...
Full source: [cookbook/02_agents/07_knowledge/rag_custom_embeddings.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/07_knowledge/rag_custom_embeddings.py)
