...
description: "Track conversation topics in session_state by updating RunContext from a pre_hook."
...
Full source: [cookbook/02_agents/09_hooks/session_state_hooks.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/09_hooks/session_state_hooks.py)
