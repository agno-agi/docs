---
title: "Stream Hook"
description: "Send a notification from a post_hook after a streamed agent response completes."
...
Full source: [cookbook/02_agents/09_hooks/stream_hook.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/09_hooks/stream_hook.py)
