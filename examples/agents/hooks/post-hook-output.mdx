...
description: "Validate agent responses for completeness, tone, safety, and length with post_hooks that raise OutputCheckError."
source: cookbook/02_agents/09_hooks/post_hook_output.py
---
...
Full source: [cookbook/02_agents/09_hooks/post_hook_output.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/09_hooks/post_hook_output.py)
