...
Full source: [cookbook/02_agents/09_hooks/message_history_hooks.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/09_hooks/message_history_hooks.py)
