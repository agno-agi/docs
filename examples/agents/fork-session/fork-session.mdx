...
description: "Fork a session into a new session with a fresh session_id and fresh run IDs while the source session stays untouched."
...
Full source: [cookbook/02_agents/21_fork_session/01_fork_session.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/21_fork_session/01_fork_session.py)
