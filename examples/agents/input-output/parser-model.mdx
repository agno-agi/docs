...
Full source: [cookbook/02_agents/02_input_output/parser_model.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/02_input_output/parser_model.py)
