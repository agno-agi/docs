...
Full source: [cookbook/02_agents/11_approvals/audit_approval_user_input.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/11_approvals/audit_approval_user_input.py)
