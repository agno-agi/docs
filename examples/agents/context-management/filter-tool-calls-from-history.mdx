...
Full source: [cookbook/02_agents/03_context_management/filter_tool_calls_from_history.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/02_agents/03_context_management/filter_tool_calls_from_history.py)
