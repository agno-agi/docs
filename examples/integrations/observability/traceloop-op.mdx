...
description: "Wraps an agent run in a Traceloop @workflow-decorated function so the run appears under a parent workflow span."
...
Full source: [cookbook/observability/traceloop_op.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/traceloop_op.py)
