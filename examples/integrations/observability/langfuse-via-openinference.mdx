...
description: "Export Agno agent spans to Langfuse over OTLP HTTP with base64 basic-auth headers and AgnoInstrumentor."
...
Full source: [cookbook/observability/langfuse_via_openinference.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/langfuse_via_openinference.py)
