...
description: "Enable mlflow.agno.autolog() against a local MLflow tracking server to capture traces from a YFinance stock agent."
...
Full source: [cookbook/observability/mlflow_via_autolog.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/mlflow_via_autolog.py)
