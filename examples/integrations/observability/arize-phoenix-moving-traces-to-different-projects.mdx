...
description: "Route traces from a stock agent and a search agent into separate Phoenix projects using dangerously_using_project."
...
Full source: [cookbook/observability/arize_phoenix_moving_traces_to_different_projects.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/arize_phoenix_moving_traces_to_different_projects.py)
