...
description: "Trace a YFinance stock-price agent with a Pydantic output_schema to Langfuse via the OpenInference Agno instrumentor and OTLP HTTP export."
...
Full source: [cookbook/observability/langfuse_via_openinference_response_model.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/langfuse_via_openinference_response_model.py)
