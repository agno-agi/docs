...
description: "Send stock-agent traces to a self-hosted Phoenix collector at localhost:6006 under a named project."
...
Full source: [cookbook/observability/arize_phoenix_via_openinference_local.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/arize_phoenix_via_openinference_local.py)
