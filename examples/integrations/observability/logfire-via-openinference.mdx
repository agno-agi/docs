...
description: "Streams a YFinance stock agent's spans to Logfire over OTLP HTTP using the OpenInference Agno instrumentor."
...
Full source: [cookbook/observability/logfire_via_openinference.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/logfire_via_openinference.py)
