...
description: "Export OpenTelemetry spans from a conditional research workflow to Langfuse via the OpenInference Agno instrumentor."
...
Full source: [cookbook/observability/workflows/langfuse_via_openinference_workflows.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/workflows/langfuse_via_openinference_workflows.py)
