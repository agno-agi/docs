...
description: "Trace a research-summarize-fact-check-write workflow to Arize Phoenix using phoenix.otel auto-instrumentation."
...
Full source: [cookbook/observability/workflows/arize_phoenix_via_openinference_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/workflows/arize_phoenix_via_openinference_workflow.py)
