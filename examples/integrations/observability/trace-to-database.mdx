...
description: "Persists agent spans to SQLite with setup_tracing, then queries db.get_trace and db.get_spans to print the span tree and attributes."
...
Full source: [cookbook/observability/trace_to_database.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/trace_to_database.py)
