...
description: "Traces a two-agent market-data and news team to Langfuse over OTLP with a run_mode switch between sync and async runs."
...
Full source: [cookbook/observability/teams/langfuse_via_openinference_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/observability/teams/langfuse_via_openinference_team.py)
