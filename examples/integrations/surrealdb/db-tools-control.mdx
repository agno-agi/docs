...
Full source: [cookbook/integrations/surrealdb/db_tools_control.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/integrations/surrealdb/db_tools_control.py)
