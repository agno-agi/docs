...
Full source: [cookbook/integrations/surrealdb/memory_creation.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/integrations/surrealdb/memory_creation.py)
