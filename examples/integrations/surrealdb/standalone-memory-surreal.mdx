...
Full source: [cookbook/integrations/surrealdb/standalone_memory_surreal.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/integrations/surrealdb/standalone_memory_surreal.py)
