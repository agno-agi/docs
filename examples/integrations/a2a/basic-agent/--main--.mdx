...
Full source: [cookbook/05_agent_os/interfaces/a2a/basic_agent/__main__.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/05_agent_os/interfaces/a2a/basic_agent/__main__.py)
