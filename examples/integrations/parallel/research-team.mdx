...
description: "Agno Team pairing a Parallel Search/Extract web researcher with a Task-API deep researcher, whose lead synthesizes one cited answer."
...
Full source: [cookbook/integrations/parallel/06_research_team.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/integrations/parallel/06_research_team.py)
