...
description: "Persistent Parallel research agent combining Search, Extract, and Task APIs with SQLite-backed sessions, history, and user memory across follow-up turns."
...
Full source: [cookbook/integrations/parallel/04_research_assistant.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/integrations/parallel/04_research_assistant.py)
