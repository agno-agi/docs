...
description: "Run source gathering and cited-brief writing as two defined workflow steps persisted to SQLite."
...
Full source: [cookbook/integrations/parallel/07_research_workflow.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/integrations/parallel/07_research_workflow.py)
