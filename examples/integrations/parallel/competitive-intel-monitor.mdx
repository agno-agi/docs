...
description: "Agent using the Parallel Monitor API at a 1-day frequency to create topic monitors, list active ones, and report detected change events with sources."
...
Full source: [cookbook/integrations/parallel/08_competitive_intel_monitor.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/integrations/parallel/08_competitive_intel_monitor.py)
