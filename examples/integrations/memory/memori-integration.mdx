...
description: "Register Memori against the agent's OpenAI client with a SQLite-backed store so preferences from earlier turns are recalled in later ones."
...
Full source: [cookbook/11_memory/integrations/memori_integration.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/integrations/memori_integration.py)
