...
description: "Seed a Mem0 cloud memory client with user facts and inject the retrieved memories into an Agno agent's context via dependencies."
...
Full source: [cookbook/11_memory/integrations/mem0_integration.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/11_memory/integrations/mem0_integration.py)
