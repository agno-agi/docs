...
<Warning>
  Groq shut down `meta-llama/llama-4-scout-17b-16e-instruct` for free and developer tiers on July 17, 2026. Replace it with the vision-capable `qwen/qwen3.6-27b`. See [Groq deprecations](https://console.groq.com/docs/deprecations).
</Warning>
...
Full source: [cookbook/10_reasoning/tools/groq_llama_finance_agent.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/tools/groq_llama_finance_agent.py)
