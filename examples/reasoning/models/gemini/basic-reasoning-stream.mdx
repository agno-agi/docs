---
title: "Gemini Basic Reasoning Stream"
description: "Stream reasoning events from Gemini 2.5 Flash with a thinking budget enabled."
source: cookbook/10_reasoning/models/gemini/basic_reasoning_stream.py
---
...
Full source: [cookbook/10_reasoning/models/gemini/basic_reasoning_stream.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/models/gemini/basic_reasoning_stream.py)
