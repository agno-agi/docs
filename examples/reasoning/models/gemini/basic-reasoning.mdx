...
description: "Compare Gemini 2.5 Flash with thinking disabled and a 1,024-token budget, then inspect reasoning content."
...
<Steps>
  ...
  <Step title="Disable thinking on the regular agent">
...
Full source: [cookbook/10_reasoning/models/gemini/basic_reasoning.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/models/gemini/basic_reasoning.py)
