---
title: "Anthropic Async Reasoning Stream"
description: "Stream Claude extended-thinking reasoning events asynchronously with stream_events."
source: cookbook/10_reasoning/models/anthropic/async_reasoning_stream.py
---
...
Full source: [cookbook/10_reasoning/models/anthropic/async_reasoning_stream.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/models/anthropic/async_reasoning_stream.py)
