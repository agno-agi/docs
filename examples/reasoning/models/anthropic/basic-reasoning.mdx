...
Full source: [cookbook/10_reasoning/models/anthropic/basic_reasoning.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/models/anthropic/basic_reasoning.py)
