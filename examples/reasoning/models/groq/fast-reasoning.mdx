...
Full source: [cookbook/10_reasoning/models/groq/fast_reasoning.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/models/groq/fast_reasoning.py)
