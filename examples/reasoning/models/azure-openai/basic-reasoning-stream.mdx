...
description: "Stream reasoning deltas from an Azure OpenAI GPT-4.1 reasoning model while the default chat model writes the answer."
...
Full source: [cookbook/10_reasoning/models/azure_openai/basic_reasoning_stream.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/models/azure_openai/basic_reasoning_stream.py)
