...
Full source: [cookbook/10_reasoning/agents/ship_of_theseus.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/agents/ship_of_theseus.py)
