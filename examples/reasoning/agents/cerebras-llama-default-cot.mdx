...
description: "Runs a Cerebras llama-3.3-70b agent with reasoning=True so it falls back to default chain-of-thought, streaming full reasoning in debug mode."
