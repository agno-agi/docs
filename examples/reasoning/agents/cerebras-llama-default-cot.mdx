...
Full source: [cookbook/10_reasoning/agents/cerebras_llama_default_COT.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/agents/cerebras_llama_default_COT.py)
