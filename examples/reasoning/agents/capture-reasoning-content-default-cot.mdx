...
Full source: [cookbook/10_reasoning/agents/capture_reasoning_content_default_COT.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/agents/capture_reasoning_content_default_COT.py)
