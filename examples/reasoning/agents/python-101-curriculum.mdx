...
Full source: [cookbook/10_reasoning/agents/python_101_curriculum.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/agents/python_101_curriculum.py)
