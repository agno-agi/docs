...
description: "Contrasts an explicit gpt-4o reasoning_model fallback against reasoning=True built-in chain-of-thought on the same fibonacci prompt."
...
Full source: [cookbook/10_reasoning/agents/default_chain_of_thought.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/agents/default_chain_of_thought.py)
