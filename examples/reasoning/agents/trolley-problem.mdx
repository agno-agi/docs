...
Full source: [cookbook/10_reasoning/agents/trolley_problem.py](https://github.com/agno-agi/agno/blob/v2.7.4/cookbook/10_reasoning/agents/trolley_problem.py)
